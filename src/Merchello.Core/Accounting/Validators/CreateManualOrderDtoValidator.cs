...
/// <summary>
/// Validates required fields for creating a manual order.
/// </summary>
public class CreateManualOrderDtoValidator : AbstractValidator<CreateManualOrderDto>
{
    public CreateManualOrderDtoValidator()
    {
