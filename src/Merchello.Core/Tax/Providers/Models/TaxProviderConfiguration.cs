...
/// <summary>
/// Configuration wrapper for tax provider settings.
/// </summary>
public class TaxProviderConfiguration
{
    private readonly Dictionary<string, string> _values;

    public TaxProviderConfiguration(string? json)
    {
    ...
    public TaxProviderConfiguration(IDictionary<string, string>? values)
    {
        _values = values != null
