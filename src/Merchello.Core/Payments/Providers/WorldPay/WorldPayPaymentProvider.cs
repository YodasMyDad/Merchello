...
public class WorldPayPaymentProvider(ILogger<WorldPayPaymentProvider> logger) : PaymentProviderBase
{
    ...
    /// </summary>
    private const string WorldPayPaymentAdapterUrl = "/App_Plugins/Merchello/js/checkout/adapters/worldpay-payment-adapter.js";

    /// <summary>
    /// URL to the WorldPay express checkout adapter script (Apple Pay, Google Pay).
    /// </summary>
    private const string WorldPayExpressAdapterUrl = "/App_Plugins/Merchello/js/checkout/adapters/worldpay-express-adapter.js";
    ...
    public override PaymentProviderMetadata Metadata => new()
    {
        ...
        IconHtml = ProviderBrandLogoCatalog.WorldPay,
