...
/// <summary>
/// Notification fired after a protocol cart session is updated.
/// </summary>
public class ProtocolCartUpdatedNotification : MerchelloNotification
{
    public ProtocolCartUpdatedNotification(
    ...
    /// <summary>
    /// The updated cart session state.
    /// </summary>
