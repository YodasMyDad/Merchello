...
/// <summary>
/// Defines a configuration field for a fulfilment provider.
/// Used to generate dynamic configuration UI in the backoffice.
/// </summary>
public class FulfilmentProviderConfigurationField
{
    /// <summary>
    ...
    /// Sensitive fields are masked in UI (rendered as password inputs).
    /// </summary>
