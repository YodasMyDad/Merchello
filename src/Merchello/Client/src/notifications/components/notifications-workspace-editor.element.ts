...
export class MerchelloNotificationsWorkspaceEditorElement extends UmbLitElement {
  ...
  constructor() {
    ...
    this.consumeContext(UMB_WORKSPACE_CONTEXT, (context) => {
      this.#workspaceContext = context as MerchelloNotificationsWorkspaceContext;
  ...
  #renderContent() {
    ...
    return html`
      ...
      <div class="priority-legend">
        ...
        ${PRIORITY_LEGEND.map(
          (item) => html`
            <span class="legend-item ${getPriorityCategoryClass(item.category)}" title=${item.description}>
