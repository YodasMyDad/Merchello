...
import type { EditSupplierModalData, EditSupplierModalValue } from "./edit-supplier-modal.token.js";
import { MerchelloApi } from "@api/merchello-api.js";

@customElement("merchello-edit-supplier-modal")
export class MerchelloEditSupplierModalElement extends UmbModalBaseElement<
...
> {
  ...
  connectedCallback(): void {
    ...
    // Pre-populate form with existing supplier data
  ...
  private async _handleSave(): Promise<void> {
    ...
    const { error } = await MerchelloApi.updateSupplier(supplierId, {
...
export default MerchelloEditSupplierModalElement;

declare global {
  interface HTMLElementTagNameMap {
    "merchello-edit-supplier-modal": MerchelloEditSupplierModalElement;
  }
}
