...
import { i as a } from "./bundle.manifests-CuX_7p_Q.js";
  ...
  constructor(t) {
    super(t, u.toString()), this.workspaceAlias = S, this.#o = new r(this), this.#e = !1, this.#n = 1e3, this.#s = new l(void 0), this.discount = this.#s.asObservable(), this.#a = new i(!1), this.isLoading = this.#a.asObservable(), this.#r = new i(!1), this.isSaving = this.#r.asObservable(), this.#o.setEntityType(a), this.#o.setUnique("discounts"), this.routes = new c(t), this._loadSettings(), this.routes.setRoutes([
      // Create discount route (before :id to avoid matching "create" as an id)
      {
        ...
        component: () => import("./discount-detail.element-D6-vCoTJ.js"),
        setup: () => {
...
//# sourceMappingURL=discounts-workspace.context-tz2LzGhm.js.map
