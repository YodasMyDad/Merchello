const e = [
  {
    ...
    js: () => import("./entrypoint-6bdqh61k.js")
  }
], o = [
  // Section
  {
  ...
  // Stats Dashboard
  {
    ...
    element: () => import("./stats-dashboard.element-DOm7c-7v.js"),
    meta: {
      label: "Stats",
      pathname: "stats"
    },
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-2FukizKy.js")
  },
  // Tree
  {
    type: "tree",
  ...
  // Fulfillment modal for creating shipments
  {
    ...
    js: () => import("./fulfillment-modal.element--mnIi9Mv.js")
  },
  // Shipment edit modal for updating tracking info
  {
    ...
    js: () => import("./shipment-edit-modal.element-DxDGCvzP.js")
  },
  // Manual payment modal for recording offline payments
  {
    ...
    js: () => import("./manual-payment-modal.element-BhDs3cZn.js")
  },
  // Refund modal for processing refunds
  {
    ...
    js: () => import("./refund-modal.element-Woh3Rbdh.js")
  },
  // Cancel invoice modal for cancelling invoices
  {
    ...
    js: () => import("./cancel-invoice-modal.element-AGbzQSYh.js")
  },
  // Export modal for exporting orders to CSV
  {
    ...
    js: () => import("./export-modal.element-D-IfPpyl.js")
  },
  // Edit order modal for editing order details
  {
    ...
    js: () => import("./edit-order-modal.element-Db6btG7d.js")
  },
  // Add custom item modal for edit order
  {
    ...
    js: () => import("./add-custom-item-modal.element-DjKxBqAi.js")
  },
  // Add discount modal for edit order
  {
    ...
    js: () => import("./add-discount-modal.element-BDEFp7OQ.js")
  },
  // Create order modal for creating manual orders from backoffice
  {
    ...
    js: () => import("./create-order-modal.element-CCUYJTA6.js")
  },
  // Customer orders modal for viewing all orders by a customer
  {
    ...
    js: () => import("./customer-orders-modal.element-BC_4KUpi.js")
  },
  // Generate statement modal for downloading customer statement PDFs
  {
    ...
    js: () => import("./generate-statement-modal.element-CIRkCT03.js")
  },
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-CeToZrXc.js"),
    meta: {
      entityType: i
    }
  },
  // Workspace view - the orders list (used when on list route)
  {
    ...
    js: () => import("./orders-list.element-BH__AR4y.js"),
    weight: 100,
    meta: {
      label: "Orders",
      pathname: "list",
  ...
  // Mark as paid modal
  {
    ...
    js: () => import("./mark-as-paid-modal.element-No9RPpO-.js")
  },
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-j9mYND2a.js"),
    meta: {
      entityType: E
    }
  },
  // Workspace view - the outstanding list
  {
    ...
    js: () => import("./outstanding-list.element-1BIrfIuj.js"),
    weight: 100,
    meta: {
      label: "Outstanding",
      pathname: "list",
  ...
  // Workspace for abandoned checkouts list (when clicking "Abandoned Checkouts" in tree)
  {
    ...
    api: () => import("./abandoned-checkouts-workspace.context-aUW0e1AM.js"),
    meta: {
      entityType: w
    }
  },
  // Workspace view - the abandoned checkouts list
  {
    ...
    js: () => import("./abandoned-checkouts-list.element-CC8FjwI8.js"),
    weight: 100,
    meta: {
  ...
  // Create product modal
  {
    ...
    js: () => import("./create-product-modal.element-C2nJc2FN.js")
  },
  // Option editor modal
  {
    type: "modal",
  ...
  // Variant batch update modal
  {
    ...
    js: () => import("./variant-batch-update-modal.element-DRs3ii0s.js")
  },
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-CZk0QUDW.js"),
    meta: {
      entityType: t
    }
  },
  // Workspace view for products list (used when on list route)
  {
    ...
    js: () => import("./products-list.element-ZIjUyH8D.js"),
    weight: 100,
    meta: {
      label: "Products",
      pathname: "products",
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-BrIZ3zLu.js"),
    meta: {
      entityType: r
    }
  },
  // Workspace view - the customers list
  {
    ...
    js: () => import("./customers-list.element-B9qVLJDQ.js"),
    weight: 100,
    meta: {
      label: "Customers",
      pathname: "list",
  ...
  // Workspace view - the segments list (tab in Customers workspace)
  {
    ...
    js: () => import("./segments-list.element-BSXlyf_3.js"),
    weight: 90,
    meta: {
      label: "Segments",
      pathname: "segments",
  ...
  // Customer edit modal
  {
    ...
    js: () => import("./customer-edit-modal.element-Rr3MsA7M.js")
  },
  // Customer picker modal (for adding members to segments)
  {
    ...
    js: () => import("./customer-picker-modal.element-6hqU3PHY.js")
  },
  // Segment picker modal (for discount eligibility)
  {
    ...
    js: () => import("./segment-picker-modal.element-BMzQ8HsI.js")
  }
], S = [
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-aMabeyuV.js"),
    meta: {
      entityType: s
    }
  },
  // Workspace view for collections
  {
    ...
    js: () => import("./collections-workspace.element-CyYUDA4D.js"),
    weight: 100,
    meta: {
      label: "Collections",
  ...
  // Collection picker modal (for discount targeting)
  {
    ...
    js: () => import("./collection-picker-modal.element-Jbijg7OA.js")
  },
  // Collection create/edit modal
  {
    ...
    js: () => import("./collection-modal.element-Cl35QRC1.js")
  }
], j = [
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-DMIWWuad.js"),
    meta: {
      entityType: c
    }
  },
  // Workspace view for filters list
  {
    ...
    js: () => import("./filters-list.element-BRo3dOcL.js"),
    weight: 100,
    meta: {
      label: "Filters",
      pathname: "filters",
  ...
  // Modal for creating/editing filter groups
  {
    ...
    js: () => import("./filter-group-modal.element-BLHmMu3o.js")
  },
  // Modal for creating/editing filters
  {
    ...
    js: () => import("./filter-modal.element-hW6hpiIy.js")
  },
  // Filter picker modal (for discount targeting)
  {
    ...
    js: () => import("./filter-picker-modal.element-UQpzVWSg.js")
  },
  // Filter group picker modal (for property editor)
  {
    ...
    js: () => import("./filter-group-picker-modal.element-DRQemsUQ.js")
  }
], V = [
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-DpetBz9v.js"),
    meta: {
      entityType: n
    }
  },
  // Workspace view for product types
  {
    ...
    js: () => import("./product-types-list.element-CcLjHswO.js"),
    weight: 100,
    meta: {
      label: "Product Types",
  ...
  // Modal for create/edit product type
  {
    ...
    js: () => import("./product-type-modal.element-DWmBladg.js")
  },
  // Product type picker modal (for discount targeting)
  {
    ...
    js: () => import("./product-type-picker-modal.element-BbFhyNOY.js")
  }
], v = [
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-DVILLgGD.js"),
    meta: {
      entityType: p
    }
  },
  // Workspace view for product feed
  {
    ...
    js: () => import("./product-feeds-list.element-BoocAEgI.js"),
    weight: 100,
    meta: {
      label: "Product Feeds",
  ...
  },
  {
    ...
    js: () => import("./product-feed-validation-modal.element-BxMCXMH4.js")
  }
], A = [
  {
    type: "workspace",
    ...
    api: () => import("./product-import-export-workspace.context-BOL36O3J.js"),
    meta: {
      entityType: m
    }
  },
  {
    ...
    js: () => import("./product-import-export-page.element-CRSst5Xk.js"),
    weight: 100,
    meta: {
      label: "Import & Export",
      pathname: "sync",
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-BXSDHdQA.js"),
    meta: {
      entityType: k
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-Dj3Zquyr.js"),
    meta: {
      entityType: d
    }
  },
  // Workspace view for analytics
  {
    ...
    js: () => import("./analytics-workspace.element-CwKDu2l4.js"),
    weight: 100,
    meta: {
      label: "Analytics",
      pathname: "analytics",
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-Dx9po5Vg.js"),
    meta: {
      entityType: h
    }
  },
  // Workspace view for discounts list (used when on list route)
  {
    ...
    js: () => import("./discounts-list.element-C7G5DPH3.js"),
    weight: 100,
    meta: {
      label: "Discounts",
      pathname: "discounts",
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-CgN6iYwI.js"),
    meta: {
      entityType: u
    }
  },
  // Workspace view - the email list
  {
    ...
    js: () => import("./email-list.element-BSRWnPmS.js"),
    weight: 100,
    meta: {
      label: "Emails",
      pathname: "list",
  ...
  // Email preview modal
  {
    ...
    js: () => import("./email-preview-modal.element-DYX5A6YP.js")
  }
], x = [
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-DZz_QUap.js"),
    meta: {
      entityType: P
    }
  },
  // Workspace view - the webhooks list
  {
    ...
    js: () => import("./webhooks-list.element-DQxsZR7C.js"),
    weight: 100,
    meta: {
      label: "Webhooks",
      pathname: "list",
  ...
  // Webhook subscription create/edit modal
  {
    ...
    js: () => import("./webhook-subscription-modal.element-VrUVqhMZ.js")
  },
  // Webhook test modal
  {
    type: "modal",
    ...
    js: () => import("./webhook-test-modal.element-WzNVXDHG.js")
  },
  // Delivery detail modal
  {
    ...
    js: () => import("./delivery-detail-modal.element-CsfPdfuZ.js")
  },
  ...
  // Workspace for notifications (when clicking "Notifications" in tree)
  {
    ...
    api: () => import("./notifications-workspace.context-DYxSMGmq.js"),
    meta: {
      entityType: T
    }
  },
  ...
  // Workspace view for tax providers list (appears as "Tax" tab in Providers workspace)
  {
    ...
    js: () => import("./tax-providers-list.element-CLHM9Gau.js"),
    weight: 85,
    meta: {
      label: "Tax",
      pathname: "tax",
  ...
  // Tax group modal (handles both create and edit)
  {
    ...
    js: () => import("./tax-group-modal.element-BGXYVSbj.js")
  },
  // Tax rate modal (handles both create and edit for geographic rates)
  {
    ...
    js: () => import("./tax-rate-modal.element-CXBrQTNY.js")
  },
  // Tax provider config modal
  {
    ...
    js: () => import("./tax-provider-config-modal.element-DNiw2FVn.js")
  },
  // Test tax provider modal
  {
    ...
    js: () => import("./test-tax-provider-modal.element-Dp4WmBFp.js")
  },
  // Shipping tax override modal
  {
    ...
    js: () => import("./shipping-tax-override-modal.element-Dn_LO0_l.js")
  }
], Y = [
  // ============================================
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-pxqsjPST.js"),
    meta: {
      entityType: M
    }
  },
  // List view for suppliers
  {
    ...
    js: () => import("./suppliers-list.element-DE3mlqOy.js"),
    weight: 100,
    meta: {
      label: "Suppliers",
      pathname: "suppliers",
  ...
  // Supplier modal (handles both create and edit)
  {
    ...
    js: () => import("./supplier-modal.element-qLCsIDhG.js")
  },
  // Supplier picker modal (for discount targeting)
  {
    ...
    js: () => import("./supplier-picker-modal.element-BoVuB51B.js")
  }
], D = [
  // ============================================
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-DkPgZtLM.js"),
    meta: {
      entityType: y
    }
  },
  // List view for warehouses (used when on list route)
  {
    ...
    js: () => import("./warehouses-list.element-OJbmoGSW.js"),
    weight: 100,
    meta: {
      label: "Warehouses",
      pathname: "warehouses",
  ...
  // Service region modal
  {
    ...
    js: () => import("./service-region-modal.element-YIZtNCnz.js")
  },
  // Warehouse picker modal (for discount targeting)
  {
    ...
    js: () => import("./warehouse-picker-modal.element-B9gS-BuT.js")
  }
], $ = [
  // Workspace view for shipping providers (under Providers workspace)
  {
    ...
    js: () => import("./shipping-providers-list.element-CO1AwMWX.js"),
    weight: 90,
    meta: {
      label: "Shipping",
      pathname: "shipping",
  ...
  // Shipping provider configuration modal
  {
    ...
    js: () => import("./shipping-provider-config-modal.element-CWgK0Cc-.js")
  },
  // Test shipping provider modal
  {
    ...
    js: () => import("./test-provider-modal.element-BhA8_m7-.js")
  },
  // Shipping option detail modal
  {
    ...
    js: () => import("./shipping-option-detail-modal.element-BMivSfT1.js")
  },
  // Shipping cost modal
  {
    type: "modal",
    ...
    js: () => import("./shipping-cost-modal.element-B5jeJw4C.js")
  },
  // Shipping weight tier modal
  {
    ...
    js: () => import("./shipping-weight-tier-modal.element-YfptavrT.js")
  },
  // Shipping destination exclusion modal
  {
    ...
    js: () => import("./shipping-destination-exclusion-modal.element-CMWpYB_i.js")
  },
  // Shipping postcode rule modal
  {
    ...
    js: () => import("./shipping-postcode-rule-modal.element-DY158DvR.js")
  }
], N = [
  // Workspace view for payment providers (under Providers workspace)
  {
    ...
    js: () => import("./payment-providers-list.element-erckNn__.js"),
    weight: 100,
    meta: {
      label: "Payments",
      pathname: "payments",
  ...
  // Modal for configuring a payment provider
  {
    ...
    js: () => import("./payment-provider-config-modal.element-B2GNPL-h.js")
  },
  // Modal for configuring payment methods within a provider
  {
    ...
    js: () => import("./payment-methods-config-modal.element-RYyVLN2w.js")
  },
  // Modal for editing a single payment method's display settings
  {
    ...
    js: () => import("./payment-method-edit-modal.element-YaUPVY7v.js")
  },
  ...
  // Modal for testing a payment provider
  {
    ...
    js: () => import("./test-provider-modal.element-6XCTIwxU.js")
  }
], H = [
  // Workspace view for fulfilment providers (under Providers workspace)
  {
    ...
    js: () => import("./fulfilment-providers-list.element-BkZFAptJ.js"),
    weight: 75,
    meta: {
      label: "Fulfilment",
      pathname: "fulfilment",
  ...
  // Configuration modal
  {
    ...
    js: () => import("./fulfilment-provider-config-modal.element-D5c7Y4TY.js")
  },
  // Test modal
  {
    type: "modal",
    ...
    js: () => import("./test-provider-modal.element-DMEBVtmg.js")
  }
], G = [
  // Workspace view for exchange rate providers (under Providers workspace)
  {
    ...
    js: () => import("./exchange-rate-providers-list.element-BHyrYUtz.js"),
    weight: 80,
  ...
  // Modal for configuring an exchange rate provider
  {
    ...
    js: () => import("./exchange-rate-provider-config-modal.element-CW6mPkrS.js")
  },
  // Modal for testing an exchange rate provider
  {
    ...
    js: () => import("./test-provider-modal.element-LrXbA8oK.js")
  }
], B = [
  // Workspace view for address lookup providers (under Providers workspace)
  {
    ...
    js: () => import("./address-lookup-providers-list.element-Cj_LtlPC.js"),
    weight: 85,
    meta: {
  ...
  // Modal for configuring an address lookup provider
  {
    ...
    js: () => import("./address-lookup-provider-config-modal.element-Btdj9_x4.js")
  },
  // Modal for testing an address lookup provider
  {
    ...
    js: () => import("./test-provider-modal.element-Wk96WrU3.js")
  }
], q = [
  {
    type: "workspace",
    ...
    api: () => import("./upsells-workspace.context-qHupkWtt.js"),
    meta: {
      entityType: b
    }
  },
  {
    ...
    js: () => import("./upsells-list.element-DmRjlnTm.js"),
    weight: 100,
    meta: {
      label: "Upsells",
      pathname: "upsells",
  ...
  },
  {
    ...
    js: () => import("./create-upsell-modal.element-DB-1hlDN.js")
  },
  {
    type: "modal",
  ...
  // Workspace for root (when clicking "Merchello" in tree)
  {
    ...
    api: () => import("./settings-workspace.context-BTgDItyr.js"),
    meta: {
      entityType: l
    }
  },
  {
    ...
    js: () => import("./settings-workspace.element-BtyeCMb9.js"),
    weight: 100,
    meta: {
      label: "Overview",
      pathname: "overview",
  ...
  // Product picker modal for selecting products in orders and property editors
  {
    ...
    js: () => import("./product-picker-modal.element-y9fHTPtN.js")
  }
], X = [
  {
    ...
    element: () => import("./property-editor-ui-collection-picker.element-CSe8QUX3.js"),
    meta: {
...
], J = [
  {
    ...
    element: () => import("./property-editor-ui-product-type-picker.element-BlozwDcT.js"),
    meta: {
...
], Q = [
  {
    ...
    element: () => import("./property-editor-ui-filter-group-picker.element-gcj0P7Lh.js"),
    meta: {
...
], Z = [
  {
    ...
    element: () => import("./property-editor-ui-filter-value-picker.element-22kpFrc9.js"),
    meta: {
...
], ee = [
  {
    ...
    element: () => import("./property-editor-ui-product-picker.element-ySBZGx1s.js"),
    meta: {
...
], oe = [
  {
    ...
    element: () => import("./property-editor-ui-google-shopping-category-picker.element-DYho58TA.js"),
    meta: {
...
//# sourceMappingURL=bundle.manifests-6i5wD5hV.js.map
