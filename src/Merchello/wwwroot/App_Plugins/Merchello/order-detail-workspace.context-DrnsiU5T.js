...
import { M as l } from "./merchello-api-DJaAbZDf.js";
class u extends i {
  constructor(e) {
    super(e, o.toString()), this.workspaceAlias = "Merchello.Order.Detail.Workspace", this.#e = new d(void 0), this.order = this.#e.asObservable(), this.routes = new a(e), this.provideContext(o, this), this.routes.setRoutes([
      {
        path: "edit/:id",
        component: () => import("./order-detail.element-BoQ57s28.js"),
        setup: (t, r) => {
...
//# sourceMappingURL=order-detail-workspace.context-DrnsiU5T.js.map
