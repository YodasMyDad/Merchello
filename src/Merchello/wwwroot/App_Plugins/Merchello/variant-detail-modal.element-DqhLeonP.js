import { html as t, nothing as p, css as f, state as n, customElement as g } from "@umbraco-cms/backoffice/external/lit";
...
import { M as D } from "./merchello-api-B5716PMS.js";
import { b as S } from "./badge.styles-C_lNgH9O.js";
var k = Object.defineProperty, $ = Object.getOwnPropertyDescriptor, m = (e) => {
  throw TypeError(e);
}, u = (e, a, i, s) => {
  for (var r = s > 1 ? void 0 : s ? $(a, i) : a, c = e.length - 1, d; c >= 0; c--)
    (d = e[c]) && (r = (s ? d(a, i, r) : d(r)) || r);
  return s && r && k(a, i, r), r;
}, v = (e, a, i) => a.has(e) || m("Cannot " + i), h = (e, a, i) => (v(e, a, "read from private field"), i ? i.call(e) : a.get(e)), y = (e, a, i) => a.has(e) ? m("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(e) : a.set(e, i), F = (e, a, i, s) => (v(e, a, "write to private field"), a.set(e, i), i), l;
  ...
  _renderFeedSection() {
    return t`
      <div class="section-content">
        ...
        ${this._formData.removeFromFeed ? p : t`
              <div class="form-grid">
...
//# sourceMappingURL=variant-detail-modal.element-DqhLeonP.js.map
