const e = [
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-DP3OewCv.js")
  },
  // Tree
  {
    type: "tree",
...
], F = "merchello-root", l = "merchello-orders", i = "merchello-products", r = "merchello-customers", t = "merchello-collections", s = "merchello-filters", c = "merchello-product-types", n = "merchello-product-feed", p = "merchello-analytics", m = "merchello-discounts", d = "merchello-tax", h = "merchello-suppliers", M = "merchello-warehouses", u = "merchello-providers", y = [
  ...
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-CWNrUBVg.js"),
    meta: {
      entityType: l
    }
  },
  ...
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-C6RfSfsm.js"),
    meta: {
      entityType: i
    }
  },
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-D-lMCDNy.js"),
    meta: {
      entityType: r
    }
  },
  ...
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-Cz2Mn6DZ.js"),
    meta: {
      entityType: t
    }
  },
  ...
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-xelgbllG.js"),
    meta: {
      entityType: s
    }
  },
  ...
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-COGTyn3z.js"),
    meta: {
      entityType: c
    }
  },
  ...
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-BvGzMVL0.js"),
    meta: {
      entityType: n
    }
  },
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-CQl6a3TI.js"),
    meta: {
      entityType: u
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-BjRBmbJd.js"),
    meta: {
      entityType: p
    }
  },
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-CBAmWewA.js"),
    meta: {
      entityType: m
    }
  },
  ...
  // Workspace for tax (when clicking "Tax" in tree)
  {
    ...
    api: () => import("./tax-workspace.context-Mzz1U0aC.js"),
    meta: {
      entityType: d
    }
  },
  // Workspace view for tax groups list
  {
    ...
    js: () => import("./tax-workspace.element-Czvel1Ro.js"),
    weight: 100,
    meta: {
      label: "Tax Groups",
      pathname: "tax-groups",
  ...
  // Workspace view for tax providers
  {
    ...
    js: () => import("./tax-providers-list.element-DY0w0GpR.js"),
    weight: 90,
    meta: {
      label: "Providers",
      pathname: "providers",
  ...
  // Tax group modal (handles both create and edit)
  {
    ...
    js: () => import("./tax-group-modal.element-Bq8PHOOU.js")
  },
  ...
  // Tax provider config modal
  {
    ...
    js: () => import("./tax-provider-config-modal.element-DosW-jDh.js")
  },
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-DQ3WKfJ3.js"),
    meta: {
      entityType: h
    }
  },
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-CTQ-X5kK.js"),
    meta: {
      entityType: M
    }
  },
...
//# sourceMappingURL=bundle.manifests-e1Lo7CbL.js.map
