const e = [
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-BNKCl9jf.js")
  },
  // Tree
  {
    type: "tree",
  ...
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-B3b9Z2yC.js"),
    meta: {
      entityType: l
    }
  },
  ...
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-CnNqdfCU.js"),
    meta: {
      entityType: k
    }
  },
  ...
  // Workspace for abandoned checkouts list (when clicking "Abandoned Checkouts" in tree)
  {
    ...
    api: () => import("./abandoned-checkouts-workspace.context-Bfw5u3X4.js"),
    meta: {
      entityType: P
    }
  },
  ...
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-miZ0XJBl.js"),
    meta: {
      entityType: i
    }
  },
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-CP068b37.js"),
    meta: {
      entityType: t
    }
  },
  ...
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-DfOMQQga.js"),
    meta: {
      entityType: r
    }
  },
  ...
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-Cf1-lpev.js"),
    meta: {
      entityType: s
    }
  },
  ...
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-mpQPM7i2.js"),
    meta: {
      entityType: c
    }
  },
  ...
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-ULlCIYdR.js"),
    meta: {
      entityType: n
    }
  },
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-DPIWkNTs.js"),
    meta: {
      entityType: u
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-B3V_0_cB.js"),
    meta: {
      entityType: p
    }
  },
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-C9KCf-Zv.js"),
    meta: {
      entityType: m
    }
  },
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-BJRbcqTP.js"),
    meta: {
      entityType: M
    }
  },
  ...
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-uquel2vO.js"),
    meta: {
      entityType: y
    }
  },
  ...
  // Workspace for notifications (when clicking "Notifications" in tree)
  {
    ...
    api: () => import("./notifications-workspace.context-C-jVX1xl.js"),
    meta: {
      entityType: E
    }
  },
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-C_nOHYHe.js"),
    meta: {
      entityType: d
    }
  },
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-D-4gS-Hj.js"),
    meta: {
      entityType: h
    }
  },
...
], H = [
  {
    ...
    api: () => import("./upsells-workspace.context-Bao12wfE.js"),
    meta: {
      entityType: w
    }
  },
...
//# sourceMappingURL=bundle.manifests-B-doK34d.js.map
