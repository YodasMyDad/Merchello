...
var A = Object.defineProperty, O = Object.getOwnPropertyDescriptor, _ = (e) => {
  ...
  for (var a = o > 1 ? void 0 : o ? O(t, i) : t, r = e.length - 1, f; r >= 0; r--)
    (f = e[r]) && (a = (o ? f(t, i, a) : f(a)) || a);
  return o && a && A(t, i, a), a;
}, b = (e, t, i) => t.has(e) || _("Cannot " + i), v = (e, t, i) => (b(e, t, "read from private field"), t.get(e)), g = (e, t, i) => t.has(e) ? _("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), p = (e, t, i, o) => (b(e, t, "write to private field"), t.set(e, i), i), c, h, u;
let n = class extends D {
  ...
  _removeValue(e) {
    ...
    t.splice(e, 1), t.forEach((i, o) => i.sortOrder = o), this._formData = { ...this._formData, values: t };
  }
  _updateValue(e, t, i) {
    const o = [...this._formData.values || []];
    o[e] = { ...o[e], [t]: i }, this._formData = { ...this._formData, values: o };
  }
  _renderValueEditor(e, t) {
    ...
    return s`
        ...
        <div class="value-content">
          <div class="value-name-row">
            <uui-input
              ...
              @input=${(a) => this._updateValue(t, "name", a.target.value)}>
            </uui-input>
            ...
            ${i === "colour" ? s`
                  <uui-input
                    ...
                    @input=${(a) => this._updateValue(t, "hexValue", a.target.value)}>
                  </uui-input>
                ` : l}
          </div>
                ...
                <div class="addon-fields">
                  <div class="addon-field">
                    ...
                    <uui-input
                      ...
                      placeholder="0.00"
                      @input=${(a) => this._updateValue(t, "priceAdjustment", parseFloat(a.target.value) || 0)}>
                    </uui-input>
                  </div>
                  ...
                  <div class="addon-field">
                    ...
                    <uui-input
                      ...
                      placeholder="0.00"
                      @input=${(a) => this._updateValue(t, "costAdjustment", parseFloat(a.target.value) || 0)}>
                    </uui-input>
                  </div>
                  ...
                  <div class="addon-field sku-field">
                    ...
                    <uui-input
                      .value=${e.skuSuffix || ""}
                      placeholder="e.g., -GW"
                      @input=${(a) => this._updateValue(t, "skuSuffix", a.target.value)}>
                    </uui-input>
                  </div>
                </div>
      ...
      this._updateValue(t, "weightKg", r ? parseFloat(r) : null);
    }}>
                    </uui-input>
  ...
  render() {
    const e = !this.data?.option, t = this._formData.values?.length || 0, i = this._getMaxValues(), o = this._formData.isVariant && t > 0 ? `Will create ${t} variants` : "";
    return s`
          ...
          <uui-box headline="Option Details">
            ...
            <umb-property-layout
              ...
              <uui-input
                ...
                @input=${(a) => this._formData = { ...this._formData, alias: a.target.value }}>
              </uui-input>
            </umb-property-layout>
            ...
            <umb-property-layout
              ...
              <uui-select
                ...
                @change=${(a) => this._formData = { ...this._formData, optionTypeAlias: a.target.value }}>
              </uui-select>
            </umb-property-layout>
            ...
            <umb-property-layout
              ...
              <uui-select
                ...
                @change=${(a) => this._formData = { ...this._formData, optionUiAlias: a.target.value }}>
              </uui-select>
            </umb-property-layout>
            ...
            <umb-property-layout
              ...
              <uui-toggle
                ...
                @change=${(a) => this._formData = { ...this._formData, isVariant: a.target.checked }}>
              </uui-toggle>
            </umb-property-layout>
          </uui-box>
          ...
          <uui-box>
            ...
            ${this._formData.values && this._formData.values.length > 0 ? s`
                  <div class="values-list">
                    ${this._formData.values.map((a, r) => this._renderValueEditor(a, r))}
                  </div>
                ` : s`
...
//# sourceMappingURL=option-editor-modal.element-DnPdXkmM.js.map
