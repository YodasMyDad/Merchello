import { LitElement as P, nothing as d, html as s, css as k, state as p, customElement as x } from "@umbraco-cms/backoffice/external/lit";
...
import { M as g } from "./merchello-api-B3w7Bp8a.js";
import { A as O, B as N, C } from "./navigation-CvTcY6zJ.js";
import { e as F } from "./formatting-C7zDJOqJ.js";
import "./merchello-empty-state.element-mt97UoA5.js";
var z = Object.defineProperty, M = Object.getOwnPropertyDescriptor, T = (e) => {
  throw TypeError(e);
}, c = (e, t, r, i) => {
  for (var o = i > 1 ? void 0 : i ? M(t, r) : t, a = e.length - 1, u; a >= 0; a--)
    (u = e[a]) && (o = (i ? u(t, r, o) : u(o)) || o);
  return i && o && z(t, r, o), o;
}, w = (e, t, r) => t.has(e) || T("Cannot " + r), l = (e, t, r) => (w(e, t, "read from private field"), t.get(e)), y = (e, t, r) => t.has(e) ? T("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), v = (e, t, r, i) => (w(e, t, "write to private field"), t.set(e, r), r), _, h, $, f;
const b = 5;
let n = class extends E(P) {
  constructor() {
        ...
        <div class="grid">
          ...
          <umb-property-layout
            ...
            <uui-toggle
              ...
              @change=${(a) => this._setGeneralField("includeTaxInPrice", a.target.checked)}>
    ...
    return s`
      ...
      return s`
        ...
        return s`
                            <uui-checkbox
                              ?checked=${m}
                              @change=${(A) => i(o.id, u.id, A.target.checked)}>
                              ${u.name}
                            </uui-checkbox>
                          `;
      })}
...
//# sourceMappingURL=product-feed-detail.element-eBnlS-iq.js.map
