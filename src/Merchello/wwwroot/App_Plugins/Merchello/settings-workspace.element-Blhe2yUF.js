import { LitElement as w, html as o, nothing as c, css as $, state as n, customElement as T } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as I } from "@umbraco-cms/backoffice/element-api";
import { M as p } from "./merchello-api-OYuQK4Mu.js";
...
import { M as K } from "./product-picker-modal.token-BfbHsSHl.js";
import { c as J } from "./formatting-CuYSKks5.js";
var Y = Object.defineProperty, Q = Object.getOwnPropertyDescriptor, x = (e, t, i, r) => {
  for (var a = r > 1 ? void 0 : r ? Q(t, i) : t, s = e.length - 1, d; s >= 0; s--)
...
let l = class extends I(w) {
  ...
  _syncFulfillmentGroups(e) {
    ...
    for (const d of r) {
      const C = this._asObject(d);
      if (C)
        for (const H of this._asArray(C.groups)) {
          const b = this._asObject(H), F = this._asString(b?.id);
          if (!b || !F)
            continue;
          const q = this._asArray(b.options).map((h) => this._asObject(h)).filter((h) => h != null).map((h) => {
            const G = this._asArray(h.totals), R = this._asObject(G[0]);
            return {
              id: this._asString(h.id) ?? "",
              title: this._asString(h.title) ?? this._t("merchello_ucpFlowTesterOptionLabel", "Option"),
              amount: this._asNumber(R?.amount),
              currency: this._asString(R?.currency)
            };
          }).filter((h) => h.id.length > 0);
          a.push({
            id: F,
            name: this._asString(b.name) ?? F,
    ...
    return o`
      <div
        ...
        <div class="step-card-header">
          ...
          <div class="step-actions" @click=${(C) => C.stopPropagation()}>
...
l = u([
  T("merchello-ucp-flow-tester")
], l);
var ee = Object.defineProperty, te = Object.getOwnPropertyDescriptor, M = (e) => {
  throw TypeError(e);
}, y = (e, t, i, r) => {
  for (var a = r > 1 ? void 0 : r ? te(t, i) : t, s = e.length - 1, d; s >= 0; s--)
    (d = e[s]) && (a = (r ? d(t, i, a) : d(a)) || a);
  return r && a && ee(t, i, a), a;
}, L = (e, t, i) => t.has(e) || M("Cannot " + i), k = (e, t, i) => (L(e, t, "read from private field"), i ? i.call(e) : t.get(e)), B = (e, t, i) => t.has(e) ? M("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), ie = (e, t, i, r) => (L(e, t, "write to private field"), t.set(e, i), i), S, v;
let m = class extends I(w) {
  constructor() {
    super(), this._isLoading = !0, this._isSaving = !1, this._errorMessage = null, this._activeTab = "store", this._configuration = null, this._descriptionEditorConfig = void 0, B(this, S, new W(this)), B(this, v), this.consumeContext(z, (e) => {
      ie(this, v, e);
    });
  }
  connectedCallback() {
  ...
  async _loadDataTypeConfig(e) {
    try {
      const { error: t } = await k(this, S).requestByUnique(e);
      if (t) {
        this._setFallbackEditorConfig();
        return;
      }
      this.observe(
        await k(this, S).byUnique(e),
        (i) => {
          if (!i) {
            this._setFallbackEditorConfig();
            return;
...
m = y([
  T("merchello-store-configuration-tabs")
], m);
var re = Object.defineProperty, ae = Object.getOwnPropertyDescriptor, E = (e, t, i, r) => {
  for (var a = r > 1 ? void 0 : r ? ae(t, i) : t, s = e.length - 1, d; s >= 0; s--)
    (d = e[s]) && (a = (r ? d(t, i, a) : d(a)) || a);
  return r && a && re(t, i, a), a;
};
let _ = class extends I(w) {
  constructor() {
...
_ = E([
  T("merchello-settings-workspace")
], _);
const ge = _;
export {
...
//# sourceMappingURL=settings-workspace.element-Blhe2yUF.js.map
