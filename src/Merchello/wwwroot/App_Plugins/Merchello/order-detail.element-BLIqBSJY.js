...
import { b as N, a as p, h as ne } from "./formatting-Bo-Avnc8.js";
                ...
                ${e.discountTotal > 0 ? a`
                  ...
                  ${e.discounts?.map((t) => a`
                    <div class="summary-row discount-detail">
                      <span>${t.name || "Discount"}</span>
                      <span></span>
                      <span>-${p(t.amount, e.currencyCode, e.currencySymbol)}</span>
                    </div>
                  `)}
                ` : o}
                <div class="summary-row">
...
//# sourceMappingURL=order-detail.element-BLIqBSJY.js.map
