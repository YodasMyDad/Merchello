...
async function t(e) {
  try {
    const r = await l(), i = d.baseUrl || "", a = await fetch(`${i}${c}/${e}`, {
      method: "GET",
...
async function o(e, r) {
  try {
    const i = await l(), a = d.baseUrl || "", n = await fetch(`${a}${c}/${e}`, {
      method: "POST",
      credentials: d.credentials,
      headers: i,
...
//# sourceMappingURL=merchello-api-DFGQMc21.js.map
