...
import { UmbModalToken as E, UMB_MODAL_MANAGER_CONTEXT as L, UMB_CONFIRM_MODAL as P } from "@umbraco-cms/backoffice/modal";
...
import { f as O, h as U, i as N } from "./navigation-CURxaj93.js";
import { b as R } from "./badge.styles-B9Lnx6kD.js";
var B = Object.defineProperty, K = Object.getOwnPropertyDescriptor, g = (e, t, i, s) => {
  for (var a = s > 1 ? void 0 : s ? K(t, i) : t, u = e.length - 1, d; u >= 0; u--)
...
let p = class extends x(k) {
  ...
  _handleNameLinkClick(e, t) {
    if (e.button !== 0 || e.metaKey || e.ctrlKey || e.shiftKey || e.altKey) {
      e.stopPropagation();
      return;
    }
    e.preventDefault(), e.stopPropagation(), this._handleRowClick(t);
  }
  _getMethodIcon(e) {
      ...
      (e) => o`
            ...
            >
              ...
              <uui-table-cell class="name-cell">
                <a
                  href=${O(e.id)}
                  @click=${(t) => this._handleNameLinkClick(t, e)}
                >
                  ${e.name}
                </a>
...
const W = new E("Merchello.SelectDiscountType.Modal", {
  modal: {
    type: "dialog",
    size: "medium"
  }
});
var j = Object.defineProperty, H = Object.getOwnPropertyDescriptor, w = (e) => {
  throw TypeError(e);
}, c = (e, t, i, s) => {
  for (var a = s > 1 ? void 0 : s ? H(t, i) : t, u = e.length - 1, d; u >= 0; u--)
    (d = e[u]) && (a = (s ? d(t, i, a) : d(a)) || a);
...
let l = class extends x(k) {
  ...
  async _handleCreateDiscount() {
    if (!n(this, b)) return;
    const t = await n(this, b).open(this, W, {
      data: {}
    }).onSubmit().catch(() => {
    });
...
//# sourceMappingURL=discounts-list.element-BjluKIlL.js.map
