...
import { M as x } from "./merchello-api-Rt7qKkDA.js";
import { g as L } from "./store-settings-DWhgRuNK.js";
...
const O = new T("Merchello.Customer.Edit.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var z = Object.defineProperty, P = Object.getOwnPropertyDescriptor, f = (e) => {
  throw TypeError(e);
}, s = (e, t, a, l) => {
  for (var n = l > 1 ? void 0 : l ? P(t, a) : t, p = e.length - 1, _; p >= 0; p--)
    (_ = e[p]) && (n = (l ? _(t, a, n) : _(n)) || n);
  return l && n && z(t, a, n), n;
}, v = (e, t, a) => t.has(e) || f("Cannot " + a), c = (e, t, a) => (v(e, t, "read from private field"), t.get(e)), g = (e, t, a) => t.has(e) ? f("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), h = (e, t, a, l) => (v(e, t, "write to private field"), t.set(e, a), a), d, m, u;
let i = class extends w(C) {
  constructor() {
    super(), this._customers = [], this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._searchTerm = "", this._searchDebounceTimer = null, g(this, d), g(this, m), g(this, u, !1), this.consumeContext(M, (e) => {
      h(this, d, e);
  ...
  connectedCallback() {
    super.connectedCallback(), h(this, u, !0), this._initializeAndLoad();
  }
  ...
  async _handleEditCustomer(e, t) {
    ...
    const l = await c(this, d)?.open(this, O, {
      data: { customer: t }
    })?.onSubmit().catch(() => {
    });
...
//# sourceMappingURL=customers-list.element-Dyv7vUff.js.map
