import { nothing as o, html as t, css as f, state as c, customElement as m } from "@umbraco-cms/backoffice/external/lit";
...
var $ = Object.defineProperty, k = Object.getOwnPropertyDescriptor, y = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? k(i, a) : i, l = e.length - 1, v; l >= 0; l--)
    (v = e[l]) && (r = (s ? v(i, a, r) : v(r)) || r);
  return s && r && $(i, a, r), r;
  ...
  async _loadFields() {
    ...
    if (p(this, u)) {
      ...
      for (const r of this._fields)
        this._values[r.key] = a[r.key] ?? r.defaultValue ?? "";
      this._isLoading = !1;
    }
  }
...
//# sourceMappingURL=fulfilment-provider-config-modal.element-Dw4N9MKl.js.map
