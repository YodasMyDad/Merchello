...
async function t(e) {
  try {
    ...
    let c;
    return n.includes("application/json") ? c = await s.json() : c = await s.text(), { data: c };
  } catch (r) {
...
async function o(e, r) {
  try {
    const i = await u(), s = p.baseUrl || "", n = await fetch(`${s}${h}/${e}`, {
      method: "POST",
      credentials: p.credentials,
      headers: i,
...
//# sourceMappingURL=merchello-api-NCGQOO9L.js.map
