...
import { M as b } from "./merchello-api-CasfpHxB.js";
import { c as O } from "./formatting-DZcj68CA.js";
...
var D = Object.defineProperty, N = Object.getOwnPropertyDescriptor, S = (e, i, t, s) => {
  for (var a = s > 1 ? void 0 : s ? N(i, t) : i, n = e.length - 1, r; n >= 0; n--)
    (r = e[n]) && (a = (s ? r(i, t, a) : r(a)) || a);
  return s && a && D(i, t, a), a;
};
let f = class extends z(A) {
  constructor() {
...
var j = Object.defineProperty, L = Object.getOwnPropertyDescriptor, y = (e, i, t, s) => {
  for (var a = s > 1 ? void 0 : s ? L(i, t) : i, n = e.length - 1, r; n >= 0; n--)
    (r = e[n]) && (a = (s ? r(i, t, a) : r(a)) || a);
...
var E = Object.defineProperty, V = Object.getOwnPropertyDescriptor, u = (e, i, t, s) => {
  for (var a = s > 1 ? void 0 : s ? V(i, t) : i, n = e.length - 1, r; n >= 0; n--)
    (r = e[n]) && (a = (s ? r(i, t, a) : r(a)) || a);
...
let l = class extends I {
  ...
  async _loadVariantsForRoot(e) {
    const i = this._productRoots.findIndex((n) => n.id === e);
    if (i === -1) return;
    ...
    const a = await Promise.all(
      t.variants.map(async (n) => this._mapToPickerVariant(n, t))
    );
    this._productRoots = this._productRoots.map(
      (n, r) => r === i ? { ...n, variants: a, variantsLoaded: !0 } : n
    );
  }
  async _mapToPickerVariant(e, i) {
    ...
    let a = !0, n = null, r = !0, h = null, m = null, k = "InStock";
    if (this._config?.shippingAddress && !i.isDigitalProduct) {
      const c = await this._getFulfillmentOptions(e.id);
      a = c.canAddToOrder, n = c.blockedReason, r = c.canAddToOrder, h = c.warehouseId, m = c.warehouseName, k = c.aggregateStockStatus;
    } else if (!i.isDigitalProduct && e.warehouseStock.length > 0) {
      const c = await this._getDefaultFulfillingWarehouse(e.id);
      a = c.canAddToOrder, n = c.blockedReason, h = c.warehouseId, m = c.warehouseName, k = c.aggregateStockStatus;
    }
    let P = k;
    if (h) {
  ...
  async _transitionToShippingSelection(e, i) {
    ...
    const h = n.availableOptions.map((m) => ({
      id: m.id,
      name: m.name,
  ...
  _handleConfirmWithShipping() {
    ...
    if (!e) return;
    const { variant: i, addons: t, warehouseId: s, warehouseName: a } = this._pendingShippingSelection, n = {
      productId: i.id,
    ...
    this._selections.set(i.id, n), this._selections = new Map(this._selections), this._viewState = "product-selection", this._pendingShippingSelection = null, this._selectedShippingOptionId = null;
  }
  _handleAdd() {
    this.value = {
  ...
  _renderAddonSelectionView() {
    const e = this._pendingAddonSelection;
    if (!e) return d;
    const i = e.variant, t = i.optionValuesDisplay ? `${i.rootName} - ${i.optionValuesDisplay}` : i.rootName, s = this._addonPricePreview, a = s?.basePrice ?? i.price, n = s?.addonsTotal ?? 0, r = s?.totalPrice ?? i.price;
    return o`
          ...
          <div class="addon-product-summary">
            ...
            <div class="product-pricing ${this._isLoadingAddonPreview ? "loading" : ""}">
              ...
              ${n !== 0 ? o`
                    ...
                    <span class="total-price">= ${g(r, this._currencySymbol)}</span>
                  ` : d}
  ...
  _renderShippingSelectionView() {
    ...
    if (!e) return d;
    const i = e.variant, t = i.optionValuesDisplay ? `${i.rootName} - ${i.optionValuesDisplay}` : i.rootName, s = e.addons.reduce((n, r) => n + r.priceAdjustment, 0), a = i.price + s;
    return o`
...
//# sourceMappingURL=product-picker-modal.element-oumunUCZ.js.map
