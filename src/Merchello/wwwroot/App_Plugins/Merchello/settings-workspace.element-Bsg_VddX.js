...
var X = Object.defineProperty, Z = Object.getOwnPropertyDescriptor, z = (e) => {
  throw TypeError(e);
}, u = (e, t, i, r) => {
  for (var a = r > 1 ? void 0 : r ? Z(t, i) : t, s = e.length - 1, d; s >= 0; s--)
    (d = e[s]) && (a = (r ? d(t, i, a) : d(a)) || a);
  return r && a && X(t, i, a), a;
}, M = (e, t, i) => t.has(e) || z("Cannot " + i), U = (e, t, i) => (M(e, t, "read from private field"), t.get(e)), A = (e, t, i) => t.has(e) ? z("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), O = (e, t, i, r) => (M(e, t, "write to private field"), t.set(e, i), i), f, P;
      ...
      if (C)
        for (const H of this._asArray(C.groups)) {
          ...
          const q = this._asArray(b.options).map((h) => this._asObject(h)).filter((h) => h != null).map((h) => {
            const G = this._asArray(h.totals), E = this._asObject(G[0]);
            return {
...
var ee = Object.defineProperty, te = Object.getOwnPropertyDescriptor, V = (e) => {
  throw TypeError(e);
}, y = (e, t, i, r) => {
  for (var a = r > 1 ? void 0 : r ? te(t, i) : t, s = e.length - 1, d; s >= 0; s--)
    (d = e[s]) && (a = (r ? d(t, i, a) : d(a)) || a);
  return r && a && ee(t, i, a), a;
}, L = (e, t, i) => t.has(e) || V("Cannot " + i), k = (e, t, i) => (L(e, t, "read from private field"), i ? i.call(e) : t.get(e)), B = (e, t, i) => t.has(e) ? V("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), ie = (e, t, i, r) => (L(e, t, "write to private field"), t.set(e, i), i), S, v;
let m = class extends I(w) {
  constructor() {
    super(), this._isLoading = !0, this._isSaving = !1, this._errorMessage = null, this._activeTab = "store", this._configuration = null, this._descriptionEditorConfig = void 0, B(this, S, new W(this)), B(this, v), this.consumeContext(N, (e) => {
      ie(this, v, e);
    });
  }
  connectedCallback() {
...
var re = Object.defineProperty, ae = Object.getOwnPropertyDescriptor, R = (e, t, i, r) => {
...
//# sourceMappingURL=settings-workspace.element-Bsg_VddX.js.map
