...
import { UmbModalToken as b, UMB_MODAL_MANAGER_CONTEXT as C, UMB_CONFIRM_MODAL as M } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as $ } from "@umbraco-cms/backoffice/notification";
import { M as g } from "./merchello-api-Rt7qKkDA.js";
import { g as k } from "./store-settings-DWhgRuNK.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
import "./order-table.element-CgFZf8tb.js";
import { M as w } from "./edit-order-modal.token-BUHVPYdq.js";
import { n as D } from "./navigation-RFmAVsdg.js";
const z = new b("Merchello.Export.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
...
var L = Object.defineProperty, I = Object.getOwnPropertyDescriptor, f = (e) => {
  throw TypeError(e);
}, r = (e, t, i, c) => {
  for (var l = c > 1 ? void 0 : c ? I(t, i) : t, _ = e.length - 1, m; _ >= 0; _--)
    (m = e[_]) && (l = (c ? m(t, i, l) : m(l)) || l);
  return c && l && L(t, i, l), l;
}, y = (e, t, i) => t.has(e) || f("Cannot " + i), s = (e, t, i) => (y(e, t, "read from private field"), t.get(e)), v = (e, t, i) => t.has(e) ? f("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), p = (e, t, i, c) => (y(e, t, "write to private field"), t.set(e, i), i), d, h, n;
let a = class extends S(O) {
  ...
  async _handleDeleteSelected() {
    ...
    if (e === 0 || !await s(this, d)?.open(this, M, {
      data: {
  ...
  async _handleExport() {
    s(this, d) && s(this, d).open(this, z, {
      data: {}
    });
  }
  async _handleCreateOrder() {
    if (!s(this, d)) return;
    const t = await s(this, d).open(this, E, {
      data: {}
    }).onSubmit().catch(() => {
    });
...
//# sourceMappingURL=orders-list.element-BYknS8jA.js.map
