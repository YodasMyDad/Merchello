const e = [
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-B0D30_LW.js")
  },
  // Tree
  {
    type: "tree",
  ...
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-g204Bi4w.js"),
    meta: {
      entityType: i
    }
  },
  ...
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-BCQcxjEo.js"),
    meta: {
      entityType: E
    }
  },
  ...
  // Workspace for abandoned checkouts list (when clicking "Abandoned Checkouts" in tree)
  {
    ...
    api: () => import("./abandoned-checkouts-workspace.context-BOVQZfb-.js"),
    meta: {
      entityType: w
    }
  },
  ...
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-CilxkE7k.js"),
    meta: {
      entityType: t
    }
  },
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-BH11YvLX.js"),
    meta: {
      entityType: r
    }
  },
  ...
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-Bgl61jtx.js"),
    meta: {
      entityType: s
    }
  },
  ...
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-BBeBYb6a.js"),
    meta: {
      entityType: c
    }
  },
  ...
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-LtWcD9SA.js"),
    meta: {
      entityType: n
    }
  },
  ...
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-CP5tn4-x.js"),
    meta: {
      entityType: p
    }
  },
...
], A = [
  {
    ...
    api: () => import("./product-import-export-workspace.context-Dyc3L0-x.js"),
    meta: {
      entityType: m
    }
  },
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-k4QRBELD.js"),
    meta: {
      entityType: k
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-BZftTIAP.js"),
    meta: {
      entityType: d
    }
  },
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-DVVuhxY-.js"),
    meta: {
      entityType: h
    }
  },
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-CSJOYY6M.js"),
    meta: {
      entityType: u
    }
  },
  ...
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-DcFQIAnz.js"),
    meta: {
      entityType: P
    }
  },
  ...
  // Workspace for notifications (when clicking "Notifications" in tree)
  {
    ...
    api: () => import("./notifications-workspace.context-BlUUu8RA.js"),
    meta: {
      entityType: T
    }
  },
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-ChhiIjY1.js"),
    meta: {
      entityType: M
    }
  },
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-wU9KQ2wT.js"),
    meta: {
      entityType: y
    }
  },
...
], q = [
  {
    ...
    api: () => import("./upsells-workspace.context-wLo4wVII.js"),
    meta: {
      entityType: b
    }
  },
  ...
  // Workspace for root (when clicking "Merchello" in tree)
  {
    ...
    api: () => import("./settings-workspace.context-CH8P7YOD.js"),
    meta: {
      entityType: l
    }
  },
  {
    ...
    js: () => import("./settings-workspace.element-B_I00Z-Y.js"),
    weight: 100,
    meta: {
      label: "Overview",
      pathname: "overview",
...
//# sourceMappingURL=bundle.manifests-9kvtxP0B.js.map
