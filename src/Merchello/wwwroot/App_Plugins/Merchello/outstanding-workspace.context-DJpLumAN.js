...
import { b as e } from "./bundle.manifests-BeYhXq8T.js";
  ...
  constructor(t) {
    super(t, s.toString()), this.workspaceAlias = r, this.#t = new n(this), this.#t.setEntityType(e), this.#t.setUnique("outstanding"), this.routes = new i(t), this.routes.setRoutes([
      // Outstanding list route
      {
        ...
        component: () => import("./outstanding-workspace-editor.element-BdVghGiz.js"),
        setup: () => {
        }
      },
      // Default redirect
...
//# sourceMappingURL=outstanding-workspace.context-DJpLumAN.js.map
