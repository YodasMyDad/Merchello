const e = [
  {
    ...
    js: () => import("./entrypoint-BlDF2Fj8.js")
  }
], o = [
  // Section
  {
  ...
  // Stats Dashboard
  {
    ...
    element: () => import("./stats-dashboard.element-Cn7sIsSI.js"),
    meta: {
      label: "Stats",
      pathname: "stats"
    },
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-CWfFQsC6.js")
  },
  // Tree
  {
    type: "tree",
  ...
  // Fulfillment modal for creating shipments
  {
    ...
    js: () => import("./fulfillment-modal.element-DVgnyofm.js")
  },
  // Shipment edit modal for updating tracking info
  {
    ...
    js: () => import("./shipment-edit-modal.element-X3_VUQAj.js")
  },
  // Manual payment modal for recording offline payments
  {
    ...
    js: () => import("./manual-payment-modal.element-DqTrOxVE.js")
  },
  // Refund modal for processing refunds
  {
    ...
    js: () => import("./refund-modal.element-CbwQlmYp.js")
  },
  // Cancel invoice modal for cancelling invoices
  {
    ...
    js: () => import("./cancel-invoice-modal.element-N-yne0wf.js")
  },
  // Export modal for exporting orders to CSV
  {
    ...
    js: () => import("./export-modal.element-COuTl8dY.js")
  },
  // Edit order modal for editing order details
  {
    ...
    js: () => import("./edit-order-modal.element-B87J7LJd.js")
  },
  // Add custom item modal for edit order
  {
    ...
    js: () => import("./add-custom-item-modal.element-Bu0s-pv3.js")
  },
  // Add discount modal for edit order
  {
    ...
    js: () => import("./add-discount-modal.element-Dp6WCadj.js")
  },
  // Create order modal for creating manual orders from backoffice
  {
    ...
    js: () => import("./create-order-modal.element-Dg1F-2EL.js")
  },
  // Customer orders modal for viewing all orders by a customer
  {
    ...
    js: () => import("./customer-orders-modal.element-CgRTfQkH.js")
  },
  // Generate statement modal for downloading customer statement PDFs
  {
    ...
    js: () => import("./generate-statement-modal.element-B7bCwuXu.js")
  },
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-DvfJigad.js"),
    meta: {
      entityType: i
    }
  },
  // Workspace view - the orders list (used when on list route)
  {
    ...
    js: () => import("./orders-list.element-cKMA2YqB.js"),
    weight: 100,
    meta: {
      label: "Orders",
      pathname: "list",
  ...
  // Mark as paid modal
  {
    ...
    js: () => import("./mark-as-paid-modal.element-BAKDTtia.js")
  },
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-D5rPoevp.js"),
    meta: {
      entityType: E
    }
  },
  // Workspace view - the outstanding list
  {
    ...
    js: () => import("./outstanding-list.element-DDd_yjU8.js"),
    weight: 100,
    meta: {
      label: "Outstanding",
      pathname: "list",
  ...
  // Workspace for abandoned checkouts list (when clicking "Abandoned Checkouts" in tree)
  {
    ...
    api: () => import("./abandoned-checkouts-workspace.context-BIJJTuOJ.js"),
    meta: {
      entityType: w
    }
  },
  // Workspace view - the abandoned checkouts list
  {
    ...
    js: () => import("./abandoned-checkouts-list.element-W_gG-kQd.js"),
    weight: 100,
    meta: {
  ...
  // Create product modal
  {
    ...
    js: () => import("./create-product-modal.element-Qeanr_Ce.js")
  },
  // Option editor modal
  {
    type: "modal",
  ...
  // Variant batch update modal
  {
    ...
    js: () => import("./variant-batch-update-modal.element-CPdjuFeE.js")
  },
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-Do-LXs31.js"),
    meta: {
      entityType: t
    }
  },
  // Workspace view for products list (used when on list route)
  {
    ...
    js: () => import("./products-list.element-vBGVNajx.js"),
    weight: 100,
    meta: {
      label: "Products",
      pathname: "products",
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-tx0UxwS5.js"),
    meta: {
      entityType: r
    }
  },
  // Workspace view - the customers list
  {
    ...
    js: () => import("./customers-list.element-9qaWqlGq.js"),
    weight: 100,
    meta: {
      label: "Customers",
      pathname: "list",
  ...
  // Workspace view - the segments list (tab in Customers workspace)
  {
    ...
    js: () => import("./segments-list.element-DhmLl9dh.js"),
    weight: 90,
    meta: {
      label: "Segments",
      pathname: "segments",
  ...
  // Customer edit modal
  {
    ...
    js: () => import("./customer-edit-modal.element-Bm9BwBjE.js")
  },
  // Customer picker modal (for adding members to segments)
  {
    ...
    js: () => import("./customer-picker-modal.element-BxKr5oBy.js")
  },
  // Segment picker modal (for discount eligibility)
  {
    ...
    js: () => import("./segment-picker-modal.element-DktSrxAw.js")
  }
], S = [
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-Dm5iHI_F.js"),
    meta: {
      entityType: s
    }
  },
  // Workspace view for collections
  {
    ...
    js: () => import("./collections-workspace.element-DptTAZU7.js"),
    weight: 100,
    meta: {
      label: "Collections",
  ...
  // Collection picker modal (for discount targeting)
  {
    ...
    js: () => import("./collection-picker-modal.element-D-bNBKNV.js")
  },
  // Collection create/edit modal
  {
    ...
    js: () => import("./collection-modal.element-CzfaX-rN.js")
  }
], j = [
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-BN0F3X6c.js"),
    meta: {
      entityType: c
    }
  },
  // Workspace view for filters list
  {
    ...
    js: () => import("./filters-list.element-WI9PfZuA.js"),
    weight: 100,
    meta: {
      label: "Filters",
      pathname: "filters",
  ...
  // Modal for creating/editing filter groups
  {
    ...
    js: () => import("./filter-group-modal.element-DnGNP0nF.js")
  },
  // Modal for creating/editing filters
  {
    ...
    js: () => import("./filter-modal.element-CxY1WdWK.js")
  },
  // Filter picker modal (for discount targeting)
  {
    ...
    js: () => import("./filter-picker-modal.element-XEKPjZ9O.js")
  },
  // Filter group picker modal (for property editor)
  {
    ...
    js: () => import("./filter-group-picker-modal.element-B0dZCxKT.js")
  }
], V = [
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-Xf3fMdqP.js"),
    meta: {
      entityType: n
    }
  },
  // Workspace view for product types
  {
    ...
    js: () => import("./product-types-list.element-DW4LROm1.js"),
    weight: 100,
    meta: {
      label: "Product Types",
  ...
  // Modal for create/edit product type
  {
    ...
    js: () => import("./product-type-modal.element-BdOnHVXz.js")
  },
  // Product type picker modal (for discount targeting)
  {
    ...
    js: () => import("./product-type-picker-modal.element-DXVoG-qE.js")
  }
], v = [
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-D1pQWlpn.js"),
    meta: {
      entityType: p
    }
  },
  // Workspace view for product feed
  {
    ...
    js: () => import("./product-feeds-list.element-CP5uMZ4p.js"),
    weight: 100,
    meta: {
      label: "Product Feeds",
  ...
  },
  {
    ...
    js: () => import("./product-feed-validation-modal.element-DxbIqwJH.js")
  }
], A = [
  {
    type: "workspace",
    ...
    api: () => import("./product-import-export-workspace.context-WntCLHTJ.js"),
    meta: {
      entityType: m
    }
  },
  {
    ...
    js: () => import("./product-import-export-page.element-CB5rYjY1.js"),
    weight: 100,
    meta: {
      label: "Import & Export",
      pathname: "sync",
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-BElaGKNY.js"),
    meta: {
      entityType: k
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-DM44ySOD.js"),
    meta: {
      entityType: d
    }
  },
  // Workspace view for analytics
  {
    ...
    js: () => import("./analytics-workspace.element-BXZGxHTz.js"),
    weight: 100,
    meta: {
      label: "Analytics",
      pathname: "analytics",
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-3EhUAurW.js"),
    meta: {
      entityType: h
    }
  },
  // Workspace view for discounts list (used when on list route)
  {
    ...
    js: () => import("./discounts-list.element-DqTc0p9h.js"),
    weight: 100,
    meta: {
      label: "Discounts",
      pathname: "discounts",
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-BTEXlJZN.js"),
    meta: {
      entityType: u
    }
  },
  // Workspace view - the email list
  {
    ...
    js: () => import("./email-list.element-CgE1Mv91.js"),
    weight: 100,
    meta: {
      label: "Emails",
      pathname: "list",
  ...
  // Email preview modal
  {
    ...
    js: () => import("./email-preview-modal.element-Bus1sVas.js")
  }
], x = [
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-wtbz9b2p.js"),
    meta: {
      entityType: P
    }
  },
  // Workspace view - the webhooks list
  {
    ...
    js: () => import("./webhooks-list.element-R9UtprcE.js"),
    weight: 100,
    meta: {
      label: "Webhooks",
      pathname: "list",
  ...
  // Webhook subscription create/edit modal
  {
    ...
    js: () => import("./webhook-subscription-modal.element-CaVIalmE.js")
  },
  // Webhook test modal
  {
    type: "modal",
    ...
    js: () => import("./webhook-test-modal.element-D5cq4Nq8.js")
  },
  // Delivery detail modal
  {
    ...
    js: () => import("./delivery-detail-modal.element-BDsTziKN.js")
  },
  ...
  // Workspace for notifications (when clicking "Notifications" in tree)
  {
    ...
    api: () => import("./notifications-workspace.context-DPYMOmvq.js"),
    meta: {
      entityType: T
    }
  },
  ...
  // Workspace view for tax providers list (appears as "Tax" tab in Providers workspace)
  {
    ...
    js: () => import("./tax-providers-list.element-ByyAncqs.js"),
    weight: 85,
    meta: {
      label: "Tax",
      pathname: "tax",
  ...
  // Tax group modal (handles both create and edit)
  {
    ...
    js: () => import("./tax-group-modal.element-BPLhOzoU.js")
  },
  // Tax rate modal (handles both create and edit for geographic rates)
  {
    ...
    js: () => import("./tax-rate-modal.element-D0emlw_B.js")
  },
  // Tax provider config modal
  {
    ...
    js: () => import("./tax-provider-config-modal.element-BR8OxSCN.js")
  },
  // Test tax provider modal
  {
    ...
    js: () => import("./test-tax-provider-modal.element-DUxy8rNO.js")
  },
  // Shipping tax override modal
  {
    ...
    js: () => import("./shipping-tax-override-modal.element-D2x7RYHO.js")
  }
], Y = [
  // ============================================
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-CMqljkl4.js"),
    meta: {
      entityType: M
    }
  },
  // List view for suppliers
  {
    ...
    js: () => import("./suppliers-list.element-CQQKBTRg.js"),
    weight: 100,
    meta: {
      label: "Suppliers",
      pathname: "suppliers",
  ...
  // Supplier modal (handles both create and edit)
  {
    ...
    js: () => import("./supplier-modal.element-DMPv-Lpn.js")
  },
  // Supplier picker modal (for discount targeting)
  {
    ...
    js: () => import("./supplier-picker-modal.element-MRTA5YTM.js")
  }
], D = [
  // ============================================
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-D9YJAuPd.js"),
    meta: {
      entityType: y
    }
  },
  // List view for warehouses (used when on list route)
  {
    ...
    js: () => import("./warehouses-list.element-DEkoumNk.js"),
    weight: 100,
    meta: {
      label: "Warehouses",
      pathname: "warehouses",
  ...
  // Service region modal
  {
    ...
    js: () => import("./service-region-modal.element-BrJ7s6ne.js")
  },
  // Warehouse picker modal (for discount targeting)
  {
    ...
    js: () => import("./warehouse-picker-modal.element-BVHU52-E.js")
  }
], $ = [
  // Workspace view for shipping providers (under Providers workspace)
  {
    ...
    js: () => import("./shipping-providers-list.element-CfWIJSph.js"),
    weight: 90,
    meta: {
      label: "Shipping",
      pathname: "shipping",
  ...
  // Shipping provider configuration modal
  {
    ...
    js: () => import("./shipping-provider-config-modal.element-DajdpssX.js")
  },
  // Test shipping provider modal
  {
    ...
    js: () => import("./test-provider-modal.element-DBQ0TM3r.js")
  },
  // Shipping option detail modal
  {
    ...
    js: () => import("./shipping-option-detail-modal.element-CzE06UZP.js")
  },
  // Shipping cost modal
  {
    type: "modal",
    ...
    js: () => import("./shipping-cost-modal.element-BQFOXfLB.js")
  },
  // Shipping weight tier modal
  {
    ...
    js: () => import("./shipping-weight-tier-modal.element-DX21Nhij.js")
  },
  // Shipping destination exclusion modal
  {
    ...
    js: () => import("./shipping-destination-exclusion-modal.element-Cqcmitph.js")
  },
  // Shipping postcode rule modal
  {
    ...
    js: () => import("./shipping-postcode-rule-modal.element-CTe2QAqt.js")
  }
], N = [
  // Workspace view for payment providers (under Providers workspace)
  {
    ...
    js: () => import("./payment-providers-list.element-DiQirq5V.js"),
    weight: 100,
    meta: {
      label: "Payments",
      pathname: "payments",
  ...
  // Modal for configuring a payment provider
  {
    ...
    js: () => import("./payment-provider-config-modal.element-Bym3iGha.js")
  },
  // Modal for configuring payment methods within a provider
  {
    ...
    js: () => import("./payment-methods-config-modal.element-DZpdUhTZ.js")
  },
  // Modal for editing a single payment method's display settings
  {
    ...
    js: () => import("./payment-method-edit-modal.element-BXHa0QuR.js")
  },
  ...
  // Modal for testing a payment provider
  {
    ...
    js: () => import("./test-provider-modal.element-CPzgu0HG.js")
  }
], H = [
  // Workspace view for fulfilment providers (under Providers workspace)
  {
    ...
    js: () => import("./fulfilment-providers-list.element-xhaU03Oh.js"),
    weight: 75,
    meta: {
      label: "Fulfilment",
      pathname: "fulfilment",
  ...
  // Configuration modal
  {
    ...
    js: () => import("./fulfilment-provider-config-modal.element-B-jlgci-.js")
  },
  // Test modal
  {
    type: "modal",
    ...
    js: () => import("./test-provider-modal.element-CDqFoJis.js")
  }
], G = [
  // Workspace view for exchange rate providers (under Providers workspace)
  {
    ...
    js: () => import("./exchange-rate-providers-list.element-BEMmPSq1.js"),
    weight: 80,
  ...
  // Modal for configuring an exchange rate provider
  {
    ...
    js: () => import("./exchange-rate-provider-config-modal.element-DGbadGF9.js")
  },
  // Modal for testing an exchange rate provider
  {
    ...
    js: () => import("./test-provider-modal.element-LySInOTE.js")
  }
], B = [
  // Workspace view for address lookup providers (under Providers workspace)
  {
    ...
    js: () => import("./address-lookup-providers-list.element-BfKEVm6V.js"),
    weight: 85,
    meta: {
  ...
  // Modal for configuring an address lookup provider
  {
    ...
    js: () => import("./address-lookup-provider-config-modal.element-DzRByGDe.js")
  },
  // Modal for testing an address lookup provider
  {
    ...
    js: () => import("./test-provider-modal.element-CPr1mFvy.js")
  }
], q = [
  {
    type: "workspace",
    ...
    api: () => import("./upsells-workspace.context-BDrWbvf8.js"),
    meta: {
      entityType: b
    }
  },
  {
    ...
    js: () => import("./upsells-list.element-T1vz9ov5.js"),
    weight: 100,
    meta: {
      label: "Upsells",
      pathname: "upsells",
  ...
  },
  {
    ...
    js: () => import("./create-upsell-modal.element-Bwx2HX4C.js")
  },
  {
    type: "modal",
  ...
  // Workspace for root (when clicking "Merchello" in tree)
  {
    ...
    api: () => import("./settings-workspace.context-BoS9w1mz.js"),
    meta: {
      entityType: l
    }
  },
  {
    ...
    js: () => import("./settings-workspace.element-DxT9Z618.js"),
    weight: 100,
    meta: {
      label: "Overview",
      pathname: "overview",
  ...
  // Product picker modal for selecting products in orders and property editors
  {
    ...
    js: () => import("./product-picker-modal.element-Ca4VeNjX.js")
  }
], X = [
  {
    ...
    element: () => import("./property-editor-ui-collection-picker.element-Q30Mkc_v.js"),
    meta: {
...
], J = [
  {
    ...
    element: () => import("./property-editor-ui-product-type-picker.element-CO74_wee.js"),
    meta: {
...
], Q = [
  {
    ...
    element: () => import("./property-editor-ui-filter-group-picker.element-C4-Fl9a1.js"),
    meta: {
...
], Z = [
  {
    ...
    element: () => import("./property-editor-ui-filter-value-picker.element-DwQewXEQ.js"),
    meta: {
...
], ee = [
  {
    ...
    element: () => import("./property-editor-ui-product-picker.element-DKolkrPi.js"),
    meta: {
...
], oe = [
  {
    ...
    element: () => import("./property-editor-ui-google-shopping-category-picker.element-BaK-BFj8.js"),
    meta: {
...
//# sourceMappingURL=bundle.manifests-BY_NALon.js.map
