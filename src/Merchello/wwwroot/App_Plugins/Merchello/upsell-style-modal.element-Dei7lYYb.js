...
var m = Object.defineProperty, f = Object.getOwnPropertyDescriptor, u = (e, t, r, i) => {
  for (var o = i > 1 ? void 0 : i ? f(t, r) : t, a = e.length - 1, l; a >= 0; a--)
...
let d = class extends y {
  ...
  _setElementStyle(e, t, r) {
    const i = { ...this._styles }, o = { ...this._getSurfaceStyle(e) }, a = { ...this._getElementStyle(e, t) }, l = r(a);
    this._isElementStyleEmpty(l) ? delete o[t] : o[t] = l, this._isSurfaceStyleEmpty(o) ? delete i[e] : i[e] = o, this._styles = i;
  }
  _handleColorChange(e, t, r, i) {
  ...
  _handleBorderStyleChange(e, t, r) {
    const o = r.target.value?.trim() ?? "";
    this._setElementStyle(e, t, (a) => ({
      ...a,
      borderStyle: o || void 0
    }));
  }
  _handleNumberChange(e, t, r, i) {
    const a = i.target.value?.trim();
    if (!a) {
  ...
  _normalizeStyles(e) {
    ...
    for (const r of c) {
      ...
      this._isSurfaceStyleEmpty(o) || (t[r.key] = o);
    }
  ...
  _renderColorPicker(e, t, r, i, o) {
    return s`
      <div class="field-row">
        <label>${i}</label>
        <uui-color-picker
          .value=${o ?? ""}
          @change=${(a) => this._handleColorChange(e, t, r, a)}
        ></uui-color-picker>
      </div>
    `;
  }
  _renderElementEditor(e) {
    const t = this._activeSurface, r = this._getElementStyle(t, e.key);
    return s`
      <uui-box headline=${e.label}>
        <div class="element-editor">
          <div class="element-grid">
            ${this._renderColorPicker(t, e.key, "textColor", "Text color", r.textColor)}
            ${this._renderColorPicker(t, e.key, "backgroundColor", "Background", r.backgroundColor)}
            ${this._renderColorPicker(t, e.key, "borderColor", "Border color", r.borderColor)}
          </div>
      ...
      name: i.label,
      value: i.value,
      selected: (r.borderStyle ?? "") === i.value
    }))}
                @change=${(i) => this._handleBorderStyleChange(t, e.key, i)}
              ></uui-select>
            </div>
            ...
            <div class="field-row">
              ...
              <uui-input
                ...
                min="0"
                max="12"
                .value=${r.borderWidth != null ? String(r.borderWidth) : ""}
                @input=${(i) => this._handleNumberChange(t, e.key, "borderWidth", i)}
              ></uui-input>
            </div>
            ...
            <div class="field-row">
              ...
              <uui-input
                ...
                min="0"
                max="64"
                .value=${r.borderRadius != null ? String(r.borderRadius) : ""}
                @input=${(i) => this._handleNumberChange(t, e.key, "borderRadius", i)}
              ></uui-input>
            </div>
          </div>

          <div class="element-actions">
            <uui-button look="secondary" compact @click=${() => this._clearElement(t, e.key)}>
              Clear ${e.label}
            </uui-button>
          </div>
        </div>
            ...
            <div class="preview-column">
              <uui-box headline="Live Preview">
                ...
                <div class="preview-actions">
                  <uui-button look="secondary" compact @click=${() => {
...
//# sourceMappingURL=upsell-style-modal.element-Dei7lYYb.js.map
