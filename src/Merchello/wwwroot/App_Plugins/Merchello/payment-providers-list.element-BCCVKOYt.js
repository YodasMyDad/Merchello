import { LitElement as y, nothing as o, html as r, css as P, state as v, customElement as x } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as $ } from "@umbraco-cms/backoffice/element-api";
import { UmbModalToken as k, UMB_MODAL_MANAGER_CONTEXT as M } from "@umbraco-cms/backoffice/modal";
...
const E = new k("Merchello.PaymentProvider.Config.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
...
var z = Object.defineProperty, I = Object.getOwnPropertyDescriptor, b = (e) => {
  ...
  for (var n = l > 1 ? void 0 : l ? I(i, a) : i, f = e.length - 1, g; f >= 0; f--)
    (g = e[f]) && (n = (l ? g(i, a, n) : g(n)) || n);
  return l && n && z(i, a, n), n;
}, _ = (e, i, a) => i.has(e) || b("Cannot " + a), s = (e, i, a) => (_(e, i, "read from private field"), i.get(e)), h = (e, i, a) => i.has(e) ? b("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, a), m = (e, i, a, l) => (_(e, i, "write to private field"), i.set(e, a), a), d, u;
let t = class extends $(y) {
  constructor() {
    super(), this._availableProviders = [], this._configuredProviders = [], this._isLoading = !0, this._errorMessage = null, h(this, d), h(this, u), this.consumeContext(M, (e) => {
      m(this, d, e);
...
//# sourceMappingURL=payment-providers-list.element-BCCVKOYt.js.map
