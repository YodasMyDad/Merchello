import { LitElement as z, html as a, nothing as f, css as M, state as s, customElement as P, query as A } from "@umbraco-cms/backoffice/external/lit";
...
let o = class extends V(z) {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), w(this, x, !1), m(this, y) && (clearInterval(m(this, y)), w(this, y, null));
  }
  async reload(e = !1) {
...
o = n([
  P("merchello-product-sync-runs-list")
], o);
var T = Object.defineProperty, q = Object.getOwnPropertyDescriptor, B = (e) => {
  throw TypeError(e);
}, h = (e, t, i, r) => {
  for (var l = r > 1 ? void 0 : r ? q(t, i) : t, u = e.length - 1, g; u >= 0; u--)
    (g = e[u]) && (l = (r ? g(t, i, l) : g(l)) || l);
  return r && l && T(t, i, l), l;
}, W = (e, t, i) => t.has(e) || B("Cannot " + i), S = (e, t, i) => (W(e, t, "read from private field"), t.get(e)), k = (e, t, i) => t.has(e) ? B("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), F = (e, t, i, r) => (W(e, t, "write to private field"), t.set(e, i), i), R, v;
let d = class extends V(z) {
  constructor() {
    super(), this._importProfile = p.ShopifyStrict, this._exportProfile = p.ShopifyStrict, this._continueOnImageFailure = !1, this._selectedFile = null, this._validationResult = null, this._validationError = null, this._isValidating = !1, this._isStartingImport = !1, this._isStartingExport = !1, k(this, R), k(this, v, !1), this.consumeContext(L, (e) => {
      F(this, R, e);
    });
  }
  connectedCallback() {
    super.connectedCallback(), F(this, v, !0);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), F(this, v, !1);
  }
  _notify(e, t, i) {
    S(this, R)?.peek(e, {
      data: {
...
d = h([
  P("merchello-product-import-export-page")
], d);
const X = d;
export {
...
//# sourceMappingURL=product-import-export-page.element-CX-9nJxt.js.map
