...
async function r(e) {
  try {
    const t = await $(), s = d.baseUrl || "", i = await fetch(`${s}${m}/${e}`, {
      method: "GET",
    ...
    let u;
    return a.includes("application/json") ? u = await i.json() : u = await i.text(), { data: u };
  } catch (t) {
...
async function o(e, t) {
  try {
    const s = await $(), i = d.baseUrl || "", a = await fetch(`${i}${m}/${e}`, {
      method: "POST",
      credentials: d.credentials,
      headers: s,
...
const w = {
  ...
  downloadCustomerStatement: async (e, t, s) => {
    try {
      const i = await $(), a = d.baseUrl || "", u = new URLSearchParams();
...
//# sourceMappingURL=merchello-api-B3MRCR4s.js.map
