...
import { a as o } from "./bundle.manifests-BqlsFMaM.js";
...
class _ extends i {
  constructor(t) {
    super(t, n.toString()), this.workspaceAlias = m, this.#r = new a(this), this.#e = new p(void 0), this.order = this.#e.asObservable(), this.#r.setEntityType(o), this.#r.setUnique("orders"), this.routes = new d(t), this.routes.setRoutes([
      ...
      {
        path: "edit/orders/:id",
        component: () => import("./order-detail.element-CcTPZckI.js"),
        setup: (r, e) => {
...
//# sourceMappingURL=orders-workspace.context-D6gZAHVT.js.map
