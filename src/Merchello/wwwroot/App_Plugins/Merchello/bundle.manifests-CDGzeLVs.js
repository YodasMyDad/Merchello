const e = [
  {
    ...
    js: () => import("./entrypoint-BahdQYmN.js")
  }
], o = [
  // Section
  {
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-gjU-WIec.js")
  },
  // Tree
  {
    type: "tree",
  ...
  // Edit order modal for editing order details
  {
    ...
    js: () => import("./edit-order-modal.element-I3m84Z9k.js")
  },
  // Add custom item modal for edit order
  {
    ...
    js: () => import("./add-custom-item-modal.element-DHygbEFs.js")
  },
  ...
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-C5nfhurK.js"),
    meta: {
      entityType: l
    }
  },
  ...
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-DJGeD2WS.js"),
    meta: {
      entityType: k
    }
  },
  ...
  // Workspace for abandoned checkouts list (when clicking "Abandoned Checkouts" in tree)
  {
    ...
    api: () => import("./abandoned-checkouts-workspace.context-anTnNf3h.js"),
    meta: {
      entityType: P
    }
  },
  ...
  // Create product modal
  {
    ...
    js: () => import("./create-product-modal.element-DF79mzQI.js")
  },
  // Option editor modal
  {
    type: "modal",
  ...
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-1_vAPQ3r.js"),
    meta: {
      entityType: i
    }
  },
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-CWsjrCBh.js"),
    meta: {
      entityType: t
    }
  },
  ...
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-BZtLCw1v.js"),
    meta: {
      entityType: r
    }
  },
  ...
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-B8CWnkyk.js"),
    meta: {
      entityType: s
    }
  },
  ...
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-CljTHn7D.js"),
    meta: {
      entityType: c
    }
  },
  ...
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-CAP28-Fa.js"),
    meta: {
      entityType: n
    }
  },
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-Cl8Ei8bo.js"),
    meta: {
      entityType: u
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-zVB2TCCh.js"),
    meta: {
      entityType: p
    }
  },
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-B5KcK0Mx.js"),
    meta: {
      entityType: m
    }
  },
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-BCsvAVgk.js"),
    meta: {
      entityType: M
    }
  },
  ...
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-xy7xyHkn.js"),
    meta: {
      entityType: y
    }
  },
  ...
  // Workspace for notifications (when clicking "Notifications" in tree)
  {
    ...
    api: () => import("./notifications-workspace.context-CFFVSBQL.js"),
    meta: {
      entityType: w
    }
  },
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-CzfCce5i.js"),
    meta: {
      entityType: d
    }
  },
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-CQMNfyCJ.js"),
    meta: {
      entityType: h
    }
  },
  ...
  // Modal for configuring payment methods within a provider
  {
    ...
    js: () => import("./payment-methods-config-modal.element-isDeNryo.js")
  },
...
], H = [
  {
    ...
    api: () => import("./upsells-workspace.context-DSHdwjwd.js"),
    meta: {
      entityType: E
    }
  },
...
], q = [
  {
    ...
    element: () => import("./property-editor-ui-collection-picker.element-CLYUAq0P.js"),
    meta: {
...
], K = [
  {
    ...
    element: () => import("./property-editor-ui-product-type-picker.element-BnMIPlTK.js"),
    meta: {
...
], z = [
  {
    ...
    element: () => import("./property-editor-ui-filter-group-picker.element-JSRmlwqy.js"),
    meta: {
...
], J = [
  {
    ...
    element: () => import("./property-editor-ui-filter-value-picker.element-B9Vsq3Zx.js"),
    meta: {
...
], Q = [
  {
    ...
    element: () => import("./property-editor-ui-product-picker.element-DULyTAFI.js"),
    meta: {
...
//# sourceMappingURL=bundle.manifests-CDGzeLVs.js.map
