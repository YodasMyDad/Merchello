import { html as n, nothing as u, css as C, state as a, customElement as b } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as w } from "@umbraco-cms/backoffice/modal";
import { M as c } from "./merchello-api-NCGQOO9L.js";
import { g as $, a as v } from "./store-settings-tgn1o2ap.js";
var S = Object.defineProperty, x = Object.getOwnPropertyDescriptor, f = (t) => {
  throw TypeError(t);
}, r = (t, e, o, l) => {
  for (var s = l > 1 ? void 0 : l ? x(e, o) : e, h = t.length - 1, p; h >= 0; h--)
    (p = t[h]) && (s = (l ? p(e, o, s) : p(s)) || s);
  return l && s && S(e, o, s), s;
}, y = (t, e, o) => e.has(t) || f("Cannot " + o), g = (t, e, o) => (y(t, e, "read from private field"), e.get(t)), O = (t, e, o) => e.has(t) ? f("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, o), _ = (t, e, o, l) => (y(t, e, "write to private field"), e.set(t, o), o), d;
...
let i = class extends w {
  ...
  async _handleTest() {
    ...
    const e = {
      ...
      heightCm: this._heightCm ? parseFloat(this._heightCm) : void 0,
      itemsSubtotal: this._itemsSubtotal
    }, { data: o, error: l } = await c.testShippingProvider(t, e);
    if (g(this, d)) {
      if (l) {
  ...
  _renderResults() {
    ...
    const { success: t, serviceLevels: e, errors: o } = this._testResult, l = v();
    return n`
...
//# sourceMappingURL=test-provider-modal.element-BmpjYF0c.js.map
