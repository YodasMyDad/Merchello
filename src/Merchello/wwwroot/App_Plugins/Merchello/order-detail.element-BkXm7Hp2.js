import { LitElement as N, nothing as o, html as a, css as F, state as l, customElement as R, property as Q, unsafeHTML as Z } from "@umbraco-cms/backoffice/external/lit";
...
import { b as O, a as c, h as te } from "./formatting-CojPLOGY.js";
import { M as g } from "./merchello-api-D2U6vWKR.js";
...
var ne = Object.defineProperty, le = Object.getOwnPropertyDescriptor, G = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? le(i, t) : i, n = e.length - 1, m; n >= 0; n--)
    (m = e[n]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && ne(i, t, r), r;
}, V = (e, i, t) => i.has(e) || G("Cannot " + t), x = (e, i, t) => (V(e, i, "read from private field"), t ? t.call(e) : i.get(e)), A = (e, i, t) => i.has(e) ? G("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), T = (e, i, t, s) => (V(e, i, "write to private field"), i.set(e, t), t), M, E, $;
let _ = class extends U(N) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, A(this, M), A(this, E), A(this, $, !1), this.consumeContext(W, (e) => {
      T(this, M, e), this.observe(x(this, M).order, (i) => {
  ...
  async _handleDeleteShipment(e) {
    ...
    if (x(this, $)) {
      ...
      this._loadShipments(), this._invoiceId && x(this, M)?.load(this._invoiceId);
    }
  }
...
var ce = Object.defineProperty, pe = Object.getOwnPropertyDescriptor, X = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? pe(i, t) : i, n = e.length - 1, m; n >= 0; n--)
    (m = e[n]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && ce(i, t, r), r;
}, Y = (e, i, t) => i.has(e) || X("Cannot " + t), w = (e, i, t) => (Y(e, i, "read from private field"), i.get(e)), H = (e, i, t) => i.has(e) ? X("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), L = (e, i, t, s) => (Y(e, i, "write to private field"), i.set(e, t), t), b, k;
let f = class extends U(N) {
  constructor() {
    super(), this.invoiceId = "", this._payments = [], this._status = null, this._isLoading = !0, this._errorMessage = null, H(this, b), H(this, k, !1), this.consumeContext(j, (e) => {
      L(this, b, e);
    });
  }
  connectedCallback() {
  ...
  async _openManualPaymentModal() {
    if (!w(this, b) || !this._status) return;
    (await w(this, b).open(this, de, {
      data: {
...
C([
  Q({ type: String })
], f.prototype, "invoiceId", 2);
C([
  l()
], f.prototype, "_payments", 2);
C([
  l()
...
var me = Object.defineProperty, ve = Object.getOwnPropertyDescriptor, K = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? ve(i, t) : i, n = e.length - 1, m; n >= 0; n--)
    (m = e[n]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && me(i, t, r), r;
}, J = (e, i, t) => i.has(e) || K("Cannot " + t), u = (e, i, t) => (J(e, i, "read from private field"), i.get(e)), I = (e, i, t) => i.has(e) ? K("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), P = (e, i, t, s) => (J(e, i, "write to private field"), i.set(e, t), t), v, h, y;
let d = class extends U(N) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._activeTab = "details", this._newNoteText = "", this._visibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], I(this, v), I(this, h), I(this, y, !1), this.consumeContext(W, (e) => {
      P(this, v, e), u(this, v) && this.observe(u(this, v).order, (i) => {
  ...
  async _openFulfillmentModal() {
    if (!this._order || !u(this, h)) return;
    await u(this, h).open(this, ae, {
      ...
      (r) => a`
              <div class="fulfillment-line-item">
                ...
                <div class="fulfillment-item-pricing">
                  <span class="fulfillment-item-price">${c(r.amount)}</span>
                  <span class="fulfillment-item-multiply">×</span>
                  <span class="fulfillment-item-qty">${r.quantity}</span>
                </div>
                <div class="fulfillment-item-total">${c(r.amount * r.quantity)}</div>
              </div>
            `
    )}
        </div>
...
//# sourceMappingURL=order-detail.element-BkXm7Hp2.js.map
