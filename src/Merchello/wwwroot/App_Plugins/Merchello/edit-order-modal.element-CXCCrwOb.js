      ...
      <umb-body-layout headline="Edit Order">
        <div id="main">
          ...
          <div class="payment-section">
            ...
            ${this._orders.map((u, C) => n`
              <div class="payment-row shipping-row ${this._removedShippingOrders.has(u.id) ? "removed" : ""}">
                <span>${u.shippingMethodName ?? "Shipping"}${this._orders.length > 1 ? ` (Order ${C + 1})` : ""}</span>
...
//# sourceMappingURL=edit-order-modal.element-CXCCrwOb.js.map
