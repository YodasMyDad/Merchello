const e = [
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-DmO9qyH-.js")
  },
  // Tree
  {
    type: "tree",
  ...
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-CqyIHNOm.js"),
    meta: {
      entityType: i
    }
  },
  ...
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-DgKi2NpV.js"),
    meta: {
      entityType: E
    }
  },
  ...
  // Workspace for abandoned checkouts list (when clicking "Abandoned Checkouts" in tree)
  {
    ...
    api: () => import("./abandoned-checkouts-workspace.context-CuPyir2m.js"),
    meta: {
      entityType: w
    }
  },
  ...
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-Ru2BriIU.js"),
    meta: {
      entityType: t
    }
  },
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-BtIRxh9K.js"),
    meta: {
      entityType: r
    }
  },
  ...
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-4DCoaa9o.js"),
    meta: {
      entityType: s
    }
  },
  ...
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-C_KkukJN.js"),
    meta: {
      entityType: c
    }
  },
  ...
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-Uw4W3NIh.js"),
    meta: {
      entityType: n
    }
  },
  ...
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-BqP6VZT-.js"),
    meta: {
      entityType: p
    }
  },
...
], v = [
  {
    ...
    api: () => import("./product-import-export-workspace.context-CleMul1v.js"),
    meta: {
      entityType: m
    }
  },
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-BZfBdpiz.js"),
    meta: {
      entityType: k
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-BDD3-cZl.js"),
    meta: {
      entityType: d
    }
  },
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-CZXmZP4w.js"),
    meta: {
      entityType: h
    }
  },
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-DxNY8_k7.js"),
    meta: {
      entityType: u
    }
  },
  ...
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-BfUSg6tq.js"),
    meta: {
      entityType: P
    }
  },
  ...
  // Workspace for notifications (when clicking "Notifications" in tree)
  {
    ...
    api: () => import("./notifications-workspace.context-YjDuNWjX.js"),
    meta: {
      entityType: b
    }
  },
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-CVg3SEe_.js"),
    meta: {
      entityType: M
    }
  },
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-Do2871Yg.js"),
    meta: {
      entityType: y
    }
  },
...
], K = [
  {
    ...
    api: () => import("./upsells-workspace.context-DWaYi3s4.js"),
    meta: {
      entityType: T
    }
  },
  ...
  // Workspace for root (when clicking "Merchello" in tree)
  {
    ...
    api: () => import("./settings-workspace.context-C_UyVCAS.js"),
    meta: {
      entityType: l
    }
  },
  {
    ...
    js: () => import("./settings-workspace.element-CPbkZkom.js"),
    weight: 100,
    meta: {
      label: "Overview",
      pathname: "overview",
...
//# sourceMappingURL=bundle.manifests-DSqRhbgz.js.map
