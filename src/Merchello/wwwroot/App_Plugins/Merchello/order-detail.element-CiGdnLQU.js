import { LitElement as G, nothing as o, html as a, css as V, state as n, customElement as B, property as J, unsafeHTML as de } from "@umbraco-cms/backoffice/external/lit";
...
import { b as A, P as X, a as c, h as ee, j as ve } from "./formatting-DYmyPQEL.js";
import { M as h } from "./merchello-api-DPQ4r4XT.js";
...
}, te = (e, i, t) => i.has(e) || ie("Cannot " + t), k = (e, i, t) => (te(e, i, "read from private field"), t ? t.call(e) : i.get(e)), F = (e, i, t) => i.has(e) ? ie("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), D = (e, i, t, s) => (te(e, i, "write to private field"), i.set(e, t), t), O, E, U, w;
let z = class extends j(G) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, F(this, O), F(this, E), F(this, U), F(this, w, !1), this.consumeContext(Q, (e) => {
      D(this, O, e), this.observe(k(this, O).order, (i) => {
  ...
  async _handleDeleteShipment(e) {
    ...
    if (k(this, w)) {
      ...
      this._loadShipments(), this._invoiceId && k(this, O)?.load(this._invoiceId);
    }
  }
...
}, le = (e, i, t) => i.has(e) || ne("Cannot " + t), l = (e, i, t) => (le(e, i, "read from private field"), i.get(e)), R = (e, i, t) => i.has(e) ? ne("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), L = (e, i, t, s) => (le(e, i, "write to private field"), i.set(e, t), t), v, f, _, b;
let u = class extends j(G) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._routes = [], this._activePath = "", this._newNoteText = "", this._isVisibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", this._isSavingPurchaseOrder = !1, R(this, v), R(this, f), R(this, _), R(this, b, !1), this.consumeContext(Q, (e) => {
      L(this, v, e), l(this, v) && this.observe(l(this, v).order, (i) => {
  ...
  connectedCallback() {
    super.connectedCallback(), L(this, b, !0), this._createRoutes();
  }
  _createRoutes() {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), L(this, b, !1);
  }
...
//# sourceMappingURL=order-detail.element-CiGdnLQU.js.map
