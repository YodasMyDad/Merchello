...
var M = Object.defineProperty, z = Object.getOwnPropertyDescriptor, T = (e) => {
  ...
  for (var l = r > 1 ? void 0 : r ? z(i, a) : i, v = e.length - 1, m; v >= 0; v--)
    (m = e[v]) && (l = (r ? m(i, a, l) : m(l)) || l);
  return r && l && M(i, a, l), l;
...
let n = class extends w {
  ...
  async _loadData() {
    ...
    for (const l of this._fields)
      this._values[l.key] = r[l.key] ?? l.defaultValue ?? "";
  ...
  async _handleDeleteTaxGroup(e, i) {
    ...
    const { error: l } = await g.deleteTaxGroup(i.id);
    if (s(this, o)) {
      if (this._isDeleting = null, l) {
        s(this, h)?.peek("danger", {
          data: { headline: "Failed to delete", message: l.message || "Could not delete tax group" }
        });
        return;
      }
...
//# sourceMappingURL=tax-provider-config-modal.element-CvUDduwg.js.map
