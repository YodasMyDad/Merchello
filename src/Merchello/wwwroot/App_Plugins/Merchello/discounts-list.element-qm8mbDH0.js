...
import { e as B } from "./formatting-Bo-Avnc8.js";
...
let l = class extends M(k) {
  ...
  async _handleCreateDiscount() {
    if (!d(this, _)) return;
    const t = await d(this, _).open(this, W, {
      data: {}
    }).onSubmit().catch(() => {
    });
    d(this, p) && t?.selectedCategory !== void 0 && F(t.selectedCategory);
  }
...
//# sourceMappingURL=discounts-list.element-qm8mbDH0.js.map
