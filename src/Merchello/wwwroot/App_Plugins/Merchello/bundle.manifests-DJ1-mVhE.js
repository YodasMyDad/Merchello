const e = [
  {
    ...
    js: () => import("./entrypoint-PlWMAv3S.js")
  }
], o = [
  // Section
  {
  ...
  // Stats Dashboard
  {
    ...
    element: () => import("./stats-dashboard.element-DYl5rZK6.js"),
    meta: {
      label: "Stats",
      pathname: "stats"
    },
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-B-bbvKGM.js")
  },
  // Tree
  {
    type: "tree",
  ...
  // Fulfillment modal for creating shipments
  {
    ...
    js: () => import("./fulfillment-modal.element-BNVgI9dT.js")
  },
  // Shipment edit modal for updating tracking info
  {
    ...
    js: () => import("./shipment-edit-modal.element-WWP0KAq-.js")
  },
  // Manual payment modal for recording offline payments
  {
    ...
    js: () => import("./manual-payment-modal.element-BS0zHB-t.js")
  },
  // Refund modal for processing refunds
  {
    ...
    js: () => import("./refund-modal.element-C7Mt4JhM.js")
  },
  // Cancel invoice modal for cancelling invoices
  {
    ...
    js: () => import("./cancel-invoice-modal.element-CUZSy1S0.js")
  },
  // Export modal for exporting orders to CSV
  {
    ...
    js: () => import("./export-modal.element-Dm4jnQHf.js")
  },
  // Edit order modal for editing order details
  {
    ...
    js: () => import("./edit-order-modal.element-BgsGVjJX.js")
  },
  // Add custom item modal for edit order
  {
    ...
    js: () => import("./add-custom-item-modal.element-DK-woUFt.js")
  },
  // Add discount modal for edit order
  {
    ...
    js: () => import("./add-discount-modal.element-Cjk1dKIt.js")
  },
  // Create order modal for creating manual orders from backoffice
  {
    ...
    js: () => import("./create-order-modal.element-Y2uLrItB.js")
  },
  // Customer orders modal for viewing all orders by a customer
  {
    ...
    js: () => import("./customer-orders-modal.element-IAqNdrQv.js")
  },
  // Generate statement modal for downloading customer statement PDFs
  {
    ...
    js: () => import("./generate-statement-modal.element-F1A-3ZWl.js")
  },
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-BEvLWi52.js"),
    meta: {
      entityType: i
    }
  },
  // Workspace view - the orders list (used when on list route)
  {
    ...
    js: () => import("./orders-list.element-BkeCRa7k.js"),
    weight: 100,
    meta: {
      label: "Orders",
      pathname: "list",
  ...
  // Mark as paid modal
  {
    ...
    js: () => import("./mark-as-paid-modal.element-CBUeD7Qe.js")
  },
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-BS1VjrFu.js"),
    meta: {
      entityType: P
    }
  },
  // Workspace view - the outstanding list
  {
    ...
    js: () => import("./outstanding-list.element-D7LaNkGQ.js"),
    weight: 100,
    meta: {
      label: "Outstanding",
      pathname: "list",
  ...
  // Workspace for abandoned checkouts list (when clicking "Abandoned Checkouts" in tree)
  {
    ...
    api: () => import("./abandoned-checkouts-workspace.context-BFWRvUe9.js"),
    meta: {
      entityType: w
    }
  },
  // Workspace view - the abandoned checkouts list
  {
    ...
    js: () => import("./abandoned-checkouts-list.element-BjIlGkCX.js"),
    weight: 100,
    meta: {
  ...
  // Create product modal
  {
    ...
    js: () => import("./create-product-modal.element-0eCm6Sxc.js")
  },
  // Option editor modal
  {
    type: "modal",
  ...
  // Variant batch update modal
  {
    ...
    js: () => import("./variant-batch-update-modal.element-DAa79yA5.js")
  },
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-CJUgqbzt.js"),
    meta: {
      entityType: t
    }
  },
  // Workspace view for products list (used when on list route)
  {
    ...
    js: () => import("./products-list.element-ByUJ7R6s.js"),
    weight: 100,
    meta: {
      label: "Products",
      pathname: "products",
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-BE7ysU3l.js"),
    meta: {
      entityType: r
    }
  },
  // Workspace view - the customers list
  {
    ...
    js: () => import("./customers-list.element-CzgXOA8_.js"),
    weight: 100,
    meta: {
      label: "Customers",
      pathname: "list",
  ...
  // Workspace view - the segments list (tab in Customers workspace)
  {
    ...
    js: () => import("./segments-list.element-DWWpx6pT.js"),
    weight: 90,
    meta: {
      label: "Segments",
      pathname: "segments",
  ...
  // Customer edit modal
  {
    ...
    js: () => import("./customer-edit-modal.element-C1BYnWSg.js")
  },
  // Customer picker modal (for adding members to segments)
  {
    ...
    js: () => import("./customer-picker-modal.element-2ciQNV8Z.js")
  },
  // Segment picker modal (for discount eligibility)
  {
    ...
    js: () => import("./segment-picker-modal.element-B_h9sUL8.js")
  }
], U = [
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-DMDo94Zz.js"),
    meta: {
      entityType: s
    }
  },
  // Workspace view for collections
  {
    ...
    js: () => import("./collections-workspace.element-y323hCdZ.js"),
    weight: 100,
    meta: {
      label: "Collections",
  ...
  // Collection picker modal (for discount targeting)
  {
    ...
    js: () => import("./collection-picker-modal.element-D-dW-Ni7.js")
  },
  // Collection create/edit modal
  {
    ...
    js: () => import("./collection-modal.element-FH3x2bNN.js")
  }
], S = [
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-B4Zi0kKX.js"),
    meta: {
      entityType: c
    }
  },
  // Workspace view for filters list
  {
    ...
    js: () => import("./filters-list.element-Cj73_d7N.js"),
    weight: 100,
    meta: {
      label: "Filters",
      pathname: "filters",
  ...
  // Modal for creating/editing filter groups
  {
    ...
    js: () => import("./filter-group-modal.element-yb_uYcbN.js")
  },
  // Modal for creating/editing filters
  {
    ...
    js: () => import("./filter-modal.element-DD9xbJoP.js")
  },
  // Filter picker modal (for discount targeting)
  {
    ...
    js: () => import("./filter-picker-modal.element-CmFFUoRs.js")
  },
  // Filter group picker modal (for property editor)
  {
    ...
    js: () => import("./filter-group-picker-modal.element-D1mq6QKH.js")
  }
], j = [
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-DM37tGp9.js"),
    meta: {
      entityType: n
    }
  },
  // Workspace view for product types
  {
    ...
    js: () => import("./product-types-list.element-vnwvKNLT.js"),
    weight: 100,
    meta: {
      label: "Product Types",
  ...
  // Modal for create/edit product type
  {
    ...
    js: () => import("./product-type-modal.element-BhudIT79.js")
  },
  // Product type picker modal (for discount targeting)
  {
    ...
    js: () => import("./product-type-picker-modal.element-Dlky0m0k.js")
  }
], V = [
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-C2SanJws.js"),
    meta: {
      entityType: p
    }
  },
  // Workspace view for product feed
  {
    ...
    js: () => import("./product-feeds-list.element-B2S3PG_j.js"),
    weight: 100,
    meta: {
      label: "Product Feeds",
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-DdmtNkbs.js"),
    meta: {
      entityType: u
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-Ddnm88jr.js"),
    meta: {
      entityType: m
    }
  },
  // Workspace view for analytics
  {
    ...
    js: () => import("./analytics-workspace.element-yiW1x81Y.js"),
    weight: 100,
    meta: {
      label: "Analytics",
      pathname: "analytics",
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-_HaRQT23.js"),
    meta: {
      entityType: d
    }
  },
  // Workspace view for discounts list (used when on list route)
  {
    ...
    js: () => import("./discounts-list.element-DMcwNKLq.js"),
    weight: 100,
    meta: {
      label: "Discounts",
      pathname: "discounts",
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-vV5fVPNo.js"),
    meta: {
      entityType: y
    }
  },
  // Workspace view - the email list
  {
    ...
    js: () => import("./email-list.element-BMypAV4H.js"),
    weight: 100,
    meta: {
      label: "Emails",
      pathname: "list",
  ...
  // Email preview modal
  {
    ...
    js: () => import("./email-preview-modal.element-BilaD2nP.js")
  }
], I = [
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-BX6WVNLM.js"),
    meta: {
      entityType: k
    }
  },
  // Workspace view - the webhooks list
  {
    ...
    js: () => import("./webhooks-list.element-CsBIaXE3.js"),
    weight: 100,
    meta: {
      label: "Webhooks",
      pathname: "list",
  ...
  // Webhook subscription create/edit modal
  {
    ...
    js: () => import("./webhook-subscription-modal.element-BLX3Fhvk.js")
  },
  // Webhook test modal
  {
    type: "modal",
    ...
    js: () => import("./webhook-test-modal.element-BxY7sh6-.js")
  },
  // Delivery detail modal
  {
    ...
    js: () => import("./delivery-detail-modal.element-CwEESlTS.js")
  },
  ...
  // Workspace for notifications (when clicking "Notifications" in tree)
  {
    ...
    api: () => import("./notifications-workspace.context-BE5cyued.js"),
    meta: {
      entityType: E
    }
  },
  ...
  // Workspace view for tax providers list (appears as "Tax" tab in Providers workspace)
  {
    ...
    js: () => import("./tax-providers-list.element-Miw_hUNC.js"),
    weight: 85,
    meta: {
      label: "Tax",
      pathname: "tax",
  ...
  // Tax group modal (handles both create and edit)
  {
    ...
    js: () => import("./tax-group-modal.element-CbcEK1Uv.js")
  },
  // Tax rate modal (handles both create and edit for geographic rates)
  {
    ...
    js: () => import("./tax-rate-modal.element-xHBA22_7.js")
  },
  // Tax provider config modal
  {
    ...
    js: () => import("./tax-provider-config-modal.element-DTcACYEV.js")
  },
  // Test tax provider modal
  {
    ...
    js: () => import("./test-tax-provider-modal.element-Dq8RM7pX.js")
  },
  // Shipping tax override modal
  {
    ...
    js: () => import("./shipping-tax-override-modal.element-CzbZ4BTk.js")
  }
], x = [
  // ============================================
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-BghJSges.js"),
    meta: {
      entityType: h
    }
  },
  // List view for suppliers
  {
    ...
    js: () => import("./suppliers-list.element-BtAaXmMO.js"),
    weight: 100,
    meta: {
      label: "Suppliers",
      pathname: "suppliers",
  ...
  // Supplier modal (handles both create and edit)
  {
    ...
    js: () => import("./supplier-modal.element-DyIQ-l64.js")
  },
  // Supplier picker modal (for discount targeting)
  {
    ...
    js: () => import("./supplier-picker-modal.element-dYRVQMI4.js")
  }
], F = [
  // ============================================
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-DCrbgQjs.js"),
    meta: {
      entityType: M
    }
  },
  // List view for warehouses (used when on list route)
  {
    ...
    js: () => import("./warehouses-list.element-B_rrd4K9.js"),
    weight: 100,
    meta: {
      label: "Warehouses",
      pathname: "warehouses",
  ...
  // Service region modal
  {
    ...
    js: () => import("./service-region-modal.element-rsDqPrC4.js")
  },
  // Warehouse picker modal (for discount targeting)
  {
    ...
    js: () => import("./warehouse-picker-modal.element-6_BQ_1zn.js")
  }
], Y = [
  // Workspace view for shipping providers (under Providers workspace)
  {
    ...
    js: () => import("./shipping-providers-list.element-DhMWyksA.js"),
    weight: 90,
    meta: {
      label: "Shipping",
      pathname: "shipping",
  ...
  // Shipping provider configuration modal
  {
    ...
    js: () => import("./shipping-provider-config-modal.element-BFjN4PK0.js")
  },
  // Test shipping provider modal
  {
    ...
    js: () => import("./test-provider-modal.element-DddtwmeH.js")
  },
  // Shipping option detail modal
  {
    ...
    js: () => import("./shipping-option-detail-modal.element-CGE-oAjn.js")
  },
  // Shipping cost modal
  {
    type: "modal",
    ...
    js: () => import("./shipping-cost-modal.element-pm_GSaiF.js")
  },
  // Shipping weight tier modal
  {
    ...
    js: () => import("./shipping-weight-tier-modal.element-BMyiEtxU.js")
  },
  // Shipping destination exclusion modal
  {
    ...
    js: () => import("./shipping-destination-exclusion-modal.element-lqGmFT5i.js")
  },
  // Shipping postcode rule modal
  {
    ...
    js: () => import("./shipping-postcode-rule-modal.element-BvuI1xB1.js")
  }
], D = [
  // Workspace view for payment providers (under Providers workspace)
  {
    ...
    js: () => import("./payment-providers-list.element-CmlpAhgT.js"),
    weight: 100,
    meta: {
      label: "Payments",
      pathname: "payments",
  ...
  // Modal for configuring a payment provider
  {
    ...
    js: () => import("./payment-provider-config-modal.element-DtbOUeJQ.js")
  },
  // Modal for configuring payment methods within a provider
  {
    ...
    js: () => import("./payment-methods-config-modal.element-DaLW60sD.js")
  },
  // Modal for editing a single payment method's display settings
  {
    ...
    js: () => import("./payment-method-edit-modal.element-BhhzxRXg.js")
  },
  ...
  // Modal for testing a payment provider
  {
    ...
    js: () => import("./test-provider-modal.element-DLa3lYzH.js")
  }
], $ = [
  // Workspace view for fulfilment providers (under Providers workspace)
  {
    ...
    js: () => import("./fulfilment-providers-list.element-CgLNyR0I.js"),
    weight: 75,
    meta: {
      label: "Fulfilment",
      pathname: "fulfilment",
  ...
  // Configuration modal
  {
    ...
    js: () => import("./fulfilment-provider-config-modal.element-B_Fn3907.js")
  },
  // Test modal
  {
    type: "modal",
    ...
    js: () => import("./test-provider-modal.element-DJV5OWOz.js")
  }
], N = [
  // Workspace view for exchange rate providers (under Providers workspace)
  {
    ...
    js: () => import("./exchange-rate-providers-list.element-C1UooH1N.js"),
    weight: 80,
  ...
  // Modal for configuring an exchange rate provider
  {
    ...
    js: () => import("./exchange-rate-provider-config-modal.element-Cdr6j3Bk.js")
  },
  // Modal for testing an exchange rate provider
  {
    ...
    js: () => import("./test-provider-modal.element-DzMHH85A.js")
  }
], H = [
  // Workspace view for address lookup providers (under Providers workspace)
  {
    ...
    js: () => import("./address-lookup-providers-list.element-BX6Fd8Ma.js"),
    weight: 85,
    meta: {
  ...
  // Modal for configuring an address lookup provider
  {
    ...
    js: () => import("./address-lookup-provider-config-modal.element-Cdp7DwMC.js")
  },
  // Modal for testing an address lookup provider
  {
    ...
    js: () => import("./test-provider-modal.element-B9hy01rP.js")
  }
], G = [
  {
    type: "workspace",
    ...
    api: () => import("./upsells-workspace.context-CMmghXeH.js"),
    meta: {
      entityType: b
    }
  },
  {
    ...
    js: () => import("./upsells-list.element-DrBgBCMI.js"),
    weight: 100,
    meta: {
      label: "Upsells",
      pathname: "upsells",
  ...
  },
  {
    ...
    js: () => import("./create-upsell-modal.element-DyaKoirR.js")
  },
  {
    type: "modal",
  ...
  // Workspace for root (when clicking "Merchello" in tree)
  {
    ...
    api: () => import("./settings-workspace.context-BNLlUcwW.js"),
    meta: {
      entityType: l
    }
  },
  {
    ...
    js: () => import("./settings-workspace.element-Dr9qA9Hm.js"),
    weight: 100,
    meta: {
      label: "Overview",
      pathname: "overview",
  ...
  // Product picker modal for selecting products in orders and property editors
  {
    ...
    js: () => import("./product-picker-modal.element-DqisjINN.js")
  }
], K = [
  {
    ...
    element: () => import("./property-editor-ui-collection-picker.element-B5Vc1_K2.js"),
    meta: {
...
], z = [
  {
    ...
    element: () => import("./property-editor-ui-product-type-picker.element-CI_H4III.js"),
    meta: {
...
], J = [
  {
    ...
    element: () => import("./property-editor-ui-filter-group-picker.element-QvtH3BAS.js"),
    meta: {
...
], Q = [
  {
    ...
    element: () => import("./property-editor-ui-filter-value-picker.element-lZEpL7hq.js"),
    meta: {
...
], X = [
  {
    ...
    element: () => import("./property-editor-ui-product-picker.element-b78eLCs2.js"),
    meta: {
...
], Z = [
  {
    ...
    element: () => import("./property-editor-ui-google-shopping-category-picker.element-D-lRNFqE.js"),
    meta: {
...
//# sourceMappingURL=bundle.manifests-DJ1-mVhE.js.map
