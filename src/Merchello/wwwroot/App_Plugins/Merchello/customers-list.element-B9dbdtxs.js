...
import { M as E } from "./merchello-api-Rt7qKkDA.js";
import { g as M } from "./store-settings-DWhgRuNK.js";
...
let i = class extends w(C) {
  constructor() {
    super(), this._customers = [], this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._searchTerm = "", this._searchDebounceTimer = null, g(this, h), g(this, m), g(this, u, !1), this.consumeContext(T, (e) => {
      d(this, h, e);
...
//# sourceMappingURL=customers-list.element-B9dbdtxs.js.map
