...
async function r(e) {
  try {
    const t = await $(), s = d.baseUrl || "", a = await fetch(`${s}${l}/${e}`, {
      method: "GET",
...
async function i(e, t) {
  try {
    const s = await $(), a = d.baseUrl || "", n = await fetch(`${a}${l}/${e}`, {
      method: "POST",
      credentials: d.credentials,
      headers: s,
...
const h = {
  ...
  updateTaxGroupRate: (e, t) => o(`tax-groups/rates/${e}`, t),
  ...
  activateTaxProvider: (e) => o(`tax-providers/${e}/activate`),
  /** Save tax provider configuration settings */
  saveTaxProviderSettings: (e, t) => o(`tax-providers/${e}/settings`, t),
  ...
  searchCustomers: (e, t) => {
    ...
    const a = s.toString();
    return r(`orders/customer-lookup${a ? `?${a}` : ""}`);
  },
  ...
  getProductFulfillmentOptions: (e, t, s) => {
    ...
    return a.set("destinationCountryCode", t), s && a.set("destinationStateCode", s), r(`products/variants/${e}/fulfillment-options?${a.toString()}`);
  },
  /**
  ...
  getShippingOptionsForWarehouse: (e, t, s) => {
    const a = new URLSearchParams();
    return a.set("destinationCountryCode", t), s && a.set("destinationStateCode", s), r(`warehouses/${e}/shipping-options?${a.toString()}`);
  },
  // ============================================
  // Suppliers API
  // ============================================
  ...
  searchCustomersForSegment: (e, t, s = 50) => {
    const a = new URLSearchParams({ search: e, pageSize: String(s) });
    return t?.length && a.set("excludeIds", t.join(",")), r(`customers/search?${a.toString()}`);
  },
  // ============================================
  ...
  getDiscountPerformance: (e, t, s) => {
    const a = new URLSearchParams();
    t && a.set("startDate", t), s && a.set("endDate", s);
    const n = a.toString();
...
//# sourceMappingURL=merchello-api-Rt7qKkDA.js.map
