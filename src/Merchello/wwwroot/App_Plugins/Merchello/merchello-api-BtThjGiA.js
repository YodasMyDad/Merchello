...
async function r(e) {
  try {
    ...
    let d;
    return n.includes("application/json") ? d = await i.json() : d = await i.text(), { data: d };
  } catch (t) {
...
async function o(e, t) {
  try {
    const s = await h(), i = c.baseUrl || "", n = await fetch(`${i}${$}/${e}`, {
      method: "POST",
      credentials: c.credentials,
      headers: s,
    ...
    if (!n.ok) {
      ...
      return { error: new Error(u || `HTTP ${n.status}: ${n.statusText}`) };
    }
...
async function P(e, t) {
  try {
    ...
    const n = c.baseUrl || "", d = await fetch(`${n}${$}/${e}`, {
      method: "POST",
      credentials: c.credentials,
      headers: i,
      body: t
...
async function p(e) {
  try {
    ...
    if (!i.ok) {
      ...
      return { error: new Error(n || `HTTP ${i.status}: ${i.statusText}`) };
    }
    return {};
  } catch (t) {
    return { error: t instanceof Error ? t : new Error(String(t)) };
...
function v(e, t, s, i, n, d) {
  let u = `reporting/${e}?startDate=${t}&endDate=${s}`;
  return i && (u += `&compareMode=${i}`), n && (u += `&comparisonStartDate=${n}`), d && (u += `&comparisonEndDate=${d}`), u;
}
const T = {
  ping: () => r("ping"),
  // Store Settings
  ...
  saveStoreConfiguration: (e) => a("settings/store-configuration", e),
  ...
  updateTaxGroup: (e, t) => a(`tax-groups/${e}`, t),
  /** Delete a tax group */
  ...
  updateTaxGroupRate: (e, t) => a(`tax-groups/rates/${e}`, t),
  ...
  activateTaxProvider: (e) => a(`tax-providers/${e}/activate`),
  /** Save tax provider configuration settings */
  saveTaxProviderSettings: (e, t) => a(`tax-providers/${e}/settings`, t),
  ...
  updateShippingTaxOverride: (e, t) => a(`shipping-tax-overrides/${e}`, t),
  ...
  updateBillingAddress: (e, t) => a(`orders/${e}/billing-address`, t),
  updateShippingAddress: (e, t) => a(`orders/${e}/shipping-address`, t),
  updatePurchaseOrder: (e, t) => a(`orders/${e}/purchase-order`, { purchaseOrder: t }),
  ...
  editInvoice: (e, t) => a(`orders/${e}/edit`, t),
  ...
  updateShipment: (e, t) => a(`shipments/${e}`, t),
  /** Update shipment status (e.g., Preparing -> Shipped -> Delivered) */
  updateShipmentStatus: (e, t) => a(`shipments/${e}/status`, t),
  ...
  downloadCustomerStatement: async (e, t, s) => {
    try {
      const i = await h(), n = c.baseUrl || "", d = new URLSearchParams();
      t && d.append("periodStart", t), s && d.append("periodEnd", s);
      const u = d.toString(), m = `${n}${$}/customers/${e}/statement${u ? `?${u}` : ""}`, g = await fetch(m, {
        method: "GET",
        credentials: c.credentials,
      ...
      const w = await g.blob(), S = g.headers.get("content-disposition");
      let y = "statement.pdf";
      if (S) {
        const f = S.match(/filename[^;=\n]*=((['"]).*?\2|[^;\n]*)/);
        f && f[1] && (y = f[1].replace(/['"]/g, ""));
      }
      return { blob: w, filename: y };
    } catch (i) {
  ...
  updatePaymentMethodSetting: (e, t, s) => a(`payment-providers/${e}/methods/${t}`, s),
  /** Reorder payment methods for a provider */
  reorderPaymentMethods: (e, t) => a(`payment-providers/${e}/methods/reorder`, t),
  // ============================================
  // Payments API
  // ============================================
  ...
  updateShippingProvider: (e, t) => a(`shipping-providers/${e}`, t),
  ...
  toggleShippingProvider: (e, t) => a(`shipping-providers/${e}/toggle`, { isEnabled: t }),
  ...
  updateProductType: (e, t) => a(`products/types/${e}`, t),
  ...
  updateProductCollection: (e, t) => a(`products/collections/${e}`, t),
  ...
  /** Update product root */
  updateProduct: (e, t) => a(`products/${e}`, t),
  ...
  /** Update a variant */
  updateVariant: (e, t, s) => a(`products/${e}/variants/${t}`, s),
  /** Set a variant as the default */
  setDefaultVariant: (e, t) => a(`products/${e}/variants/${t}/set-default`),
  /**
  ...
  saveProductOptions: (e, t) => a(`products/${e}/options`, t),
  // Shipping Exclusions
  ...
  updateProductShippingExclusions: (e, t) => a(`products/${e}/shipping-exclusions`, {
    excludedShippingOptionIds: t
  }),
  /** Update shipping exclusions for a specific variant */
  updateVariantShippingExclusions: (e, t, s) => a(`products/${e}/variants/${t}/shipping-exclusions`, {
  ...
  updateProductFeed: (e, t) => a(`product-feeds/${e}`, t),
  ...
  validateProductImport: (e, t) => {
    ...
    return s.append("file", e), s.append("profile", String(t.profile)), t.maxIssues !== null && t.maxIssues !== void 0 && s.append("maxIssues", String(t.maxIssues)), P("product-sync/imports/validate", s);
  },
  /** Queue a product import run after validation. */
  startProductImport: (e, t) => {
    const s = new FormData();
    return s.append("file", e), s.append("profile", String(t.profile)), s.append("continueOnImageFailure", String(t.continueOnImageFailure)), t.maxIssues !== null && t.maxIssues !== void 0 && s.append("maxIssues", String(t.maxIssues)), P("product-sync/imports/start", s);
  },
  ...
  downloadProductSyncExport: async (e) => {
    try {
      ...
      const i = c.baseUrl || "", n = await fetch(`${i}${$}/product-sync/runs/${e}/download`, {
        method: "GET",
        credentials: c.credentials,
        headers: s
      });
      ...
      const d = await n.blob(), u = n.headers.get("content-disposition");
      let m = `product-sync-${e}.csv`;
      if (u) {
        const g = u.match(/filename[^;=\n]*=((['"]).*?\2|[^;\n]*)/);
  ...
  updateShippingOption: (e, t) => a(`shipping-options/${e}`, t),
  ...
  updateShippingCost: (e, t) => a(`shipping-costs/${e}`, t),
  ...
  updateShippingWeightTier: (e, t) => a(`shipping-weight-tiers/${e}`, t),
  ...
  updateShippingPostcodeRule: (e, t) => a(`shipping-postcode-rules/${e}`, t),
  ...
  /** Update a warehouse */
  updateWarehouse: (e, t) => a(`warehouses/${e}`, t),
  /** Delete a warehouse */
  ...
  updateServiceRegion: (e, t, s) => a(`warehouses/${e}/service-regions/${t}`, s),
  ...
  getWarehouseProducts: (e, t = 1, s = 20, i) => {
    const n = new URLSearchParams({ page: String(t), pageSize: String(s) });
    return i && n.set("search", i), r(`warehouses/${e}/products?${n.toString()}`);
  },
  ...
  updateSupplier: (e, t) => a(`suppliers/${e}`, t),
  /** Delete a supplier */
  ...
  updateCustomer: (e, t) => a(`customers/${e}`, t),
  ...
  updateCustomerSegment: (e, t) => a(`customer-segments/${e}`, t),
  ...
  getAnalyticsSummary: (e, t, s, i, n) => r(v("summary", e, t, s, i, n)),
   ...
   */
  getSalesTimeSeriesWithTotals: (e, t, s, i, n) => r(v("sales-timeseries-with-totals", e, t, s, i, n)),
   ...
   */
  getAovTimeSeriesWithTotals: (e, t, s, i, n) => r(v("aov-timeseries-with-totals", e, t, s, i, n)),
  /** Get sales breakdown (gross, discounts, returns, net, shipping, taxes) */
  getSalesBreakdown: (e, t, s, i, n) => r(v("breakdown", e, t, s, i, n)),
  // ============================================
  ...
  activateExchangeRateProvider: (e) => a(`exchange-rate-providers/${e}/activate`),
  /** Save exchange rate provider configuration settings */
  saveExchangeRateProviderSettings: (e, t) => a(`exchange-rate-providers/${e}/settings`, t),
  ...
  activateAddressLookupProvider: (e) => a(`address-lookup-providers/${e}/activate`),
  /** Deactivate all address lookup providers */
  deactivateAddressLookupProviders: () => a("address-lookup-providers/deactivate"),
  /** Save address lookup provider configuration settings */
  saveAddressLookupProviderSettings: (e, t) => a(`address-lookup-providers/${e}/settings`, t),
  ...
  updateDiscount: (e, t) => a(`discounts/${e}`, t),
  /** Delete a discount */
  ...
  getDiscountPerformance: (e, t, s) => {
    ...
    const n = i.toString();
    return r(`discounts/${e}/performance${n ? `?${n}` : ""}`);
  },
  // ============================================
  // Upsells API
  // ============================================
  ...
  updateUpsell: (e, t) => a(`upsells/${e}`, t),
  ...
  getUpsellPerformance: (e, t, s) => {
    ...
    t && i.set("startDate", t), s && i.set("endDate", s);
    const n = i.toString();
    return r(`upsells/${e}/performance${n ? `?${n}` : ""}`);
  },
  ...
  updateEmailConfiguration: (e, t) => a(`emails/${e}`, t),
  ...
  updateWebhookSubscription: (e, t) => a(`webhooks/${e}`, t),
  ...
  updateFulfilmentProvider: (e, t) => a(`fulfilment-providers/${e}`, t),
  ...
  toggleFulfilmentProvider: (e, t) => a(`fulfilment-providers/${e}/toggle`, { isEnabled: t }),
...
//# sourceMappingURL=merchello-api-BtThjGiA.js.map
