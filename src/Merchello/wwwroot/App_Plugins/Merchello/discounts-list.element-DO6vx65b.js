...
import { c as S, b as C, D as m, d as f } from "./discount.types-Du4rtOaW.js";
import { M as k } from "./merchello-api-0px5tmLf.js";
import { g as O } from "./store-settings-DdTmiT9W.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
import { a as U, e as B } from "./formatting-DoC7VCqW.js";
...
let l = class extends M(T) {
  ...
  async _loadDiscounts() {
    ...
    const { data: t, error: a } = await k.getDiscounts(e);
    if (n(this, h)) {
      if (a) {
  ...
  async _handleDeleteSelected() {
    ...
    let s = 0, i = 0;
    for (const u of a) {
      const { error: d } = await k.deleteDiscount(u);
      if (!n(this, h)) return;
      d ? i++ : s++;
    }
...
//# sourceMappingURL=discounts-list.element-DO6vx65b.js.map
