const e = [
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-BGRtbfq7.js")
  },
  // Tree
  {
    type: "tree",
  ...
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-DGlvyZqb.js"),
    meta: {
      entityType: i
    }
  },
  ...
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-B2577tIP.js"),
    meta: {
      entityType: E
    }
  },
  ...
  // Workspace for abandoned checkouts list (when clicking "Abandoned Checkouts" in tree)
  {
    ...
    api: () => import("./abandoned-checkouts-workspace.context-BPqeuRGX.js"),
    meta: {
      entityType: w
    }
  },
  ...
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-DgVCzWfd.js"),
    meta: {
      entityType: t
    }
  },
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-d96P9GWT.js"),
    meta: {
      entityType: r
    }
  },
  ...
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-Buqkp5uT.js"),
    meta: {
      entityType: s
    }
  },
  ...
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-BLx_BojW.js"),
    meta: {
      entityType: c
    }
  },
  ...
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-C8_06fFJ.js"),
    meta: {
      entityType: n
    }
  },
  ...
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-C5V_toFh.js"),
    meta: {
      entityType: p
    }
  },
  ...
  },
  {
    ...
    js: () => import("./product-feed-validation-modal.element-DXGMbBJs.js")
  }
], A = [
  {
    type: "workspace",
    ...
    api: () => import("./product-import-export-workspace.context-DVF4X83i.js"),
    meta: {
      entityType: m
    }
  },
  {
    ...
    js: () => import("./product-import-export-page.element-CX-9nJxt.js"),
    weight: 100,
    meta: {
      label: "Import & Export",
      pathname: "sync",
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-DfYVuqfD.js"),
    meta: {
      entityType: k
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-i-_qapaV.js"),
    meta: {
      entityType: d
    }
  },
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-CZn1sWGB.js"),
    meta: {
      entityType: h
    }
  },
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-B7KvWvAU.js"),
    meta: {
      entityType: u
    }
  },
  ...
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-DrkgBI7M.js"),
    meta: {
      entityType: P
    }
  },
  ...
  // Workspace for notifications (when clicking "Notifications" in tree)
  {
    ...
    api: () => import("./notifications-workspace.context-BG2svK7j.js"),
    meta: {
      entityType: T
    }
  },
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-BLz6myuX.js"),
    meta: {
      entityType: M
    }
  },
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-BEi6XTdt.js"),
    meta: {
      entityType: y
    }
  },
...
], q = [
  {
    ...
    api: () => import("./upsells-workspace.context-Dhrzclmx.js"),
    meta: {
      entityType: b
    }
  },
  ...
  // Workspace for root (when clicking "Merchello" in tree)
  {
    ...
    api: () => import("./settings-workspace.context-C3_8coCC.js"),
    meta: {
      entityType: l
    }
  },
...
//# sourceMappingURL=bundle.manifests-Bvg7TLvL.js.map
