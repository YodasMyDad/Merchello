...
import { d as j, p as ie } from "./purify.es-Cuv6u9x0.js";
import { UmbElementMixin as B } from "@umbraco-cms/backoffice/element-api";
import { UMB_WORKSPACE_CONTEXT as W } from "@umbraco-cms/backoffice/workspace";
import { UmbModalToken as D, UMB_MODAL_MANAGER_CONTEXT as V } from "@umbraco-cms/backoffice/modal";
...
import { I as f, P as q } from "./order.types-B45a7FtJ.js";
import { M as re } from "./customer-orders-modal.token-DUOTW0Xz.js";
import { b as N, a as p, h as se } from "./formatting-DaSoStSN.js";
import { M as g } from "./merchello-api-DFGQMc21.js";
import { k as oe } from "./navigation-D1KCp5wk.js";
import "./product-image.element-D7HwAIKr.js";
const ne = new D("Merchello.Fulfillment.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
}), le = new D("Merchello.EditOrder.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
}), de = new D("Merchello.ShipmentEdit.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
...
}, X = (e, i, t) => i.has(e) || G("Cannot " + t), $ = (e, i, t) => (X(e, i, "read from private field"), t ? t.call(e) : i.get(e)), I = (e, i, t) => i.has(e) ? G("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), A = (e, i, t, s) => (X(e, i, "write to private field"), i.set(e, t), t), E, M, k;
let w = class extends B(F) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, I(this, E), I(this, M), I(this, k, !1), this.consumeContext(W, (e) => {
      A(this, E, e), this.observe($(this, E).order, (i) => {
  ...
  async _handleDeleteShipment(e) {
    ...
    if ($(this, k)) {
      ...
      this._loadShipments(), this._invoiceId && $(this, E)?.load(this._invoiceId);
    }
  }
...
const pe = new D("Merchello.ManualPayment.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), me = new D("Merchello.Refund.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
...
}, K = (e, i, t) => i.has(e) || Y("Cannot " + t), C = (e, i, t) => (K(e, i, "read from private field"), i.get(e)), H = (e, i, t) => i.has(e) ? Y("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), L = (e, i, t, s) => (K(e, i, "write to private field"), i.set(e, t), t), x, z;
let _ = class extends B(F) {
  constructor() {
    super(), this.invoiceId = "", this._payments = [], this._status = null, this._isLoading = !0, this._errorMessage = null, H(this, x), H(this, z, !1), this.consumeContext(V, (e) => {
      L(this, x, e);
    });
  }
  connectedCallback() {
  ...
  _renderPayment(e) {
    const i = e.paymentType === q.Refund || e.paymentType === q.PartialRefund;
    return a`
...
}, Q = (e, i, t) => i.has(e) || J("Cannot " + t), l = (e, i, t) => (Q(e, i, "read from private field"), i.get(e)), T = (e, i, t) => i.has(e) ? J("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), P = (e, i, t, s) => (Q(e, i, "write to private field"), i.set(e, t), t), h, b, y, v;
let u = class extends B(F) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._routes = [], this._activePath = "", this._newNoteText = "", this._isVisibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", this._isSavingPurchaseOrder = !1, T(this, h), T(this, b), T(this, y), T(this, v, !1), this.consumeContext(W, (e) => {
      P(this, h, e), l(this, h) && this.observe(l(this, h).order, (i) => {
  ...
  connectedCallback() {
    super.connectedCallback(), P(this, v, !0), this._createRoutes();
  }
  _createRoutes() {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), P(this, v, !1);
  }
  ...
  _renderMarkdown(e) {
    ...
    const i = j.parse(e), t = ie.sanitize(i);
    return ee(t);
  }
  _getGoogleMapsUrl(e) {
    if (!e) return "";
  ...
  async _savePurchaseOrder() {
    ...
    if (l(this, v)) {
      ...
      }), this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", l(this, h)?.load(this._order.id);
    }
  }
  ...
  async _handlePostNote() {
    ...
    if (l(this, v)) {
      ...
      }), this._newNoteText = "", this._isVisibleToCustomer = !1, l(this, h)?.load(this._order.id);
    }
  }
  _renderLoadingState() {
    return a`<div class="loading"><uui-loader></uui-loader></div>`;
...
//# sourceMappingURL=order-detail.element-DwQZMnFz.js.map
