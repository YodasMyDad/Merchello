const e = [
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-DKVxcxkb.js")
  },
  // Tree
  {
    type: "tree",
  ...
  // Fulfillment modal for creating shipments
  {
    ...
    js: () => import("./fulfillment-modal.element-BGeKqvNW.js")
  },
  ...
  // Manual payment modal for recording offline payments
  {
    ...
    js: () => import("./manual-payment-modal.element-aD9XdKY8.js")
  },
  // Refund modal for processing refunds
  {
    ...
    js: () => import("./refund-modal.element-CXPUBmbA.js")
  },
  // Cancel invoice modal for cancelling invoices
  {
    ...
    js: () => import("./cancel-invoice-modal.element-DYloYDrl.js")
  },
  ...
  // Edit order modal for editing order details
  {
    ...
    js: () => import("./edit-order-modal.element-B7_moA64.js")
  },
  // Add custom item modal for edit order
  {
    ...
    js: () => import("./add-custom-item-modal.element-DzxUVQv4.js")
  },
  // Add discount modal for edit order
  {
    ...
    js: () => import("./add-discount-modal.element-BpS5MF6E.js")
  },
  // Create order modal for creating manual orders from backoffice
  {
    ...
    js: () => import("./create-order-modal.element-CnYeloHo.js")
  },
  ...
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-DQyZVGLA.js"),
    meta: {
      entityType: l
    }
  },
  ...
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-8ZwK4uZr.js"),
    meta: {
      entityType: k
    }
  },
  ...
  // Workspace for abandoned checkouts list (when clicking "Abandoned Checkouts" in tree)
  {
    ...
    api: () => import("./abandoned-checkouts-workspace.context-D-sd1leb.js"),
    meta: {
      entityType: P
    }
  },
  ...
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-BEgGGWXk.js"),
    meta: {
      entityType: i
    }
  },
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-Cn9cBUUP.js"),
    meta: {
      entityType: t
    }
  },
  ...
  // Customer picker modal (for adding members to segments)
  {
    ...
    js: () => import("./customer-picker-modal.element-Cl0gmj-3.js")
  },
  // Segment picker modal (for discount eligibility)
  {
    ...
    js: () => import("./segment-picker-modal.element-DyvDHU1N.js")
  }
], f = [
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-Cp8C8V9P.js"),
    meta: {
      entityType: r
    }
  },
  ...
  // Collection picker modal (for discount targeting)
  {
    ...
    js: () => import("./collection-picker-modal.element-DTiA9o7S.js")
  },
  ...
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-CXVBdIO-.js"),
    meta: {
      entityType: s
    }
  },
  ...
  // Filter picker modal (for discount targeting)
  {
    ...
    js: () => import("./filter-picker-modal.element-DgJxx3ue.js")
  },
  // Filter group picker modal (for property editor)
  {
    ...
    js: () => import("./filter-group-picker-modal.element-qYtOTiWI.js")
  }
], U = [
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-DhMDXRHC.js"),
    meta: {
      entityType: c
    }
  },
  ...
  // Product type picker modal (for discount targeting)
  {
    ...
    js: () => import("./product-type-picker-modal.element-Bhu0JObT.js")
  }
], j = [
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-ChMSxAWm.js"),
    meta: {
      entityType: n
    }
  },
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-Ss1v92E_.js"),
    meta: {
      entityType: u
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-CvQlLldz.js"),
    meta: {
      entityType: p
    }
  },
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-DAb8wXw3.js"),
    meta: {
      entityType: m
    }
  },
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-DSTVWIQ3.js"),
    meta: {
      entityType: M
    }
  },
  ...
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-BYetQk96.js"),
    meta: {
      entityType: y
    }
  },
  ...
  // Workspace for notifications (when clicking "Notifications" in tree)
  {
    ...
    api: () => import("./notifications-workspace.context-BXyovbXp.js"),
    meta: {
      entityType: w
    }
  },
  ...
  // Tax rate modal (handles both create and edit for geographic rates)
  {
    ...
    js: () => import("./tax-rate-modal.element-bmIKRRYk.js")
  },
  // Tax provider config modal
  {
    ...
    js: () => import("./tax-provider-config-modal.element-ec73N49b.js")
  },
  // Test tax provider modal
  {
    ...
    js: () => import("./test-tax-provider-modal.element-pkFjK-30.js")
  },
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-BbqC4u9C.js"),
    meta: {
      entityType: d
    }
  },
  ...
  // Supplier picker modal (for discount targeting)
  {
    ...
    js: () => import("./supplier-picker-modal.element-B4eQSF9Q.js")
  }
], x = [
  // ============================================
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-AS-i902z.js"),
    meta: {
      entityType: h
    }
  },
  ...
  // Warehouse picker modal (for discount targeting)
  {
    ...
    js: () => import("./warehouse-picker-modal.element-G5o1IyxI.js")
  }
], F = [
  ...
  // Shipping provider configuration modal
  {
    ...
    js: () => import("./shipping-provider-config-modal.element-DVfIHE8X.js")
  },
  ...
  // Modal for configuring a payment provider
  {
    ...
    js: () => import("./payment-provider-config-modal.element-DFoKUdNg.js")
  },
  ...
  // Modal for editing a single payment method's display settings
  {
    ...
    js: () => import("./payment-method-edit-modal.element-g2wa1b5U.js")
  },
  ...
  // Modal for testing a payment provider
  {
    ...
    js: () => import("./test-provider-modal.element-Bv_f1uOk.js")
  }
], N = [
  // Workspace view for fulfilment providers (under Providers workspace)
  {
    ...
    js: () => import("./fulfilment-providers-list.element-DLA5x87U.js"),
    weight: 75,
    meta: {
      label: "Fulfilment",
      pathname: "fulfilment",
  ...
  // Configuration modal
  {
    ...
    js: () => import("./fulfilment-provider-config-modal.element-NqE4HnQc.js")
  },
  // Test modal
  {
    type: "modal",
  ...
  // Modal for configuring an exchange rate provider
  {
    ...
    js: () => import("./exchange-rate-provider-config-modal.element-CHkOSrnP.js")
  },
  // Modal for testing an exchange rate provider
  {
    ...
    js: () => import("./test-provider-modal.element-BIP_gWVH.js")
  }
], D = [
  ...
  // Modal for configuring an address lookup provider
  {
    ...
    js: () => import("./address-lookup-provider-config-modal.element-C4472btT.js")
  },
  // Modal for testing an address lookup provider
  {
    ...
    js: () => import("./test-provider-modal.element-CRgAG6zj.js")
  }
], H = [
  {
    type: "workspace",
    ...
    api: () => import("./upsells-workspace.context-BeS7gF6e.js"),
    meta: {
      entityType: E
    }
  },
  {
    ...
    js: () => import("./upsells-list.element-DvBRGhRG.js"),
    weight: 100,
    meta: {
      label: "Upsells",
      pathname: "upsells",
  ...
  // Product picker modal for selecting products in orders and property editors
  {
    ...
    js: () => import("./product-picker-modal.element-CX6fmHA6.js")
  }
], B = [
  {
...
//# sourceMappingURL=bundle.manifests-BQ3efdWX.js.map
