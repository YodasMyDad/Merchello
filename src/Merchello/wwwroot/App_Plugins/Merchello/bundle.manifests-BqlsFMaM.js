const e = [
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-LgGmXWEl.js")
  },
  // Tree
  {
    type: "tree",
  ...
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-D6gZAHVT.js"),
    meta: {
      entityType: i
    }
  },
  ...
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-CkSHB4RQ.js"),
    meta: {
      entityType: E
    }
  },
  ...
  // Workspace for abandoned checkouts list (when clicking "Abandoned Checkouts" in tree)
  {
    ...
    api: () => import("./abandoned-checkouts-workspace.context-CGTrluoa.js"),
    meta: {
      entityType: w
    }
  },
  ...
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-CJetVYYa.js"),
    meta: {
      entityType: t
    }
  },
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-BJPDPx4-.js"),
    meta: {
      entityType: r
    }
  },
  ...
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-DPtADYq2.js"),
    meta: {
      entityType: s
    }
  },
  ...
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-CE_i61O6.js"),
    meta: {
      entityType: c
    }
  },
  ...
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-BgSjmsDI.js"),
    meta: {
      entityType: n
    }
  },
  ...
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-CMNLW0CU.js"),
    meta: {
      entityType: p
    }
  },
...
], A = [
  {
    ...
    api: () => import("./product-import-export-workspace.context-_UIeIFNW.js"),
    meta: {
      entityType: m
    }
  },
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-GOeR74fg.js"),
    meta: {
      entityType: k
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-Buw6DUMW.js"),
    meta: {
      entityType: d
    }
  },
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-CYFsoAkg.js"),
    meta: {
      entityType: h
    }
  },
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-lDmhJivE.js"),
    meta: {
      entityType: u
    }
  },
  ...
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-BummXDf8.js"),
    meta: {
      entityType: P
    }
  },
  ...
  // Workspace for notifications (when clicking "Notifications" in tree)
  {
    ...
    api: () => import("./notifications-workspace.context-DwkbtJ_h.js"),
    meta: {
      entityType: T
    }
  },
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-D2Y6AZLy.js"),
    meta: {
      entityType: M
    }
  },
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-qW4Gn56l.js"),
    meta: {
      entityType: y
    }
  },
...
], q = [
  {
    ...
    api: () => import("./upsells-workspace.context-l-Cp88CS.js"),
    meta: {
      entityType: b
    }
  },
  ...
  // Workspace for root (when clicking "Merchello" in tree)
  {
    ...
    api: () => import("./settings-workspace.context-DZHYvT4N.js"),
    meta: {
      entityType: l
    }
  },
  {
    ...
    js: () => import("./settings-workspace.element-Bsg_VddX.js"),
    weight: 100,
    meta: {
      label: "Overview",
      pathname: "overview",
...
//# sourceMappingURL=bundle.manifests-BqlsFMaM.js.map
