import { nothing as n, html as u, css as c, state as d, customElement as m } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as h } from "@umbraco-cms/backoffice/modal";
var v = Object.defineProperty, _ = Object.getOwnPropertyDescriptor, o = (e, t, l, s) => {
  for (var a = s > 1 ? void 0 : s ? _(t, l) : t, i = e.length - 1, p; i >= 0; i--)
    (p = e[i]) && (a = (s ? p(t, l, a) : p(a)) || a);
  return s && a && v(t, l, a), a;
};
        ...
        <div id="main">
          ...
          <div class="form-row">
            ...
            ${this._selectedTaxGroupId ? u`
              <span class="tax-info">Tax: ${e}${s.toFixed(2)} at ${t}%</span>
            ` : n}
          </div>
...
//# sourceMappingURL=add-custom-item-modal.element-O0A5CfSa.js.map
