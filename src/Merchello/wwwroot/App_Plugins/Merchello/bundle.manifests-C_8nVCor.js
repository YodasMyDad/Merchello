const e = [
  ...
  // Stats Dashboard
  {
    ...
    element: () => import("./stats-dashboard.element-Lusj8Xtk.js"),
    meta: {
      label: "Stats",
      pathname: "stats"
    },
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-D9isXsx0.js")
  },
  // Tree
  {
    type: "tree",
  ...
  // Fulfillment modal for creating shipments
  {
    ...
    js: () => import("./fulfillment-modal.element-Dw2JAVhh.js")
  },
  // Shipment edit modal for updating tracking info
  {
    ...
    js: () => import("./shipment-edit-modal.element-BZ6_9uBE.js")
  },
  // Manual payment modal for recording offline payments
  {
    ...
    js: () => import("./manual-payment-modal.element-BpRf7_Ld.js")
  },
  // Refund modal for processing refunds
  {
    ...
    js: () => import("./refund-modal.element-GWT_K_PT.js")
  },
  ...
  // Export modal for exporting orders to CSV
  {
    ...
    js: () => import("./export-modal.element-ongYirK0.js")
  },
  // Edit order modal for editing order details
  {
    ...
    js: () => import("./edit-order-modal.element-DBH6FkQb.js")
  },
  // Add custom item modal for edit order
  {
    ...
    js: () => import("./add-custom-item-modal.element-BV5cH4x5.js")
  },
  // Add discount modal for edit order
  {
    ...
    js: () => import("./add-discount-modal.element-BtV7x-lI.js")
  },
  // Create order modal for creating draft orders from backoffice
  {
    ...
    js: () => import("./create-order-modal.element-CoAsMVHo.js")
  },
  // Customer orders modal for viewing all orders by a customer
  {
    ...
    js: () => import("./customer-orders-modal.element-TFO9YTrU.js")
  },
  ...
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-k5ZodnUj.js"),
    meta: {
      entityType: l
    }
  },
  // Workspace view - the orders list (used when on list route)
  {
    ...
    js: () => import("./orders-list.element-BISTmK-s.js"),
    weight: 100,
    meta: {
      label: "Orders",
      pathname: "list",
  ...
  // Mark as paid modal
  {
    ...
    js: () => import("./mark-as-paid-modal.element-CcU0-GVL.js")
  },
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-B8CScQ7_.js"),
    meta: {
      entityType: k
    }
  },
  // Workspace view - the outstanding list
  {
    ...
    js: () => import("./outstanding-list.element-Bsv6j3Tk.js"),
    weight: 100,
    meta: {
      label: "Outstanding",
      pathname: "list",
  ...
  // Workspace for abandoned checkouts list (when clicking "Abandoned Checkouts" in tree)
  {
    ...
    api: () => import("./abandoned-checkouts-workspace.context-PoDMfY3_.js"),
    meta: {
      entityType: P
    }
  },
  // Workspace view - the abandoned checkouts list
  {
    ...
    js: () => import("./abandoned-checkouts-list.element-rIIVemQZ.js"),
    weight: 100,
    meta: {
  ...
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-zlAhTL4w.js"),
    meta: {
      entityType: i
    }
  },
  // Workspace view for products list (used when on list route)
  {
    ...
    js: () => import("./products-list.element-Ddv6mrey.js"),
    weight: 100,
    meta: {
      label: "Products",
      pathname: "products",
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-Dzf8BfPq.js"),
    meta: {
      entityType: t
    }
  },
  ...
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-BCXChO3P.js"),
    meta: {
      entityType: r
    }
  },
  ...
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-Lyh6uet-.js"),
    meta: {
      entityType: s
    }
  },
  ...
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-CcBb5tln.js"),
    meta: {
      entityType: c
    }
  },
  ...
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-CFYf4gCs.js"),
    meta: {
      entityType: n
    }
  },
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-BHQ_br7d.js"),
    meta: {
      entityType: u
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-DgyWOSPN.js"),
    meta: {
      entityType: p
    }
  },
  // Workspace view for analytics
  {
    ...
    js: () => import("./analytics-workspace.element-D61EbUMq.js"),
    weight: 100,
    meta: {
      label: "Analytics",
      pathname: "analytics",
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-Bi14guXe.js"),
    meta: {
      entityType: m
    }
  },
  // Workspace view for discounts list (used when on list route)
  {
    ...
    js: () => import("./discounts-list.element-6Bw6ZrYO.js"),
    weight: 100,
    meta: {
      label: "Discounts",
      pathname: "discounts",
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-D5bh-7Kl.js"),
    meta: {
      entityType: M
    }
  },
  // Workspace view - the email list
  {
    ...
    js: () => import("./email-list.element-wHQRKOpg.js"),
    weight: 100,
    meta: {
      label: "Emails",
      pathname: "list",
  ...
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-BEIrzOU4.js"),
    meta: {
      entityType: y
    }
  },
  // Workspace view - the webhooks list
  {
    ...
    js: () => import("./webhooks-list.element-dIo-twC4.js"),
    weight: 100,
    meta: {
      label: "Webhooks",
      pathname: "list",
  ...
  // Workspace for notifications (when clicking "Notifications" in tree)
  {
    ...
    api: () => import("./notifications-workspace.context-Dia85GJw.js"),
    meta: {
      entityType: E
    }
  },
  ...
  // Tax group modal (handles both create and edit)
  {
    ...
    js: () => import("./tax-group-modal.element-B-_No2Xf.js")
  },
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-CW9TjNvF.js"),
    meta: {
      entityType: d
    }
  },
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-CnZ_4txE.js"),
    meta: {
      entityType: h
    }
  },
  ...
  // Test shipping provider modal
  {
    ...
    js: () => import("./test-provider-modal.element-CvvUzsk8.js")
  },
  // Shipping option detail modal
  {
    ...
    js: () => import("./shipping-option-detail-modal.element-A3CZp3cy.js")
  },
  // Shipping cost modal
  {
    type: "modal",
  ...
  // Workspace view for fulfilment providers (under Providers workspace)
  {
    ...
    js: () => import("./fulfilment-providers-list.element-CYMc_hxr.js"),
    weight: 75,
    meta: {
      label: "Fulfilment",
      pathname: "fulfilment",
  ...
  // Modal for testing an exchange rate provider
  {
    ...
    js: () => import("./test-provider-modal.element-CkrasRRB.js")
  }
], D = [
  {
    type: "workspace",
    ...
    api: () => import("./upsells-workspace.context-CDqlqadP.js"),
    meta: {
      entityType: w
    }
  },
  {
    ...
    js: () => import("./upsells-list.element-Bet3C_Ct.js"),
    weight: 100,
    meta: {
      label: "Upsells",
      pathname: "upsells",
  ...
  // Product picker modal for selecting products in orders and property editors
  {
    ...
    js: () => import("./product-picker-modal.element-xkuWm649.js")
  }
], q = [
  {
...
], K = [
  {
    ...
    element: () => import("./property-editor-ui-filter-group-picker.element-B0lRciAt.js"),
    meta: {
...
], J = [
  {
    ...
    element: () => import("./property-editor-ui-product-picker.element-BmqQnQyf.js"),
    meta: {
...
//# sourceMappingURL=bundle.manifests-C_8nVCor.js.map
