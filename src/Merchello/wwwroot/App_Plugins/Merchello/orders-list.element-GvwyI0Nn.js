...
var P = Object.defineProperty, R = Object.getOwnPropertyDescriptor, y = (e) => {
  ...
  for (var n = l > 1 ? void 0 : l ? R(t, i) : t, _ = e.length - 1, m; _ >= 0; _--)
    (m = e[_]) && (n = (l ? m(t, i, n) : m(n)) || n);
  return l && n && P(t, i, n), n;
}, O = (e, t, i) => t.has(e) || y("Cannot " + i), s = (e, t, i) => (O(e, t, "read from private field"), t.get(e)), v = (e, t, i) => t.has(e) ? y("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), p = (e, t, i, l) => (O(e, t, "write to private field"), t.set(e, i), i), u, h, d;
  ...
  async _loadOrders() {
    ...
    if (s(this, d)) {
      ...
      if (t) {
        ...
        const l = new Set(t.items.map((n) => n.id));
        this._selectedOrders = new Set(
          Array.from(this._selectedOrders).filter((n) => l.has(n))
        );
      }
      this._isLoading = !1;
    }
...
//# sourceMappingURL=orders-list.element-GvwyI0Nn.js.map
