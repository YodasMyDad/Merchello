...
import { a as o } from "./bundle.manifests-CKtonSjd.js";
...
class _ extends i {
  constructor(t) {
    super(t, d.toString()), this.workspaceAlias = m, this.#r = new a(this), this.#e = new p(void 0), this.order = this.#e.asObservable(), this.#r.setEntityType(o), this.#r.setUnique("orders"), this.routes = new n(t), this.routes.setRoutes([
      ...
      {
        path: "edit/orders/:id",
        component: () => import("./order-detail.element-u24uM3on.js"),
        setup: (r, e) => {
...
//# sourceMappingURL=orders-workspace.context-Cp54FIoz.js.map
