...
async function r(e) {
  try {
    ...
    let c;
    return n.includes("application/json") ? c = await o.json() : c = await o.text(), { data: c };
  } catch (t) {
...
async function i(e, t) {
  try {
    const s = await $(), o = d.baseUrl || "", n = await fetch(`${o}${m}/${e}`, {
      method: "POST",
      credentials: d.credentials,
      headers: s,
...
async function p(e) {
  try {
    ...
    if (!o.ok) {
      ...
      return { error: new Error(n || `HTTP ${o.status}: ${o.statusText}`) };
    }
    return {};
  } catch (t) {
    return { error: t instanceof Error ? t : new Error(String(t)) };
...
const w = {
  ...
  downloadCustomerStatement: async (e, t, s) => {
    try {
      const o = await $(), n = d.baseUrl || "", c = new URLSearchParams();
      t && c.append("periodStart", t), s && c.append("periodEnd", s);
      const u = c.toString(), S = `${n}${m}/customers/${e}/statement${u ? `?${u}` : ""}`, l = await fetch(S, {
        method: "GET",
        credentials: d.credentials,
      ...
      const P = await l.blob(), v = l.headers.get("content-disposition");
      let y = "statement.pdf";
      if (v) {
  ...
  /** Activate a discount */
  activateDiscount: (e) => a(`discounts/${e}/activate`),
  /** Deactivate a discount */
  deactivateDiscount: (e) => a(`discounts/${e}/deactivate`),
...
//# sourceMappingURL=merchello-api-DJVcrCxX.js.map
