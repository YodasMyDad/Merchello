import { LitElement as h, html as c, nothing as n, css as b, property as u, customElement as p } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as m } from "@umbraco-cms/backoffice/element-api";
import { a as f, O as v } from "./order.types-_o7xLk2Z.js";
import { c as g, a as k, d as C } from "./formatting-SQYZJ8LX.js";
      ...
      case "invoiceNumber":
        return c`
          <uui-table-cell class="order-number ${e.isCancelled ? "cancelled" : ""}">
            ...
            ${e.isCancelled ? c`<span class="badge cancelled">Cancelled</span>` : n}
            ...
            ${e.creditLimitExceeded ? c`<span class="badge warning">
                  <uui-icon name="icon-alert"></uui-icon>
                  Credit Limit
                </span>` : n}
          </uui-table-cell>
      ...
      case "total":
        return c`
          <uui-table-cell>
            ...
            ${e.isMultiCurrency ? c`<span class="currency-indicator">${e.currencyCode}</span>` : n}
          </uui-table-cell>
        `;
      case "paymentStatus":
        return c`
...
//# sourceMappingURL=order-table.element-BadrxynE.js.map
