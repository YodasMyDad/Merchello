import { nothing as n, html as s, css as y, state as m, customElement as x } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as D, UMB_MODAL_MANAGER_CONTEXT as w, UMB_CONFIRM_MODAL as V } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as $ } from "@umbraco-cms/backoffice/notification";
var A = Object.defineProperty, O = Object.getOwnPropertyDescriptor, _ = (a) => {
  throw TypeError(a);
}, d = (a, e, i, o) => {
  for (var t = o > 1 ? void 0 : o ? O(e, i) : e, r = a.length - 1, f; r >= 0; r--)
    (f = a[r]) && (t = (o ? f(e, i, t) : f(t)) || t);
  return o && t && A(e, i, t), t;
}, b = (a, e, i) => e.has(a) || _("Cannot " + i), v = (a, e, i) => (b(a, e, "read from private field"), e.get(a)), g = (a, e, i) => e.has(a) ? _("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(a) : e.set(a, i), p = (a, e, i, o) => (b(a, e, "write to private field"), e.set(a, i), i), c, h, u;
let l = class extends D {
  constructor() {
    super(), this._formData = {
      ...
      isVariant: !1,
      values: []
    }, this._isSaving = !1, this._errorMessage = null, this._originalIsVariant = !1, g(this, c), g(this, h), g(this, u, !1), this.consumeContext($, (a) => {
      p(this, c, a);
  ...
  async _handleSave() {
    if (this._validateForm()) {
      if (this.data?.option && this._originalIsVariant !== this._formData.isVariant) {
        const a = this._formData.isVariant ? "Enabling 'Generates Variants' will create new product variants. You'll need to regenerate variants for this to take effect." : "Disabling 'Generates Variants' will not delete existing variants, but they won't be regenerated.", e = v(this, h)?.open(this, V, {
          data: {
  ...
  _removeValue(a) {
    ...
    e.splice(a, 1), e.forEach((i, o) => i.sortOrder = o), this._formData = { ...this._formData, values: e };
  }
  _updateValue(a, e, i) {
    const o = [...this._formData.values || []];
    o[a] = { ...o[a], [e]: i }, this._formData = { ...this._formData, values: o };
  }
        ...
        <div class="value-content">
          <div class="value-name-row">
            <uui-input
              ...
              @input=${(t) => this._updateValue(e, "name", t.target.value)}>
            </uui-input>
            ...
            ${i === "colour" ? s`
                  <uui-input
                    ...
                    @input=${(t) => this._updateValue(e, "hexValue", t.target.value)}>
                  </uui-input>
                ` : n}
          </div>
                ...
                <div class="addon-fields">
                  <div class="addon-field">
                    ...
                    <uui-input
                      ...
                      placeholder="0.00"
                      @input=${(t) => this._updateValue(e, "priceAdjustment", parseFloat(t.target.value) || 0)}>
                    </uui-input>
                  </div>
                  ...
                  <div class="addon-field">
                    ...
                    <uui-input
                      ...
                      placeholder="0.00"
                      @input=${(t) => this._updateValue(e, "costAdjustment", parseFloat(t.target.value) || 0)}>
                    </uui-input>
                  </div>
                  ...
                  <div class="addon-field sku-field">
                    ...
                    <uui-input
                      ...
                      .value=${a.skuSuffix || ""}
                      placeholder="e.g., -GW"
                      @input=${(t) => this._updateValue(e, "skuSuffix", t.target.value)}>
                    </uui-input>
                  </div>
                </div>
  ...
  render() {
    const a = !this.data?.option, e = this._formData.values?.length || 0, i = this._getMaxValues(), o = this._formData.isVariant && e > 0 ? `Will create ${e} variants` : "";
    return s`
        ...
        <div class="modal-content">
          ...
          <uui-box>
            <div class="section-header" slot="headline">
              ...
              <span class="value-count">${e}/${i}</span>
            </div>
...
//# sourceMappingURL=option-editor-modal.element-rEc0u18H.js.map
