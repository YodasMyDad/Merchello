const e = [
  {
    ...
    js: () => import("./entrypoint-f-5yDifd.js")
  }
], o = [
  // Section
  {
  ...
  // Stats Dashboard
  {
    ...
    element: () => import("./stats-dashboard.element-CHPWe-CW.js"),
    meta: {
      label: "Stats",
      pathname: "stats"
    },
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-C5qkdRhk.js")
  },
  // Tree
  {
    type: "tree",
...
], H = "merchello-root", l = "merchello-orders", i = "merchello-products", t = "merchello-customers", r = "merchello-collections", s = "merchello-filters", c = "merchello-product-types", n = "merchello-product-feed", m = "merchello-analytics", p = "merchello-discounts", d = "merchello-suppliers", h = "merchello-warehouses", M = "merchello-emails", y = "merchello-providers", u = "merchello-webhooks", k = "merchello-outstanding", P = [
  // Fulfillment modal for creating shipments
  {
    type: "modal",
    alias: "Merchello.Fulfillment.Modal",
    name: "Merchello Fulfillment Modal",
    js: () => import("./fulfillment-modal.element-VL4DWAH1.js")
  },
  // Shipment edit modal for updating tracking info
  {
    ...
    js: () => import("./shipment-edit-modal.element-Ck-cu3Mr.js")
  },
  // Manual payment modal for recording offline payments
  {
    ...
    js: () => import("./manual-payment-modal.element-Da2GqnaY.js")
  },
  // Refund modal for processing refunds
  {
    ...
    js: () => import("./refund-modal.element-CT3Qf_Qy.js")
  },
  // Cancel invoice modal for cancelling invoices
  {
    ...
    js: () => import("./cancel-invoice-modal.element-BrBGWytN.js")
  },
  // Export modal for exporting orders to CSV
  {
    ...
    js: () => import("./export-modal.element-DiDK9Y1I.js")
  },
  // Edit order modal for editing order details
  {
    ...
    js: () => import("./edit-order-modal.element-Cm7mGUvd.js")
  },
  // Add custom item modal for edit order
  {
    ...
    js: () => import("./add-custom-item-modal.element-BjZf3zgn.js")
  },
  // Add discount modal for edit order
  {
    ...
    js: () => import("./add-discount-modal.element-BE5MD1rI.js")
  },
  // Create order modal for creating draft orders from backoffice
  {
    ...
    js: () => import("./create-order-modal.element-DLFKLCYF.js")
  },
  // Customer orders modal for viewing all orders by a customer
  {
    ...
    js: () => import("./customer-orders-modal.element-COhFDSbH.js")
  },
  // Generate statement modal for downloading customer statement PDFs
  {
    ...
    js: () => import("./generate-statement-modal.element-CTMtrxc5.js")
  },
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-DVuMn1Q0.js"),
    meta: {
      entityType: l
    }
  },
  // Workspace view - the orders list (used when on list route)
  {
    ...
    js: () => import("./orders-list.element-WhhlYVQc.js"),
    weight: 100,
    meta: {
      label: "Orders",
      pathname: "list",
  ...
  // Mark as paid modal
  {
    ...
    js: () => import("./mark-as-paid-modal.element-Ai-AeeY0.js")
  },
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-BrhUC7rh.js"),
    meta: {
      entityType: k
    }
  },
  // Workspace view - the outstanding list
  {
    ...
    js: () => import("./outstanding-list.element-xd0gsoUz.js"),
    weight: 100,
    meta: {
      label: "Outstanding",
      pathname: "list",
  ...
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-DtM0VM9O.js"),
    meta: {
      entityType: i
    }
  },
  // Workspace view for products list (used when on list route)
  {
    ...
    js: () => import("./products-list.element-r0nhW0zt.js"),
    weight: 100,
    meta: {
      label: "Products",
      pathname: "products",
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-BS_XK9Zb.js"),
    meta: {
      entityType: t
    }
  },
  // Workspace view - the customers list
  {
    ...
    js: () => import("./customers-list.element-DjRV2Dnv.js"),
    weight: 100,
    meta: {
      label: "Customers",
      pathname: "list",
  ...
  // Workspace view - the segments list (tab in Customers workspace)
  {
    ...
    js: () => import("./segments-list.element-BJlYb1Am.js"),
    weight: 90,
    meta: {
      label: "Segments",
      pathname: "segments",
  ...
  // Customer edit modal
  {
    ...
    js: () => import("./customer-edit-modal.element-CGq8Y7it.js")
  },
  // Customer picker modal (for adding members to segments)
  {
    ...
    js: () => import("./customer-picker-modal.element-CwLhbNhz.js")
  },
  // Segment picker modal (for discount eligibility)
  {
    ...
    js: () => import("./segment-picker-modal.element-BlN9NjXP.js")
  }
], b = [
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-BsRoEANL.js"),
    meta: {
      entityType: r
    }
  },
  // Workspace view for collections
  {
    ...
    js: () => import("./collections-workspace.element-BDhvgGK_.js"),
    weight: 100,
    meta: {
      label: "Collections",
  ...
  // Collection picker modal (for discount targeting)
  {
    ...
    js: () => import("./collection-picker-modal.element-CRSwT-8L.js")
  },
  // Collection create/edit modal
  {
    ...
    js: () => import("./collection-modal.element-DEE06aQx.js")
  }
], g = [
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-BhnqDgJd.js"),
    meta: {
      entityType: s
    }
  },
  // Workspace view for filters list
  {
    ...
    js: () => import("./filters-list.element-AAEujHtK.js"),
    weight: 100,
    meta: {
      label: "Filters",
      pathname: "filters",
  ...
  // Modal for creating/editing filter groups
  {
    ...
    js: () => import("./filter-group-modal.element-CiJf1HRL.js")
  },
  // Modal for creating/editing filters
  {
    ...
    js: () => import("./filter-modal.element-DP20Eiu1.js")
  },
  // Filter picker modal (for discount targeting)
  {
    ...
    js: () => import("./filter-picker-modal.element-ByDUyGY-.js")
  },
  // Filter group picker modal (for property editor)
  {
    ...
    js: () => import("./filter-group-picker-modal.element-Bxrol7AB.js")
  }
], W = [
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-BjklmlrJ.js"),
    meta: {
      entityType: c
    }
  },
  // Workspace view for product types
  {
    ...
    js: () => import("./product-types-list.element-angU7Vx3.js"),
    weight: 100,
    meta: {
      label: "Product Types",
  ...
  // Modal for create/edit product type
  {
    ...
    js: () => import("./product-type-modal.element-C0RMLJWH.js")
  },
  // Product type picker modal (for discount targeting)
  {
    ...
    js: () => import("./product-type-picker-modal.element-CUu6lEnA.js")
  }
], C = [
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-D053Bz5z.js"),
    meta: {
      entityType: n
    }
  },
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-V0jaGnMC.js"),
    meta: {
      entityType: y
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-Cr2PvCdQ.js"),
    meta: {
      entityType: m
    }
  },
  // Workspace view for analytics
  {
    ...
    js: () => import("./analytics-workspace.element-D_HQvlVn.js"),
    weight: 100,
    meta: {
      label: "Analytics",
      pathname: "analytics",
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-CUol7498.js"),
    meta: {
      entityType: p
    }
  },
  // Workspace view for discounts list (used when on list route)
  {
    ...
    js: () => import("./discounts-list.element-Dj-b2kS9.js"),
    weight: 100,
    meta: {
      label: "Discounts",
      pathname: "discounts",
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-DIW-7aGa.js"),
    meta: {
      entityType: M
    }
  },
  // Workspace view - the email list
  {
    ...
    js: () => import("./email-list.element-CrMZRRZ2.js"),
    weight: 100,
    meta: {
      label: "Emails",
      pathname: "list",
  ...
  // Email preview modal
  {
    ...
    js: () => import("./email-preview-modal.element-BXRNmjBW.js")
  }
], V = [
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-4JuQFnVQ.js"),
    meta: {
      entityType: u
    }
  },
  // Workspace view - the webhooks list
  {
    ...
    js: () => import("./webhooks-list.element-CCQ_ekky.js"),
    weight: 100,
    meta: {
      label: "Webhooks",
      pathname: "list",
  ...
  // Webhook subscription create/edit modal
  {
    ...
    js: () => import("./webhook-subscription-modal.element-C-fzuWh_.js")
  },
  // Webhook test modal
  {
    type: "modal",
    ...
    js: () => import("./webhook-test-modal.element-BGDkpGlb.js")
  },
  // Delivery detail modal
  {
    ...
    js: () => import("./delivery-detail-modal.element-Byp1kiEK.js")
  },
  ...
  // Workspace view for tax providers list (appears as "Tax" tab in Providers workspace)
  {
    ...
    js: () => import("./tax-providers-list.element-2FCFgyQV.js"),
    weight: 85,
    meta: {
      label: "Tax",
      pathname: "tax",
  ...
  // Tax group modal (handles both create and edit)
  {
    ...
    js: () => import("./tax-group-modal.element-Di1sATXU.js")
  },
  // Tax rate modal (handles both create and edit for geographic rates)
  {
    ...
    js: () => import("./tax-rate-modal.element-Bv8vIxCX.js")
  },
  // Tax provider config modal
  {
    ...
    js: () => import("./tax-provider-config-modal.element-BgSfjZi-.js")
  },
  // Test tax provider modal
  {
    ...
    js: () => import("./test-tax-provider-modal.element-BzdvUt4l.js")
  }
], I = [
  // ============================================
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-DHCPX3Nt.js"),
    meta: {
      entityType: d
    }
  },
  // List view for suppliers
  {
    ...
    js: () => import("./suppliers-list.element-Szs0THu9.js"),
    weight: 100,
    meta: {
      label: "Suppliers",
      pathname: "suppliers",
  ...
  // Supplier modal (handles both create and edit)
  {
    ...
    js: () => import("./supplier-modal.element-C0QBdl9X.js")
  },
  // Supplier picker modal (for discount targeting)
  {
    ...
    js: () => import("./supplier-picker-modal.element-DNeVpI_I.js")
  }
], v = [
  // ============================================
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-PaC20Bhs.js"),
    meta: {
      entityType: h
    }
  },
  // List view for warehouses (used when on list route)
  {
    ...
    js: () => import("./warehouses-list.element-BWFbtz1s.js"),
    weight: 100,
    meta: {
      label: "Warehouses",
      pathname: "warehouses",
  ...
  // Service region modal
  {
    ...
    js: () => import("./service-region-modal.element-DMFINIAn.js")
  },
  // Warehouse picker modal (for discount targeting)
  {
    ...
    js: () => import("./warehouse-picker-modal.element-BxElAI8D.js")
  }
], A = [
  // Workspace view for shipping providers (under Providers workspace)
  {
    ...
    js: () => import("./shipping-providers-list.element-BPwalobz.js"),
    weight: 90,
    meta: {
      label: "Shipping",
      pathname: "shipping",
  ...
  // Shipping provider configuration modal
  {
    ...
    js: () => import("./shipping-provider-config-modal.element-Cw0zUrO2.js")
  },
  // Test shipping provider modal
  {
    ...
    js: () => import("./test-provider-modal.element-DiT97aCI.js")
  },
  // Shipping option detail modal
  {
    ...
    js: () => import("./shipping-option-detail-modal.element-DAV497Rc.js")
  },
  // Shipping cost modal
  {
    type: "modal",
    ...
    js: () => import("./shipping-cost-modal.element-obGspDm0.js")
  },
  // Shipping weight tier modal
  {
    ...
    js: () => import("./shipping-weight-tier-modal.element-adtUi51S.js")
  }
], L = [
  // Workspace view for payment providers (under Providers workspace)
  {
    ...
    js: () => import("./payment-providers-list.element-Df3TM8eL.js"),
    weight: 100,
    meta: {
      label: "Payments",
      pathname: "payments",
  ...
  // Modal for configuring a payment provider
  {
    ...
    js: () => import("./payment-provider-config-modal.element-Cxrf7RzU.js")
  },
  // Modal for configuring payment methods within a provider
  {
    ...
    js: () => import("./payment-methods-config-modal.element-B56SbjX4.js")
  },
  ...
  // Modal for testing a payment provider
  {
    ...
    js: () => import("./test-provider-modal.element-o-1RoOIr.js")
  }
], R = [
  // Workspace view for exchange rate providers (under Providers workspace)
  {
    ...
    js: () => import("./exchange-rate-providers-list.element-Bu6Lo5GB.js"),
    weight: 80,
  ...
  // Modal for configuring an exchange rate provider
  {
    ...
    js: () => import("./exchange-rate-provider-config-modal.element-0c8tbSkb.js")
  },
  // Modal for testing an exchange rate provider
  {
    ...
    js: () => import("./test-provider-modal.element-0uHIZUvJ.js")
  }
], _ = [
  ...
  // Product picker modal for selecting products in orders and property editors
  {
    ...
    js: () => import("./product-picker-modal.element-B80dw_1y.js")
  }
], Y = [
  {
    ...
    element: () => import("./property-editor-ui-collection-picker.element-DIoU0y-b.js"),
    meta: {
...
], F = [
  {
    ...
    element: () => import("./property-editor-ui-product-type-picker.element-GLhCMliM.js"),
    meta: {
...
], D = [
  {
    ...
    element: () => import("./property-editor-ui-filter-group-picker.element-BOy0lk9k.js"),
    meta: {
...
], $ = [
  {
    ...
    element: () => import("./property-editor-ui-filter-value-picker.element-Bk_7jpea.js"),
    meta: {
...
], N = [
  {
    ...
    element: () => import("./property-editor-ui-product-picker.element-DGrl7OhK.js"),
    meta: {
...
//# sourceMappingURL=bundle.manifests-D4h6iN2e.js.map
