...
import { M as y } from "./merchello-api-Rt7qKkDA.js";
import { c as a, D as b } from "./formatting-BVxDxd-q.js";
...
var q = Object.defineProperty, E = Object.getOwnPropertyDescriptor, S = (e) => {
  ...
  for (var o = t > 1 ? void 0 : t ? E(i, s) : i, n = e.length - 1, g; n >= 0; n--)
    (g = e[n]) && (o = (t ? g(i, s, o) : g(o)) || o);
...
let d = class extends D {
  ...
  async _loadInvoice() {
    ...
    this._invoice = e.data ?? null, this._taxGroups = i.data ?? [], this._invoice && (this._orders = this._invoice.orders.map((s) => ({
      ...
      (s) => s.lineItems.map((t) => {
        const o = t.discounts.length > 0, n = o ? {
  ...
  _renderLineItem(e) {
    ...
    const i = this._invoice?.currencySymbol ?? "£", s = e.discount !== null, t = this._previewResult?.lineItems.find((m) => m.id === e.id), o = t?.hasInsufficientStock ?? !1, n = t?.canAddDiscount ?? !0, g = e.newQuantity < e.quantity, f = e.childLineItems ?? [];
    return r`
          ...
          <div class="line-item-details">
            ...
            ${e.isStockTracked && e.availableStock !== null ? r`
              <div class="stock-info ${o ? "error" : ""}">
                ${o ? r`<uui-icon name="icon-alert"></uui-icon> Only ${e.availableStock} available` : r`${e.availableStock} in stock`}
              </div>
            ` : c}
          </div>
        </div>
  ...
  _renderAddonLineItem(e, i, s) {
    ...
    return r`
      <div class="line-item child-item addon-item">
        ...
        <div class="line-item-total">
          ${t !== null ? r`+${s}${a(t, 2)}` : r`<span class="calculating">...</span>`}
        </div>
  ...
  render() {
    ...
    const e = this._invoice.currencySymbol, i = this._invoice.currencyCode, s = this._subtotalBeforeDiscounts, t = this._discountTotal, o = this._adjustedSubtotal, n = this._newTax, g = this._newTotal, f = this._hasChanges(), m = this._lineItems.filter((u) => u.isRemoved), P = t > 0;
    return r`
...
//# sourceMappingURL=edit-order-modal.element-DB8H1UEs.js.map
