import { html as d, nothing as g, css as x, state as l, customElement as R } from "@umbraco-cms/backoffice/external/lit";
...
import { M as _ } from "./merchello-api-0px5tmLf.js";
import { a as C } from "./formatting-DoC7VCqW.js";
var O = Object.defineProperty, z = Object.getOwnPropertyDescriptor, $ = (e) => {
  throw TypeError(e);
}, a = (e, i, s, r) => {
  for (var t = r > 1 ? void 0 : r ? z(i, s) : i, u = e.length - 1, o; u >= 0; u--)
    (o = e[u]) && (t = (r ? o(i, s, t) : o(t)) || t);
  return r && t && O(i, s, t), t;
...
let n = class extends F {
  ...
  _renderAddressField(e, i, s, r = "text", t = !1) {
    const o = (e === "billing" ? this._billingAddress : this._shippingAddress)[i] ?? "", c = this._validationErrors[`${e}.${i}`], h = e === "billing" ? this._updateBillingField : this._updateShippingField;
    return d`
      <umb-property-layout
        label=${s}
        ?mandatory=${t}
        ...
        <uui-input
          ...
          type=${r}
          .value=${o}
          @input=${(f) => h.call(this, i, f.target.value || null)}>
        </uui-input>
      </umb-property-layout>
    `;
  }
  _renderCountrySelect(e) {
    ...
    return d`
      ...
      s.call(this, "countryCode", t.value || null), s.call(this, "country", u?.name ?? null), s.call(this, "countyState", null), e === "billing" ? this._billingRegions = [] : this._shippingRegions = [], t.value && this._loadRegions(e, t.value);
    }}>
        </uui-select>
      </umb-property-layout>
    `;
  ...
  _renderRegionSelect(e) {
    ...
    if (u && s.length > 0) {
      const o = [
        { name: "Select region...", value: "", selected: !i.countyState }
      ];
      return s.forEach((c) => {
        o.push({
          name: c.name,
          value: c.regionCode,
          selected: c.regionCode === i.countyState || c.name === i.countyState
        });
      }), d`
        <umb-property-layout label="County/State">
          <uui-select
            ...
            .options=${o}
            @change=${(c) => {
        const h = c.target, f = s.find((L) => L.regionCode === h.value);
        t.call(this, "countyState", (f?.name ?? h.value) || null);
      }}>
          </uui-select>
        </umb-property-layout>
      `;
  ...
  _handleAddressLookupInput(e, i) {
    ...
    const o = e === "billing" ? this._billingAddress : this._shippingAddress, c = setTimeout(async () => {
      ...
      const { data: h, error: f } = await _.getOrderAddressLookupSuggestions({
        query: r,
        countryCode: o.countryCode ?? void 0,
        limit: this._addressLookupConfig?.maxSuggestions ?? 10
      });
      e === "billing" ? this._isSearchingBillingAddress = !1 : this._isSearchingShippingAddress = !1, !(f || !h?.success) && (e === "billing" ? (this._billingAddressSuggestions = h.suggestions ?? [], this._showBillingAddressDropdown = this._billingAddressSuggestions.length > 0) : (this._shippingAddressSuggestions = h.suggestions ?? [], this._showShippingAddressDropdown = this._shippingAddressSuggestions.length > 0));
    }, 300);
  ...
  async _selectAddressSuggestion(e, i) {
    ...
    const o = t.address;
    o.company && r.call(this, "company", o.company), o.address1 && r.call(this, "addressOne", o.address1), o.address2 && r.call(this, "addressTwo", o.address2), o.city && r.call(this, "townCity", o.city), o.state && r.call(this, "countyState", o.state), o.postalCode && r.call(this, "postalCode", o.postalCode), o.countryCode && o.stateCode && await this._loadRegions(e, o.countryCode);
  }
...
//# sourceMappingURL=create-order-modal.element-DuhMHmKq.js.map
