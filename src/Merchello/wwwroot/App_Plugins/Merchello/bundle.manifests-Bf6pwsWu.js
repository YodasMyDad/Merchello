const e = [
  {
    ...
    js: () => import("./entrypoint-B-EKgsQU.js")
  }
], o = [
  // Section
  {
  ...
  // Stats Dashboard
  {
    ...
    element: () => import("./stats-dashboard.element-Ba-Presu.js"),
    meta: {
      label: "Stats",
      pathname: "stats"
    },
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-Q7R0NPiL.js")
  },
  // Tree
  {
    type: "tree",
  ...
  // Fulfillment modal for creating shipments
  {
    ...
    js: () => import("./fulfillment-modal.element-B7BQv9Hd.js")
  },
  // Shipment edit modal for updating tracking info
  {
    ...
    js: () => import("./shipment-edit-modal.element-DBr0irUL.js")
  },
  // Manual payment modal for recording offline payments
  {
    ...
    js: () => import("./manual-payment-modal.element-Eb60_q4n.js")
  },
  // Refund modal for processing refunds
  {
    ...
    js: () => import("./refund-modal.element-Y6HmT8_V.js")
  },
  // Cancel invoice modal for cancelling invoices
  {
    ...
    js: () => import("./cancel-invoice-modal.element-CbB7jzra.js")
  },
  // Export modal for exporting orders to CSV
  {
    ...
    js: () => import("./export-modal.element-KO57J_HG.js")
  },
  // Edit order modal for editing order details
  {
    ...
    js: () => import("./edit-order-modal.element-B_eL-mE3.js")
  },
  // Add custom item modal for edit order
  {
    ...
    js: () => import("./add-custom-item-modal.element-uwBEmNO5.js")
  },
  // Add discount modal for edit order
  {
    ...
    js: () => import("./add-discount-modal.element-CDgzTUaR.js")
  },
  // Create order modal for creating manual orders from backoffice
  {
    ...
    js: () => import("./create-order-modal.element-CPqM4GXu.js")
  },
  // Customer orders modal for viewing all orders by a customer
  {
    ...
    js: () => import("./customer-orders-modal.element-BP3UH8qX.js")
  },
  // Generate statement modal for downloading customer statement PDFs
  {
    ...
    js: () => import("./generate-statement-modal.element-_utbcFNo.js")
  },
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-TbIS2UgB.js"),
    meta: {
      entityType: i
    }
  },
  // Workspace view - the orders list (used when on list route)
  {
    ...
    js: () => import("./orders-list.element-Uu8SKZDX.js"),
    weight: 100,
    meta: {
      label: "Orders",
      pathname: "list",
  ...
  // Mark as paid modal
  {
    ...
    js: () => import("./mark-as-paid-modal.element-C9G1XjCZ.js")
  },
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-CP2qypue.js"),
    meta: {
      entityType: P
    }
  },
  // Workspace view - the outstanding list
  {
    ...
    js: () => import("./outstanding-list.element-CQ7h3PxG.js"),
    weight: 100,
    meta: {
      label: "Outstanding",
      pathname: "list",
  ...
  // Workspace for abandoned checkouts list (when clicking "Abandoned Checkouts" in tree)
  {
    ...
    api: () => import("./abandoned-checkouts-workspace.context-DaQPrCqg.js"),
    meta: {
      entityType: w
    }
  },
  // Workspace view - the abandoned checkouts list
  {
    ...
    js: () => import("./abandoned-checkouts-list.element-D3OLJM6A.js"),
    weight: 100,
    meta: {
  ...
  // Create product modal
  {
    ...
    js: () => import("./create-product-modal.element-BqbjATEi.js")
  },
  // Option editor modal
  {
    type: "modal",
  ...
  // Variant batch update modal
  {
    ...
    js: () => import("./variant-batch-update-modal.element-C9U_ULNw.js")
  },
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-DdBpvGUi.js"),
    meta: {
      entityType: t
    }
  },
  // Workspace view for products list (used when on list route)
  {
    ...
    js: () => import("./products-list.element-DL3wxY6l.js"),
    weight: 100,
    meta: {
      label: "Products",
      pathname: "products",
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-DFoDdlTJ.js"),
    meta: {
      entityType: r
    }
  },
  // Workspace view - the customers list
  {
    ...
    js: () => import("./customers-list.element-tBaR67r_.js"),
    weight: 100,
    meta: {
      label: "Customers",
      pathname: "list",
  ...
  // Workspace view - the segments list (tab in Customers workspace)
  {
    ...
    js: () => import("./segments-list.element-DP4UMQTP.js"),
    weight: 90,
    meta: {
      label: "Segments",
      pathname: "segments",
  ...
  // Customer edit modal
  {
    ...
    js: () => import("./customer-edit-modal.element-C1N0stfl.js")
  },
  // Customer picker modal (for adding members to segments)
  {
    ...
    js: () => import("./customer-picker-modal.element-nns5Zogk.js")
  },
  // Segment picker modal (for discount eligibility)
  {
    ...
    js: () => import("./segment-picker-modal.element-2MJbzXdz.js")
  }
], U = [
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-B7n93eGo.js"),
    meta: {
      entityType: s
    }
  },
  // Workspace view for collections
  {
    ...
    js: () => import("./collections-workspace.element-D_jIHqg3.js"),
    weight: 100,
    meta: {
      label: "Collections",
  ...
  // Collection picker modal (for discount targeting)
  {
    ...
    js: () => import("./collection-picker-modal.element-CA08CXVt.js")
  },
  // Collection create/edit modal
  {
    ...
    js: () => import("./collection-modal.element-BoIF04fW.js")
  }
], S = [
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-V-zuyf65.js"),
    meta: {
      entityType: c
    }
  },
  // Workspace view for filters list
  {
    ...
    js: () => import("./filters-list.element-BivBaIfC.js"),
    weight: 100,
    meta: {
      label: "Filters",
      pathname: "filters",
  ...
  // Modal for creating/editing filter groups
  {
    ...
    js: () => import("./filter-group-modal.element-CvefCxQR.js")
  },
  // Modal for creating/editing filters
  {
    ...
    js: () => import("./filter-modal.element-tQB0jCP7.js")
  },
  // Filter picker modal (for discount targeting)
  {
    ...
    js: () => import("./filter-picker-modal.element-7RoJ5ebH.js")
  },
  // Filter group picker modal (for property editor)
  {
    ...
    js: () => import("./filter-group-picker-modal.element-D_1DwdPP.js")
  }
], j = [
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-BpazGDF8.js"),
    meta: {
      entityType: n
    }
  },
  // Workspace view for product types
  {
    ...
    js: () => import("./product-types-list.element-BERlAkCI.js"),
    weight: 100,
    meta: {
      label: "Product Types",
  ...
  // Modal for create/edit product type
  {
    ...
    js: () => import("./product-type-modal.element-CmCnfJIv.js")
  },
  // Product type picker modal (for discount targeting)
  {
    ...
    js: () => import("./product-type-picker-modal.element-CbeYEO9f.js")
  }
], V = [
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-w7ySiw7W.js"),
    meta: {
      entityType: p
    }
  },
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-DF8Yu4ES.js"),
    meta: {
      entityType: u
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-RtCEhfg_.js"),
    meta: {
      entityType: m
    }
  },
  // Workspace view for analytics
  {
    ...
    js: () => import("./analytics-workspace.element-D8MWGx_d.js"),
    weight: 100,
    meta: {
      label: "Analytics",
      pathname: "analytics",
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-Db0_4niT.js"),
    meta: {
      entityType: d
    }
  },
  // Workspace view for discounts list (used when on list route)
  {
    ...
    js: () => import("./discounts-list.element-nxhZ8kyr.js"),
    weight: 100,
    meta: {
      label: "Discounts",
      pathname: "discounts",
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-AfMzfYgF.js"),
    meta: {
      entityType: y
    }
  },
  // Workspace view - the email list
  {
    ...
    js: () => import("./email-list.element-DmN3NmuU.js"),
    weight: 100,
    meta: {
      label: "Emails",
      pathname: "list",
  ...
  // Email preview modal
  {
    ...
    js: () => import("./email-preview-modal.element-CWMLDWq2.js")
  }
], I = [
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-LboSJNLK.js"),
    meta: {
      entityType: k
    }
  },
  // Workspace view - the webhooks list
  {
    ...
    js: () => import("./webhooks-list.element-3p4xE2iX.js"),
    weight: 100,
    meta: {
      label: "Webhooks",
      pathname: "list",
  ...
  // Webhook subscription create/edit modal
  {
    ...
    js: () => import("./webhook-subscription-modal.element-Cx8CFT_a.js")
  },
  // Webhook test modal
  {
    type: "modal",
    ...
    js: () => import("./webhook-test-modal.element-Df9ld0Oh.js")
  },
  // Delivery detail modal
  {
    ...
    js: () => import("./delivery-detail-modal.element-DRY9fQLT.js")
  },
  ...
  // Workspace for notifications (when clicking "Notifications" in tree)
  {
    ...
    api: () => import("./notifications-workspace.context-Dxit7iHv.js"),
    meta: {
      entityType: E
    }
  },
  ...
  // Workspace view for tax providers list (appears as "Tax" tab in Providers workspace)
  {
    ...
    js: () => import("./tax-providers-list.element-DgyirMOI.js"),
    weight: 85,
    meta: {
      label: "Tax",
      pathname: "tax",
  ...
  // Tax group modal (handles both create and edit)
  {
    ...
    js: () => import("./tax-group-modal.element-tOYjKyqU.js")
  },
  // Tax rate modal (handles both create and edit for geographic rates)
  {
    ...
    js: () => import("./tax-rate-modal.element-NLHh-Rjl.js")
  },
  // Tax provider config modal
  {
    ...
    js: () => import("./tax-provider-config-modal.element-CYEKwqTB.js")
  },
  // Test tax provider modal
  {
    ...
    js: () => import("./test-tax-provider-modal.element-CYU6aS9X.js")
  },
  // Shipping tax override modal
  {
    ...
    js: () => import("./shipping-tax-override-modal.element-C7HdBUsw.js")
  }
], x = [
  // ============================================
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-CLgyb0GB.js"),
    meta: {
      entityType: h
    }
  },
  // List view for suppliers
  {
    ...
    js: () => import("./suppliers-list.element-DFEI_KMt.js"),
    weight: 100,
    meta: {
      label: "Suppliers",
      pathname: "suppliers",
  ...
  // Supplier modal (handles both create and edit)
  {
    ...
    js: () => import("./supplier-modal.element-R5pH_u6T.js")
  },
  // Supplier picker modal (for discount targeting)
  {
    ...
    js: () => import("./supplier-picker-modal.element-DLuRG2FK.js")
  }
], F = [
  // ============================================
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-C8Uaxy8b.js"),
    meta: {
      entityType: M
    }
  },
  // List view for warehouses (used when on list route)
  {
    ...
    js: () => import("./warehouses-list.element-DFowF6VP.js"),
    weight: 100,
    meta: {
      label: "Warehouses",
      pathname: "warehouses",
  ...
  // Service region modal
  {
    ...
    js: () => import("./service-region-modal.element-CivCTUX9.js")
  },
  // Warehouse picker modal (for discount targeting)
  {
    ...
    js: () => import("./warehouse-picker-modal.element-BOi0dYh9.js")
  }
], Y = [
  // Workspace view for shipping providers (under Providers workspace)
  {
    ...
    js: () => import("./shipping-providers-list.element-CWEbWGgl.js"),
    weight: 90,
    meta: {
      label: "Shipping",
      pathname: "shipping",
  ...
  // Shipping provider configuration modal
  {
    ...
    js: () => import("./shipping-provider-config-modal.element-CGFQhByH.js")
  },
  // Test shipping provider modal
  {
    ...
    js: () => import("./test-provider-modal.element-DpWMscLa.js")
  },
  // Shipping option detail modal
  {
    ...
    js: () => import("./shipping-option-detail-modal.element-DGcrUmbB.js")
  },
  // Shipping cost modal
  {
    type: "modal",
    ...
    js: () => import("./shipping-cost-modal.element-CUnIX6XE.js")
  },
  // Shipping weight tier modal
  {
    ...
    js: () => import("./shipping-weight-tier-modal.element-BoplFFMk.js")
  },
  // Shipping destination exclusion modal
  {
    ...
    js: () => import("./shipping-destination-exclusion-modal.element-Nx53sv_X.js")
  },
  // Shipping postcode rule modal
  {
    ...
    js: () => import("./shipping-postcode-rule-modal.element-BAKj8S8H.js")
  }
], D = [
  // Workspace view for payment providers (under Providers workspace)
  {
    ...
    js: () => import("./payment-providers-list.element-BFZkgG2W.js"),
    weight: 100,
    meta: {
      label: "Payments",
      pathname: "payments",
  ...
  // Modal for configuring a payment provider
  {
    ...
    js: () => import("./payment-provider-config-modal.element-BoLE5izz.js")
  },
  // Modal for configuring payment methods within a provider
  {
    ...
    js: () => import("./payment-methods-config-modal.element-BE5OmQdk.js")
  },
  // Modal for editing a single payment method's display settings
  {
    ...
    js: () => import("./payment-method-edit-modal.element-Dii82oNM.js")
  },
  ...
  // Modal for testing a payment provider
  {
    ...
    js: () => import("./test-provider-modal.element-J5Vgc7sI.js")
  }
], $ = [
  // Workspace view for fulfilment providers (under Providers workspace)
  {
    ...
    js: () => import("./fulfilment-providers-list.element-zUnwk0X2.js"),
    weight: 75,
    meta: {
      label: "Fulfilment",
      pathname: "fulfilment",
  ...
  // Configuration modal
  {
    ...
    js: () => import("./fulfilment-provider-config-modal.element-CcS40dh1.js")
  },
  // Test modal
  {
    type: "modal",
    ...
    js: () => import("./test-provider-modal.element-CMp_5NsW.js")
  }
], N = [
  // Workspace view for exchange rate providers (under Providers workspace)
  {
    ...
    js: () => import("./exchange-rate-providers-list.element-bsehcDm3.js"),
    weight: 80,
  ...
  // Modal for configuring an exchange rate provider
  {
    ...
    js: () => import("./exchange-rate-provider-config-modal.element-DVouzmnr.js")
  },
  // Modal for testing an exchange rate provider
  {
    ...
    js: () => import("./test-provider-modal.element-CrfO1eAW.js")
  }
], H = [
  // Workspace view for address lookup providers (under Providers workspace)
  {
    ...
    js: () => import("./address-lookup-providers-list.element-KdaYIAls.js"),
    weight: 85,
    meta: {
  ...
  // Modal for configuring an address lookup provider
  {
    ...
    js: () => import("./address-lookup-provider-config-modal.element-DbUVdweS.js")
  },
  // Modal for testing an address lookup provider
  {
    ...
    js: () => import("./test-provider-modal.element-C89xQxDM.js")
  }
], G = [
  {
    type: "workspace",
    ...
    api: () => import("./upsells-workspace.context-Dvgt171I.js"),
    meta: {
      entityType: b
    }
  },
  {
    ...
    js: () => import("./upsells-list.element--tkQW4VD.js"),
    weight: 100,
    meta: {
      label: "Upsells",
      pathname: "upsells",
  ...
  },
  {
    ...
    js: () => import("./create-upsell-modal.element-DKejpWpM.js")
  },
  {
    type: "modal",
  ...
  // Workspace for root (when clicking "Merchello" in tree)
  {
    ...
    api: () => import("./settings-workspace.context-ZL9F_O01.js"),
    meta: {
      entityType: l
    }
  },
  {
    ...
    js: () => import("./settings-workspace.element-OwMCilDb.js"),
    weight: 100,
    meta: {
      label: "Overview",
      pathname: "overview",
  ...
  // Product picker modal for selecting products in orders and property editors
  {
    ...
    js: () => import("./product-picker-modal.element-BSa0Q9TO.js")
  }
], K = [
  {
    ...
    element: () => import("./property-editor-ui-collection-picker.element-CUifgntL.js"),
    meta: {
...
], z = [
  {
    ...
    element: () => import("./property-editor-ui-product-type-picker.element-_fBm0bwM.js"),
    meta: {
...
], J = [
  {
    ...
    element: () => import("./property-editor-ui-filter-group-picker.element-IE1SwVOd.js"),
    meta: {
...
], Q = [
  {
    ...
    element: () => import("./property-editor-ui-filter-value-picker.element-fRHiCLuR.js"),
    meta: {
...
], X = [
  {
    ...
    element: () => import("./property-editor-ui-product-picker.element-BqGl73lS.js"),
    meta: {
...
], Z = [
  {
    ...
    element: () => import("./property-editor-ui-google-shopping-category-picker.element-CKdC-Hpm.js"),
    meta: {
...
//# sourceMappingURL=bundle.manifests-Bf6pwsWu.js.map
