...
import { UmbModalToken as k, UMB_MODAL_MANAGER_CONTEXT as G, UMB_CONFIRM_MODAL as oe } from "@umbraco-cms/backoffice/modal";
import { f as H, a as y, b as K, g as j, D, e as f, h as v, i as l, d as F, c as ne } from "./discount.types-YWYxoniA.js";
import { M as x } from "./merchello-api-CasfpHxB.js";
import { t as ue, u as le, v as ce } from "./navigation-m-G5wLvz.js";
import { a as de, c as B } from "./formatting-DZcj68CA.js";
import { M as pe } from "./customer-picker-modal.token-BZSMisS9.js";
import { M as he } from "./product-picker-modal.token-BfbHsSHl.js";
var me = Object.defineProperty, ge = Object.getOwnPropertyDescriptor, V = (e, t, i, a) => {
...
let P = class extends L(E) {
  constructor() {
    super(), this.rules = [], this.readonly = !1, Ce(this, w), this.consumeContext(G, (e) => {
      $e(this, w, e);
    });
  }
  _dispatchChange() {
  ...
  async _openCustomerPicker(e, t) {
    if (!M(this, w)) return;
    const a = await M(this, w).open(this, pe, {
      data: {
...
let S = class extends L(E) {
  ...
  async _openCollectionPicker(e, t) {
    if (!_(this, h)) return;
    const a = await _(this, h).open(this, De, {
      data: {
  ...
  async _openProductTypePicker(e, t) {
    if (!_(this, h)) return;
    const a = await _(this, h).open(this, Te, {
      data: {
        excludeIds: t.targetIds ?? [],
        multiSelect: !0
      }
  ...
  async _openSupplierPicker(e, t) {
    if (!_(this, h)) return;
    const a = await _(this, h).open(this, we, {
      data: {
        excludeIds: t.targetIds ?? [],
        multiSelect: !0
      }
...
let p = class extends L(E) {
  ...
  _getValueTypeOptions() {
    ...
    return this._discount?.category === F.BuyXGetY && e.push({ name: "Free", value: y.Free, selected: this._discount?.valueType === y.Free }), e;
  }
...
//# sourceMappingURL=discount-detail.element-BXL-Iv8c.js.map
