...
var v = Object.defineProperty, b = Object.getOwnPropertyDescriptor, r = (e, i, a, l) => {
  for (var t = l > 1 ? void 0 : l ? b(i, a) : i, d = e.length - 1, p; d >= 0; d--)
    (p = e[d]) && (t = (l ? p(i, a, t) : p(t)) || t);
  return l && t && v(i, a, t), t;
};
let s = class extends f {
  constructor() {
    super(...arguments), this._discountType = o.Amount, this._discountValue = 0, this._discountReason = "", this._visibleToCustomer = !1, this._errors = {};
  }
  connectedCallback() {
  ...
  _validate() {
    const e = {};
    return this._discountValue <= 0 && (e.value = "Discount value must be greater than 0"), this._discountType === o.Percentage && this._discountValue > 100 && (e.value = "Percentage cannot exceed 100%"), this._errors = e, Object.keys(e).length === 0;
  }
  _handleApply() {
  ...
  _getCalculatedDiscount() {
    ...
    return this._discountType === o.Amount ? Math.min(this._discountValue * (this.data.lineItemQuantity ?? 1), e) : e * (this._discountValue / 100);
  }
  render() {
    const e = this.data?.currencySymbol ?? "£", i = this.data?.isOrderDiscount ?? !0, a = !!this.data?.existingDiscount;
    return n`
      <umb-body-layout headline=${a ? "Edit discount" : i ? "Add order discount" : "Add line item discount"}>
        <div id="main">
          ...
          <div class="form-row">
            <label for="discount-value">
              Value ${this._discountType === o.Percentage ? "(%)" : i ? "" : "(per unit)"}
            </label>
            <div class="input-with-affix">
              ${this._discountType === o.Amount ? n`<span class="prefix">${e}</span>` : u}
              <uui-input
                id="discount-value"
                type="number"
...
//# sourceMappingURL=add-discount-modal.element-BBj0dUVf.js.map
