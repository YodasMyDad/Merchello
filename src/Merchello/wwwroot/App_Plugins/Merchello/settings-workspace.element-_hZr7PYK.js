...
import { b as Z } from "./formatting-SQYZJ8LX.js";
    ...
    return o`
      <div class="session-state">
        <div
          ...
          @click=${this._sessionId ? () => {
      this._copyText(this._sessionId, "Session ID");
    } : c}>
        ...
        <div
          ...
          title="${this._orderId ?? ""}"
          @click=${this._orderId ? () => {
      this._copyText(this._orderId, "Order ID");
    } : c}>
...
//# sourceMappingURL=settings-workspace.element-_hZr7PYK.js.map
