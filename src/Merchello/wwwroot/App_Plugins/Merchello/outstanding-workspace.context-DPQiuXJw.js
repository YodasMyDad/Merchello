...
import { n as e } from "./bundle.manifests-D4_333c9.js";
const r = "Merchello.Outstanding.Workspace";
class E extends n {
  constructor(t) {
    super(t, s.toString()), this.workspaceAlias = r, this.#t = new o(this), this.#t.setEntityType(e), this.#t.setUnique("outstanding"), this.routes = new i(t), this.routes.setRoutes([
...
//# sourceMappingURL=outstanding-workspace.context-DPQiuXJw.js.map
