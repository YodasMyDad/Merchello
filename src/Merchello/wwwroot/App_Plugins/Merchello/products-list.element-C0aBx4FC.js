import { LitElement as P, nothing as w, html as r, css as S, property as p, state as l, customElement as k } from "@umbraco-cms/backoffice/external/lit";
...
import { g as E } from "./store-settings-DdTmiT9W.js";
...
import { a as f } from "./formatting-DoC7VCqW.js";
      ...
      case "select":
        return r`
          <uui-table-cell class="checkbox-col">
            <uui-checkbox label="Select" aria-label="Select ${e.rootName}" ?checked=${this.selectedIds.includes(e.id)}
...
//# sourceMappingURL=products-list.element-C0aBx4FC.js.map
