...
async function t(e) {
  try {
    const r = await h(), s = p.baseUrl || "", o = await fetch(`${s}${u}/${e}`, {
      method: "GET",
    ...
    let g;
    return n.includes("application/json") ? g = await o.json() : g = await o.text(), { data: g };
  } catch (r) {
...
async function a(e, r) {
  try {
    const s = await h(), o = p.baseUrl || "", n = await fetch(`${o}${u}/${e}`, {
      method: "POST",
      credentials: p.credentials,
      headers: s,
...
const v = {
  ...
  createTaxGroup: (e) => a("tax-groups", e),
  /** Update an existing tax group */
  updateTaxGroup: (e, r) => i(`tax-groups/${e}`, r),
  /** Delete a tax group */
  ...
  updateBillingAddress: (e, r) => i(`orders/${e}/billing-address`, r),
  updateShippingAddress: (e, r) => i(`orders/${e}/shipping-address`, r),
  updatePurchaseOrder: (e, r) => i(`orders/${e}/purchase-order`, { purchaseOrder: r }),
  ...
  searchCustomers: (e, r) => {
    ...
    const o = s.toString();
    return t(`orders/customer-lookup${o ? `?${o}` : ""}`);
  },
  ...
  editInvoice: (e, r) => i(`orders/${e}/edit`, r),
  ...
  updateShipment: (e, r) => i(`shipments/${e}`, r),
  ...
  testPaymentProvider: (e, r) => a(`payment-providers/${e}/test`, r),
  // ============================================
  // Payments API
  // ============================================
  ...
  updateShippingProvider: (e, r) => i(`shipping-providers/${e}`, r),
  ...
  toggleShippingProvider: (e, r) => i(`shipping-providers/${e}/toggle`, { isEnabled: r }),
  ...
  testShippingProvider: (e, r) => a(`shipping-providers/${e}/test`, r),
  // ============================================
  // Products API
  // ============================================
  ...
  createProduct: (e) => a("products", e),
  /** Update product root */
  updateProduct: (e, r) => i(`products/${e}`, r),
  ...
  /** Update a variant */
  updateVariant: (e, r, s) => i(`products/${e}/variants/${r}`, s),
  /** Set a variant as the default */
  setDefaultVariant: (e, r) => i(`products/${e}/variants/${r}/set-default`),
  // Options operations
  /** Save all product options (replaces existing). Variants are automatically regenerated. */
  saveProductOptions: (e, r) => i(`products/${e}/options`, r),
  // ============================================
  ...
  createShippingOption: (e) => a("shipping-options", e),
  /** Update a shipping option */
  updateShippingOption: (e, r) => i(`shipping-options/${e}`, r),
  /** Delete a shipping option */
  deleteShippingOption: (e) => d(`shipping-options/${e}`),
  /** Add a cost to a shipping option */
  addShippingCost: (e, r) => a(`shipping-options/${e}/costs`, r),
  /** Update a shipping cost */
  updateShippingCost: (e, r) => i(`shipping-costs/${e}`, r),
  /** Delete a shipping cost */
  deleteShippingCost: (e) => d(`shipping-costs/${e}`),
  /** Add a weight tier to a shipping option */
  addShippingWeightTier: (e, r) => a(`shipping-options/${e}/weight-tiers`, r),
  /** Update a weight tier */
  updateShippingWeightTier: (e, r) => i(`shipping-weight-tiers/${e}`, r),
  ...
  createWarehouse: (e) => a("warehouses", e),
  /** Update a warehouse */
  updateWarehouse: (e, r) => i(`warehouses/${e}`, r),
  /** Delete a warehouse */
  ...
  addServiceRegion: (e, r) => a(`warehouses/${e}/service-regions`, r),
  /** Update a service region */
  updateServiceRegion: (e, r, s) => i(`warehouses/${e}/service-regions/${r}`, s),
  ...
  createSupplier: (e) => a("suppliers", e),
  /** Update an existing supplier */
  updateSupplier: (e, r) => i(`suppliers/${e}`, r),
  /** Delete a supplier */
  ...
  saveExchangeRateProviderSettings: (e, r) => i(`exchange-rate-providers/${e}/settings`, r),
  /** Test an exchange rate provider by fetching rates */
  testExchangeRateProvider: (e) => a(`exchange-rate-providers/${e}/test`),
  /** Force refresh the exchange rate cache */
  refreshExchangeRates: () => a("exchange-rate-providers/refresh"),
...
//# sourceMappingURL=merchello-api-C9FLsMxF.js.map
