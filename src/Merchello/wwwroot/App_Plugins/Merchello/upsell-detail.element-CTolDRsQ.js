import { LitElement as L, html as l, nothing as n, css as F, property as H, customElement as M, state as v } from "@umbraco-cms/backoffice/external/lit";
...
import { E as ce, F as de, G as pe } from "./navigation-CURxaj93.js";
...
T = X([
  M("merchello-upsell-trigger-rule-builder")
], T);
...
E = Z([
  M("merchello-upsell-recommendation-rule-builder")
], E);
...
N = te([
  M("merchello-upsell-eligibility-rule-builder")
], N);
...
var Fe = Object.defineProperty, Me = Object.getOwnPropertyDescriptor, ae = (e) => {
  throw TypeError(e);
}, m = (e, t, a, i) => {
  for (var s = i > 1 ? void 0 : i ? Me(t, a) : t, p = e.length - 1, h; p >= 0; p--)
    (h = e[p]) && (s = (i ? h(t, a, s) : h(s)) || s);
...
//# sourceMappingURL=upsell-detail.element-CTolDRsQ.js.map
