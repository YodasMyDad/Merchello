...
import { D as p } from "./order.types-DjkMLpgj.js";
...
var L = Object.defineProperty, M = Object.getOwnPropertyDescriptor, w = (e) => {
  ...
  for (var n = o > 1 ? void 0 : o ? M(i, t) : i, l = e.length - 1, v; l >= 0; l--)
    (v = e[l]) && (n = (o ? v(i, t, n) : v(n)) || n);
  return o && n && L(i, t, n), n;
...
let r = class extends R {
  constructor() {
    super(), this._invoice = null, this._isLoading = !0, this._isSaving = !1, this._errorMessage = null, this._editReason = "", this._orders = [], this._lineItems = [], this._customItems = [], this._discountPopoverLineItemId = null, this._discountType = p.Amount, this._discountValue = 0, this._discountReason = "", this._discountVisibleToCustomer = !1, this._popoverPosition = { top: 0, left: 0 }, this._taxGroups = [], this._removedShippingOrders = /* @__PURE__ */ new Set(), this._taxRemoved = !1, this._removedOrderDiscounts = /* @__PURE__ */ new Set(), this._previewResult = null, this._previewLoading = !1, y(this, h), y(this, g), this.consumeContext(O, (e) => {
      x(this, h, e);
  ...
  async _loadInvoice() {
    ...
    this._invoice = e.data ?? null, this._taxGroups = i.data ?? [], this._invoice && (this._orders = this._invoice.orders.map((t) => ({
      ...
      (t) => t.lineItems.map((o) => {
        const n = o.discounts.length > 0, l = n ? {
  ...
  _openDiscountPopover(e, i) {
    ...
    const n = this._lineItems.find((l) => l.id === e);
    n?.discount ? (this._discountType = n.discount.type, this._discountValue = n.discount.value, this._discountReason = n.discount.reason ?? "", this._discountVisibleToCustomer = n.discount.visibleToCustomer) : (this._discountType = p.Amount, this._discountValue = 0, this._discountReason = "", this._discountVisibleToCustomer = !1), this._discountPopoverLineItemId = e;
  }
  ...
  _getOptimisticLineItemTotal(e, i, t) {
    const o = e * i;
    return !t || t.value <= 0 ? o : t.type === p.Amount ? Math.max(0, o - t.value * i) : o * (1 - t.value / 100);
  }
  _getDiscountTypeOptions() {
    return [
      { name: "Fixed amount", value: "0", selected: this._discountType === p.Amount },
      { name: "Percentage", value: "1", selected: this._discountType === p.Percentage }
    ];
  }
  ...
  _renderLineItem(e) {
    ...
    const i = this._invoice?.currencySymbol ?? "£", t = e.discount !== null, o = e.newQuantity < e.quantity, n = e.newQuantity > e.quantity, l = e.newQuantity - e.quantity, v = n && e.isStockTracked && e.availableStock !== null && e.availableStock < l, b = !e.hadOriginalDiscount || t;
    return s`
          ...
          <div class="line-item-details">
            ...
            ${e.isStockTracked && e.availableStock !== null ? s`
              <div class="stock-info ${v ? "error" : ""}">
                ${v ? s`<uui-icon name="icon-alert"></uui-icon> Only ${e.availableStock} available` : s`${e.availableStock} in stock`}
              </div>
            ` : d}
          </div>
        </div>
        ...
        <div class="line-item-price">
          ...
          ${t ? s`
            <div class="discount-badge">
              -${e.discount.type === p.Percentage ? `${e.discount.value}%` : `${i}${e.discount.value.toFixed(2)}`}
            ...
            <div class="order-discount-row">
              <div class="discount-info">
                ...
                <span class="discount-value">
                  ${t.type === p.Percentage ? `${t.value}%` : `${i}${t.value.toFixed(2)}`}
                </span>
              </div>
    ...
    return s`
      ...
      <div class="discount-popover" style=${i}>
        ...
        <div class="popover-row">
          <label>Value ${this._discountType === p.Percentage ? "(%)" : "(per unit)"}</label>
          <div class="input-with-affix">
            ${this._discountType === p.Amount ? s`<span class="prefix">${e}</span>` : d}
            <uui-input
              type="number"
              ...
              step="0.01"
            ></uui-input>
            ${this._discountType === p.Percentage ? s`<span class="suffix">%</span>` : d}
          </div>
        </div>
  ...
  _renderCustomItem(e) {
    const i = this._invoice?.currencySymbol ?? "£", t = e.taxGroupId ? this._taxGroups.find((n) => n.id === e.taxGroupId) : null, o = t ? `${t.name} (${t.taxPercentage}%)` : "Not taxable";
    return s`
  ...
  render() {
    ...
    const e = this._invoice.currencySymbol, i = this._invoice.currencyCode, t = this._subtotalBeforeDiscounts, o = this._discountTotal, n = this._adjustedSubtotal, l = this._newTax, v = this._newTotal, b = this._hasChanges(), m = this._lineItems.filter((c) => c.isRemoved), k = o > 0;
    return s`
...
//# sourceMappingURL=edit-order-modal.element-DeL7BJgA.js.map
