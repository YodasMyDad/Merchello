...
import { B as L } from "./navigation-CURxaj93.js";
...
var R = Object.defineProperty, N = Object.getOwnPropertyDescriptor, $ = (e) => {
  throw TypeError(e);
}, r = (e, i, a, u) => {
  for (var h = u > 1 ? void 0 : u ? N(i, a) : i, m = e.length - 1, y; m >= 0; m--)
    (y = e[m]) && (h = (u ? y(i, a, h) : y(h)) || h);
  return u && h && R(i, a, h), h;
...
let s = class extends C(D) {
  ...
  _handleIntegrationGuide() {
    !t(this, n) || !this._subscription || t(this, n).open(this, B, {
...
//# sourceMappingURL=webhook-detail.element-BkJKLnAn.js.map
