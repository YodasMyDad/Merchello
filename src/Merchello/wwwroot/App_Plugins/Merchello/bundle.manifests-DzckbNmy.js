const e = [
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-DonmAxRy.js")
  },
  // Tree
  {
    type: "tree",
  ...
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-bfh23EuM.js"),
    meta: {
      entityType: i
    }
  },
  ...
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-DGYqXKm0.js"),
    meta: {
      entityType: E
    }
  },
  ...
  // Workspace for abandoned checkouts list (when clicking "Abandoned Checkouts" in tree)
  {
    ...
    api: () => import("./abandoned-checkouts-workspace.context--6ss1Pxc.js"),
    meta: {
      entityType: w
    }
  },
  ...
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-BiMq7Dp2.js"),
    meta: {
      entityType: t
    }
  },
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-DSyrDE2z.js"),
    meta: {
      entityType: r
    }
  },
  ...
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-DoxuckZx.js"),
    meta: {
      entityType: s
    }
  },
  ...
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-CPpWUAMj.js"),
    meta: {
      entityType: c
    }
  },
  ...
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-BZ-UENTw.js"),
    meta: {
      entityType: n
    }
  },
  ...
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-CgemQRq4.js"),
    meta: {
      entityType: p
    }
  },
...
], A = [
  {
    ...
    api: () => import("./product-import-export-workspace.context-CooU36PK.js"),
    meta: {
      entityType: m
    }
  },
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-CF-MHQpr.js"),
    meta: {
      entityType: k
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-CWmWb7ON.js"),
    meta: {
      entityType: d
    }
  },
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-i6AAYkA8.js"),
    meta: {
      entityType: h
    }
  },
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-DPRT8i_8.js"),
    meta: {
      entityType: u
    }
  },
  ...
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-rCb5QnRf.js"),
    meta: {
      entityType: P
    }
  },
  ...
  // Workspace for notifications (when clicking "Notifications" in tree)
  {
    ...
    api: () => import("./notifications-workspace.context-DGMK5993.js"),
    meta: {
      entityType: T
    }
  },
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-jYF0g2Or.js"),
    meta: {
      entityType: M
    }
  },
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-Cliq9I2s.js"),
    meta: {
      entityType: y
    }
  },
...
], K = [
  {
    ...
    api: () => import("./upsells-workspace.context-ZgRbmt9k.js"),
    meta: {
      entityType: b
    }
  },
  ...
  // Workspace for root (when clicking "Merchello" in tree)
  {
    ...
    api: () => import("./settings-workspace.context-IRm5iYm0.js"),
    meta: {
      entityType: l
    }
  },
...
//# sourceMappingURL=bundle.manifests-DzckbNmy.js.map
