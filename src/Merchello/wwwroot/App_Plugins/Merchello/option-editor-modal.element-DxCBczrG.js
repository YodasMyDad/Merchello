import { nothing as n, html as r, css as y, state as m, customElement as D } from "@umbraco-cms/backoffice/external/lit";
...
var C = Object.defineProperty, k = Object.getOwnPropertyDescriptor, _ = (e) => {
  throw TypeError(e);
}, p = (e, t, a, i) => {
  for (var o = i > 1 ? void 0 : i ? k(t, a) : t, l = e.length - 1, v; l >= 0; l--)
    (v = e[l]) && (o = (i ? v(t, a, o) : v(o)) || o);
  return i && o && C(t, a, o), o;
}, b = (e, t, a) => t.has(e) || _("Cannot " + a), d = (e, t, a) => (b(e, t, "read from private field"), t.get(e)), g = (e, t, a) => t.has(e) ? _("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), h = (e, t, a, i) => (b(e, t, "write to private field"), t.set(e, a), a), f, c, u;
let s = class extends x {
  constructor() {
    super(), this._formData = {
      ...
      isRequired: !1,
      values: []
    }, this._isSaving = !1, this._errorMessage = null, this._originalIsVariant = !1, this._hasAttemptedSave = !1, g(this, f), g(this, c), g(this, u, !1), new M(this), this.consumeContext(A, (e) => {
      h(this, f, e);
  ...
  async _handleSave() {
    if (this._validateForm()) {
      if (this.data?.option && this._originalIsVariant !== this._formData.isVariant) {
        const e = this._formData.isVariant ? "Enabling 'Generates Variants' will create new product variants. You'll need to regenerate variants for this to take effect." : "Disabling 'Generates Variants' will not delete existing variants, but they won't be regenerated.", t = d(this, c)?.open(this, w, {
          data: {
      ...
      }, d(this, f)?.peek("positive", { data: { headline: "Option saved", message: `"${this._formData.name}" has been saved` } }), this.modalContext?.submit();
    }
  }
  _handleDelete() {
    this.value = {
  ...
  async _addValue() {
    ...
    this._errorMessage = null, e.push({
      ...
      skuSuffix: null,
      weightKg: null
    }), this._formData = { ...this._formData, values: e }, await this.updateComplete;
    const t = this.renderRoot.querySelectorAll(".value-row uui-input[label='Value name']");
    t[t.length - 1]?.focus();
  }
  _removeValue(e) {
    const t = [...this._formData.values || []];
    t.splice(e, 1), t.forEach((a, i) => a.sortOrder = i), this._formData = { ...this._formData, values: t };
  }
  _updateValue(e, t, a) {
  ...
  _renderValueEditor(e, t) {
    ...
    return r`
      <div class="value-row ${i ? "is-addon" : ""}">
      ...
      this._updateValue(t, "weightKg", l ? parseFloat(l) : null);
    }}>
                    </uui-input>
          ...
          <uui-box>
            ...
            ${this._formData.values && this._formData.values.length > 0 ? r`
                  <div class="values-list">
                    ${this._formData.values.map((o, l) => this._renderValueEditor(o, l))}
                  </div>
                ` : r`
...
//# sourceMappingURL=option-editor-modal.element-DxCBczrG.js.map
