...
import { a as o } from "./bundle.manifests-D4h6iN2e.js";
import { M as h } from "./merchello-api-CpOYLjBe.js";
...
class _ extends i {
  constructor(t) {
    super(t, n.toString()), this.workspaceAlias = m, this.#r = new a(this), this.#e = new p(void 0), this.order = this.#e.asObservable(), this.#r.setEntityType(o), this.#r.setUnique("orders"), this.routes = new d(t), this.routes.setRoutes([
      ...
      {
        path: "edit/orders/:id",
        component: () => import("./order-detail.element-v5W0xy8-.js"),
        setup: (r, e) => {
...
//# sourceMappingURL=orders-workspace.context-DVuMn1Q0.js.map
