import { LitElement as D, nothing as C, html as u, css as w, state as c, customElement as A } from "@umbraco-cms/backoffice/external/lit";
...
import { M as v } from "./merchello-api-OYuQK4Mu.js";
import { g as E } from "./store-settings-DGWNjuMS.js";
...
import { c as U, a as I } from "./formatting-CuYSKks5.js";
import { c as O } from "./collection-layout.styles-CmOznf4V.js";
...
}, T = (e, i, t) => i.has(e) || S("Cannot " + t), a = (e, i, t) => (T(e, i, "read from private field"), i.get(e)), m = (e, i, t) => i.has(e) ? S("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), d = (e, i, t, s) => (T(e, i, "write to private field"), i.set(e, t), t), p, h, n, y, k;
let l = class extends M(D) {
  constructor() {
    super(), this._upsells = [], this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._activeTab = "all", this._selectedUpsells = /* @__PURE__ */ new Set(), this._searchTerm = "", this._isDeleting = !1, this._isBulkActionRunning = !1, this._searchDebounceTimer = null, m(this, p), m(this, h), m(this, n, !1), m(this, y), m(this, k), this.consumeContext(R, (e) => {
      d(this, p, e);
  ...
  async _initializeAndLoad() {
    const e = await E();
    a(this, n) && (this._pageSize = e.defaultPaginationPageSize, d(this, y, e.currencyCode), d(this, k, e.currencySymbol), this._loadUpsells());
  }
  disconnectedCallback() {
    super.disconnectedCallback(), d(this, n, !1), this._searchDebounceTimer && clearTimeout(this._searchDebounceTimer);
  }
  async _loadUpsells() {
...
//# sourceMappingURL=upsells-list.element-T1vz9ov5.js.map
