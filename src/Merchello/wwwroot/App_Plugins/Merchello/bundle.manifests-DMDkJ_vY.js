const e = [
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-D7EIqhfH.js")
  },
  // Tree
  {
    type: "tree",
  ...
  // Edit order modal for editing order details
  {
    ...
    js: () => import("./edit-order-modal.element-Bxhrsoq_.js")
  },
  ...
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-FT4prA6L.js"),
    meta: {
      entityType: l
    }
  },
  ...
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-T2aNXwbH.js"),
    meta: {
      entityType: k
    }
  },
  ...
  // Workspace for abandoned checkouts list (when clicking "Abandoned Checkouts" in tree)
  {
    ...
    api: () => import("./abandoned-checkouts-workspace.context-Bh8UrZ-3.js"),
    meta: {
      entityType: P
    }
  },
  ...
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-vDiL606Q.js"),
    meta: {
      entityType: i
    }
  },
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-B9cRH68e.js"),
    meta: {
      entityType: t
    }
  },
  ...
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-CpuOW4av.js"),
    meta: {
      entityType: r
    }
  },
  ...
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-DhrigGbt.js"),
    meta: {
      entityType: s
    }
  },
  ...
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-xXu3Z_9r.js"),
    meta: {
      entityType: c
    }
  },
  ...
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-BFKqXHxM.js"),
    meta: {
      entityType: n
    }
  },
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-W8G3QZu0.js"),
    meta: {
      entityType: y
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-BU0cFU4x.js"),
    meta: {
      entityType: p
    }
  },
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-ByqEW7-s.js"),
    meta: {
      entityType: m
    }
  },
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-Cb0oM0OZ.js"),
    meta: {
      entityType: M
    }
  },
  ...
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-BhQmuP9C.js"),
    meta: {
      entityType: u
    }
  },
  ...
  // Workspace for notifications (when clicking "Notifications" in tree)
  {
    ...
    api: () => import("./notifications-workspace.context-C2cKiFH4.js"),
    meta: {
      entityType: E
    }
  },
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-D1_PZlu6.js"),
    meta: {
      entityType: d
    }
  },
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-BfaGew_r.js"),
    meta: {
      entityType: h
    }
  },
...
], H = [
  {
    ...
    api: () => import("./upsells-workspace.context-QrLyFYim.js"),
    meta: {
      entityType: w
    }
  },
  ...
  // Product picker modal for selecting products in orders and property editors
  {
    ...
    js: () => import("./product-picker-modal.element-CehlO8Rp.js")
  }
], q = [
  {
...
//# sourceMappingURL=bundle.manifests-DMDkJ_vY.js.map
