import { LitElement as A, html as r, nothing as d, css as T, property as k, state as o, customElement as z } from "@umbraco-cms/backoffice/external/lit";
...
import { M as f } from "./merchello-api-DJaAbZDf.js";
import { o as re, p as se } from "./navigation-CeBoJi5F.js";
...
import { a as le } from "./formatting-yvY2E0o9.js";
import { b as ue } from "./store-settings-D4iMD5sL.js";
...
}, K = (e, t, i) => t.has(e) || X("Cannot " + i), g = (e, t, i) => (K(e, t, "read from private field"), t.get(e)), L = (e, t, i) => t.has(e) ? X("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), D = (e, t, i, a) => (K(e, t, "write to private field"), t.set(e, i), i), P, C, $;
let c = class extends O(A) {
  constructor() {
    super(), this.segmentId = "", this._members = [], this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._removingIds = /* @__PURE__ */ new Set(), L(this, P), L(this, C), L(this, $, !1), this.consumeContext(ne, (e) => {
      D(this, P, e);
  ...
  async _handleAddMembers() {
    const e = this._members.map((a) => a.customerId), i = await g(this, P)?.open(this, de, {
      data: {
...
c = _([
  z("merchello-segment-members-table")
], c);
...
}, Q = (e, t, i) => t.has(e) || J("Cannot " + i), Y = (e, t, i) => (Q(e, t, "read from private field"), i ? i.call(e) : t.get(e)), W = (e, t, i) => t.has(e) ? J("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), F = (e, t, i, a) => (Q(e, t, "write to private field"), t.set(e, i), i), q = (e, t, i, a) => ({
  set _(s) {
    F(e, t, s);
  },
  get _() {
...
let y = class extends O(A) {
  constructor() {
    super(...arguments), this.criteria = [], this.matchMode = "All", this._criteriaRows = [], this._availableFields = [], this._isLoadingFields = !0, W(this, x, !1), W(this, I, 0);
  }
  connectedCallback() {
    super.connectedCallback(), F(this, x, !0), this._loadAvailableFields(), this._initializeCriteriaRows();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), F(this, x, !1);
  }
  updated(e) {
...
y = M([
  z("merchello-segment-criteria-builder")
], y);
...
}, j = (e, t, i) => t.has(e) || Z("Cannot " + i), B = (e, t, i) => (j(e, t, "read from private field"), t.get(e)), ve = (e, t, i) => t.has(e) ? Z("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), U = (e, t, i, a) => (j(e, t, "write to private field"), t.set(e, i), i), S;
let u = class extends O(A) {
  ...
  connectedCallback() {
    super.connectedCallback(), U(this, S, !0), this.segmentId && (this._loadPreview(), this._loadStatistics());
  }
  disconnectedCallback() {
    super.disconnectedCallback(), U(this, S, !1);
  }
  updated(e) {
...
}, te = (e, t, i) => t.has(e) || ee("Cannot " + i), m = (e, t, i) => (te(e, t, "read from private field"), i ? i.call(e) : t.get(e)), G = (e, t, i) => t.has(e) ? ee("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), V = (e, t, i, a) => (te(e, t, "write to private field"), t.set(e, i), i), v, b;
const E = () => document.createElement("div");
let p = class extends O(A) {
  constructor() {
    super(), this._formData = {}, this._isSaving = !1, this._activePath = "tab/details", this._routerPath = "", this._fieldErrors = {}, G(this, v), G(this, b), this._routes = [
      { path: "tab/details", component: E },
      { path: "tab/members", component: E },
      { path: "tab/criteria", component: E },
      { path: "tab/preview", component: E },
      { path: "", redirectTo: "tab/details" }
    ], this.consumeContext(ae, (e) => {
      V(this, v, e), this.observe(m(this, v).segment, (t) => {
        this._segment = t, t && (this._formData = { ...t });
      });
    }), this.consumeContext(H, (e) => {
      V(this, b, e);
    });
  ...
  async _handleSave() {
    ...
    try {
      if (this._isNew) {
        ...
        if (i) {
          m(this, b)?.peek("danger", {
            data: { headline: "Create failed", message: i.message }
          });
          return;
        }
        t && (m(this, v)?.updateSegment(t), m(this, b)?.peek("positive", {
  ...
  _renderTabs() {
    const e = this._formData.segmentType === "Manual", t = this._formData.segmentType === "Automated";
    return r`
      <uui-tab-group slot="header">
        ...
        ${t ? r`
          <uui-tab
            ...
            Criteria
            ${this._hasCriteriaErrors() ? r`<uui-badge slot="extra" color="danger" attention>!</uui-badge>` : d}
          </uui-tab>
          ${this._isNew ? d : r`
            <uui-tab
              label="Preview"
  ...
  _renderActiveTabContent() {
    return this._activePath.includes("tab/members") ? this._renderMembersTab() : this._activePath.includes("tab/criteria") ? this._renderCriteriaTab() : this._activePath.includes("tab/preview") ? this._renderPreviewTab() : this._renderDetailsTab();
  }
  _renderDetailsTab() {
    return r`
  ...
  _renderMembersTab() {
    return this._segment?.id ? r`
      <merchello-segment-members-table
        ...
        @members-changed=${() => m(this, v)?.reload()}>
      </merchello-segment-members-table>
    ` : r`<p>Save the segment first to manage members.</p>`;
  }
  _renderCriteriaTab() {
    return r`
...
w([
  o()
], p.prototype, "_fieldErrors", 2);
p = w([
  z("merchello-segment-detail")
], p);
const Ae = p;
export {
  p as MerchelloSegmentDetailElement,
  Ae as default
};
//# sourceMappingURL=segment-detail.element-BeBi5aUz.js.map
