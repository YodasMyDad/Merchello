...
var w = Object.defineProperty, b = Object.getOwnPropertyDescriptor, c = (o, t, a, r) => {
  for (var e = r > 1 ? void 0 : r ? b(t, a) : t, i = o.length - 1, s; i >= 0; i--)
    (s = o[i]) && (e = (r ? s(t, a, e) : s(e)) || e);
  return r && e && w(t, a, e), e;
};
...
c([
  p()
], n.prototype, "_renderedContent", 2);
n = c([
  v("merchello-setup-instructions-modal")
], n);
const x = n;
export {
  n as MerchelloSetupInstructionsModalElement,
  x as default
};
//# sourceMappingURL=setup-instructions-modal.element-BjDcuuoC.js.map
