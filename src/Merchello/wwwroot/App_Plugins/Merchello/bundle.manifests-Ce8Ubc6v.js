const e = [
  {
    ...
    js: () => import("./entrypoint-BEN_GI11.js")
  }
], o = [
  // Section
  {
  ...
  // Stats Dashboard
  {
    ...
    element: () => import("./stats-dashboard.element-6G7gKz9r.js"),
    meta: {
      label: "Stats",
      pathname: "stats"
    },
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-A3NI7fHV.js")
  },
  // Tree
  {
    type: "tree",
...
], B = "merchello-root", l = "merchello-orders", i = "merchello-products", t = "merchello-customers", r = "merchello-collections", s = "merchello-filters", c = "merchello-product-types", n = "merchello-product-feed", m = "merchello-analytics", p = "merchello-discounts", d = "merchello-suppliers", h = "merchello-warehouses", M = "merchello-emails", u = "merchello-providers", y = "merchello-webhooks", k = "merchello-outstanding", P = "merchello-abandoned-checkouts", E = [
  // Fulfillment modal for creating shipments
  {
    type: "modal",
    alias: "Merchello.Fulfillment.Modal",
    name: "Merchello Fulfillment Modal",
    js: () => import("./fulfillment-modal.element-h1bpcq1l.js")
  },
  // Shipment edit modal for updating tracking info
  {
    ...
    js: () => import("./shipment-edit-modal.element-6misRURe.js")
  },
  // Manual payment modal for recording offline payments
  {
    ...
    js: () => import("./manual-payment-modal.element-DVNoxbSP.js")
  },
  // Refund modal for processing refunds
  {
    ...
    js: () => import("./refund-modal.element-DNOGnYGp.js")
  },
  // Cancel invoice modal for cancelling invoices
  {
    ...
    js: () => import("./cancel-invoice-modal.element-B6kxYeoe.js")
  },
  // Export modal for exporting orders to CSV
  {
    ...
    js: () => import("./export-modal.element-CV3PKBqM.js")
  },
  // Edit order modal for editing order details
  {
    ...
    js: () => import("./edit-order-modal.element-BddWhygf.js")
  },
  // Add custom item modal for edit order
  {
    ...
    js: () => import("./add-custom-item-modal.element-ClG7CnPq.js")
  },
  // Add discount modal for edit order
  {
    ...
    js: () => import("./add-discount-modal.element-GKKDqzqY.js")
  },
  // Create order modal for creating draft orders from backoffice
  {
    ...
    js: () => import("./create-order-modal.element-BqldHpV6.js")
  },
  // Customer orders modal for viewing all orders by a customer
  {
    ...
    js: () => import("./customer-orders-modal.element-Bnoiz_9Z.js")
  },
  // Generate statement modal for downloading customer statement PDFs
  {
    ...
    js: () => import("./generate-statement-modal.element-BGxJhx-n.js")
  },
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-DCbG91x0.js"),
    meta: {
      entityType: l
    }
  },
  // Workspace view - the orders list (used when on list route)
  {
    ...
    js: () => import("./orders-list.element-lt8ttP7b.js"),
    weight: 100,
    meta: {
      label: "Orders",
      pathname: "list",
  ...
  // Mark as paid modal
  {
    ...
    js: () => import("./mark-as-paid-modal.element-CgLkz-Et.js")
  },
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-ATaORwVj.js"),
    meta: {
      entityType: k
    }
  },
  // Workspace view - the outstanding list
  {
    ...
    js: () => import("./outstanding-list.element-RWrJICn-.js"),
    weight: 100,
    meta: {
      label: "Outstanding",
      pathname: "list",
  ...
  // Workspace for abandoned checkouts list (when clicking "Abandoned Checkouts" in tree)
  {
    ...
    api: () => import("./abandoned-checkouts-workspace.context-Buy54Ryc.js"),
    meta: {
      entityType: P
    }
  },
  // Workspace view - the abandoned checkouts list
  {
    ...
    js: () => import("./abandoned-checkouts-list.element-CnuBs_MI.js"),
    weight: 100,
    meta: {
  ...
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-CJ9T8oYQ.js"),
    meta: {
      entityType: i
    }
  },
  // Workspace view for products list (used when on list route)
  {
    ...
    js: () => import("./products-list.element-DmZovlM7.js"),
    weight: 100,
    meta: {
      label: "Products",
      pathname: "products",
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-K67maXVe.js"),
    meta: {
      entityType: t
    }
  },
  // Workspace view - the customers list
  {
    ...
    js: () => import("./customers-list.element-Dj9Ggwm3.js"),
    weight: 100,
    meta: {
      label: "Customers",
      pathname: "list",
  ...
  // Workspace view - the segments list (tab in Customers workspace)
  {
    ...
    js: () => import("./segments-list.element-9Fvzd8aT.js"),
    weight: 90,
    meta: {
      label: "Segments",
      pathname: "segments",
  ...
  // Customer edit modal
  {
    ...
    js: () => import("./customer-edit-modal.element-B0VX3ti8.js")
  },
  // Customer picker modal (for adding members to segments)
  {
    ...
    js: () => import("./customer-picker-modal.element-Du0LjVy0.js")
  },
  // Segment picker modal (for discount eligibility)
  {
    ...
    js: () => import("./segment-picker-modal.element-DLCC4i37.js")
  }
], C = [
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-Dma-wBij.js"),
    meta: {
      entityType: r
    }
  },
  // Workspace view for collections
  {
    ...
    js: () => import("./collections-workspace.element-CaWqv0Qa.js"),
    weight: 100,
    meta: {
      label: "Collections",
  ...
  // Collection picker modal (for discount targeting)
  {
    ...
    js: () => import("./collection-picker-modal.element-BFB3cEIs.js")
  },
  // Collection create/edit modal
  {
    ...
    js: () => import("./collection-modal.element-BMQyjOVY.js")
  }
], W = [
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-B5i41NRy.js"),
    meta: {
      entityType: s
    }
  },
  // Workspace view for filters list
  {
    ...
    js: () => import("./filters-list.element-Bq3COHMj.js"),
    weight: 100,
    meta: {
      label: "Filters",
      pathname: "filters",
  ...
  // Modal for creating/editing filter groups
  {
    ...
    js: () => import("./filter-group-modal.element-VV4Dyvuz.js")
  },
  // Modal for creating/editing filters
  {
    ...
    js: () => import("./filter-modal.element-BpaRee5N.js")
  },
  // Filter picker modal (for discount targeting)
  {
    ...
    js: () => import("./filter-picker-modal.element-mSD-O-RY.js")
  },
  // Filter group picker modal (for property editor)
  {
    ...
    js: () => import("./filter-group-picker-modal.element-C5ceiOUi.js")
  }
], f = [
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-BwezVZvl.js"),
    meta: {
      entityType: c
    }
  },
  // Workspace view for product types
  {
    ...
    js: () => import("./product-types-list.element-BMBPeSD3.js"),
    weight: 100,
    meta: {
      label: "Product Types",
  ...
  // Modal for create/edit product type
  {
    ...
    js: () => import("./product-type-modal.element-Cmh44vOU.js")
  },
  // Product type picker modal (for discount targeting)
  {
    ...
    js: () => import("./product-type-picker-modal.element-eEHNk9fC.js")
  }
], S = [
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-Kt6Lsrf4.js"),
    meta: {
      entityType: n
    }
  },
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-B_YL-9zu.js"),
    meta: {
      entityType: u
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-B07TjdYA.js"),
    meta: {
      entityType: m
    }
  },
  // Workspace view for analytics
  {
    ...
    js: () => import("./analytics-workspace.element-DenqBwX1.js"),
    weight: 100,
    meta: {
      label: "Analytics",
      pathname: "analytics",
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-DaCMzHQp.js"),
    meta: {
      entityType: p
    }
  },
  // Workspace view for discounts list (used when on list route)
  {
    ...
    js: () => import("./discounts-list.element-B2FVeZMM.js"),
    weight: 100,
    meta: {
      label: "Discounts",
      pathname: "discounts",
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-DNIWXwiX.js"),
    meta: {
      entityType: M
    }
  },
  // Workspace view - the email list
  {
    ...
    js: () => import("./email-list.element-9s5HMZi6.js"),
    weight: 100,
    meta: {
      label: "Emails",
      pathname: "list",
  ...
  // Email preview modal
  {
    ...
    js: () => import("./email-preview-modal.element-D-9CDwib.js")
  }
], A = [
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-DHbd0vnZ.js"),
    meta: {
      entityType: y
    }
  },
  // Workspace view - the webhooks list
  {
    ...
    js: () => import("./webhooks-list.element-dNMwK56P.js"),
    weight: 100,
    meta: {
      label: "Webhooks",
      pathname: "list",
  ...
  // Webhook subscription create/edit modal
  {
    ...
    js: () => import("./webhook-subscription-modal.element-CW6Hv6RY.js")
  },
  // Webhook test modal
  {
    type: "modal",
    ...
    js: () => import("./webhook-test-modal.element-Ho95X4nQ.js")
  },
  // Delivery detail modal
  {
    ...
    js: () => import("./delivery-detail-modal.element-9n3rzpye.js")
  },
  ...
  // Workspace view for tax providers list (appears as "Tax" tab in Providers workspace)
  {
    ...
    js: () => import("./tax-providers-list.element-UrdoZoVE.js"),
    weight: 85,
    meta: {
      label: "Tax",
      pathname: "tax",
  ...
  // Tax group modal (handles both create and edit)
  {
    ...
    js: () => import("./tax-group-modal.element-uLpnQLj8.js")
  },
  // Tax rate modal (handles both create and edit for geographic rates)
  {
    ...
    js: () => import("./tax-rate-modal.element-PqTlSmBx.js")
  },
  // Tax provider config modal
  {
    ...
    js: () => import("./tax-provider-config-modal.element-8NV90eJQ.js")
  },
  // Test tax provider modal
  {
    ...
    js: () => import("./test-tax-provider-modal.element-D3nDa7YE.js")
  },
  // Shipping tax override modal
  {
    ...
    js: () => import("./shipping-tax-override-modal.element-IpG8Wqq0.js")
  }
], I = [
  // ============================================
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-BC88WlgH.js"),
    meta: {
      entityType: d
    }
  },
  // List view for suppliers
  {
    ...
    js: () => import("./suppliers-list.element-ComeEjTa.js"),
    weight: 100,
    meta: {
      label: "Suppliers",
      pathname: "suppliers",
  ...
  // Supplier modal (handles both create and edit)
  {
    ...
    js: () => import("./supplier-modal.element-D0RqmKuq.js")
  },
  // Supplier picker modal (for discount targeting)
  {
    ...
    js: () => import("./supplier-picker-modal.element-B5PvaGKt.js")
  }
], L = [
  // ============================================
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-DJXY6xsE.js"),
    meta: {
      entityType: h
    }
  },
  // List view for warehouses (used when on list route)
  {
    ...
    js: () => import("./warehouses-list.element-7GLhIQbU.js"),
    weight: 100,
    meta: {
      label: "Warehouses",
      pathname: "warehouses",
  ...
  // Service region modal
  {
    ...
    js: () => import("./service-region-modal.element-M4c2tSkN.js")
  },
  // Warehouse picker modal (for discount targeting)
  {
    ...
    js: () => import("./warehouse-picker-modal.element-Y-Q5f02C.js")
  }
], _ = [
  // Workspace view for shipping providers (under Providers workspace)
  {
    ...
    js: () => import("./shipping-providers-list.element-CACT5XON.js"),
    weight: 90,
    meta: {
      label: "Shipping",
      pathname: "shipping",
  ...
  // Shipping provider configuration modal
  {
    ...
    js: () => import("./shipping-provider-config-modal.element-dGaWfBgF.js")
  },
  // Test shipping provider modal
  {
    ...
    js: () => import("./test-provider-modal.element-CmMeS3oY.js")
  },
  // Shipping option detail modal
  {
    ...
    js: () => import("./shipping-option-detail-modal.element-D7DwR2Di.js")
  },
  // Shipping cost modal
  {
    type: "modal",
    ...
    js: () => import("./shipping-cost-modal.element-CJ6N9k8r.js")
  },
  // Shipping weight tier modal
  {
    ...
    js: () => import("./shipping-weight-tier-modal.element-qr_ob_IL.js")
  }
], R = [
  // Workspace view for payment providers (under Providers workspace)
  {
    ...
    js: () => import("./payment-providers-list.element-DJ7dT9no.js"),
    weight: 100,
    meta: {
      label: "Payments",
      pathname: "payments",
  ...
  // Modal for configuring a payment provider
  {
    ...
    js: () => import("./payment-provider-config-modal.element-DCKVWais.js")
  },
  // Modal for configuring payment methods within a provider
  {
    ...
    js: () => import("./payment-methods-config-modal.element-BFs5R7KB.js")
  },
  // Modal for editing a single payment method's display settings
  {
    ...
    js: () => import("./payment-method-edit-modal.element-CaWPoXdy.js")
  },
  ...
  // Modal for testing a payment provider
  {
    ...
    js: () => import("./test-provider-modal.element-BCHyjAUX.js")
  }
], x = [
  // Workspace view for fulfilment providers (under Providers workspace)
  {
    ...
    js: () => import("./fulfilment-providers-list.element-C8dgjpMq.js"),
    weight: 75,
    meta: {
      label: "Fulfilment",
      pathname: "fulfilment",
  ...
  // Configuration modal
  {
    ...
    js: () => import("./fulfilment-provider-config-modal.element-CdkgA8aw.js")
  },
  // Test modal
  {
    type: "modal",
    ...
    js: () => import("./test-provider-modal.element-B4Xx47rp.js")
  }
], F = [
  // Workspace view for exchange rate providers (under Providers workspace)
  {
    ...
    js: () => import("./exchange-rate-providers-list.element-B8TaK_tB.js"),
    weight: 80,
  ...
  // Modal for configuring an exchange rate provider
  {
    ...
    js: () => import("./exchange-rate-provider-config-modal.element-CNCUJuCt.js")
  },
  // Modal for testing an exchange rate provider
  {
    ...
    js: () => import("./test-provider-modal.element-DxPGReY0.js")
  }
], Y = [
  ...
  // Product picker modal for selecting products in orders and property editors
  {
    ...
    js: () => import("./product-picker-modal.element-7faO9-hQ.js")
  }
], $ = [
  {
    ...
    element: () => import("./property-editor-ui-collection-picker.element-DT_F4G9f.js"),
    meta: {
...
], N = [
  {
    ...
    element: () => import("./property-editor-ui-product-type-picker.element-6ybNRoHB.js"),
    meta: {
...
], H = [
  {
    ...
    element: () => import("./property-editor-ui-filter-group-picker.element-DgLcRV05.js"),
    meta: {
...
], G = [
  {
    ...
    element: () => import("./property-editor-ui-filter-value-picker.element-CbNt49or.js"),
    meta: {
...
], q = [
  {
    ...
    element: () => import("./property-editor-ui-product-picker.element--pbFNHPC.js"),
    meta: {
...
//# sourceMappingURL=bundle.manifests-Ce8Ubc6v.js.map
