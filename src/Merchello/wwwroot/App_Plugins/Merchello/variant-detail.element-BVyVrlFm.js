import { LitElement as $, html as i, nothing as n, css as k, state as s, customElement as x } from "@umbraco-cms/backoffice/external/lit";
...
var w = Object.defineProperty, z = Object.getOwnPropertyDescriptor, y = (t) => {
  throw TypeError(t);
}, u = (t, e, a, l) => {
  for (var p = l > 1 ? void 0 : l ? z(e, a) : e, f = t.length - 1, v; f >= 0; f--)
    (v = t[f]) && (p = (l ? v(e, a, p) : v(p)) || p);
  return l && p && w(e, a, p), p;
}, D = (t, e, a) => e.has(t) || y("Cannot " + a), r = (t, e, a) => (D(t, e, "read from private field"), e.get(t)), g = (t, e, a) => e.has(t) ? y("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, a), m = (t, e, a, l) => (D(t, e, "write to private field"), e.set(t, a), a), c, d, b, h;
let o = class extends S($) {
   ...
   */
  _getActiveTab() {
    return this._activePath.includes("tab/dimensions") ? "dimensions" : this._activePath.includes("tab/seo") ? "seo" : this._activePath.includes("tab/feed") ? "feed" : this._activePath.includes("tab/stock") ? "stock" : "basic";
  }
  async _handleSave() {
        ...
        <uui-box headline="Description">
          <umb-property-layout label="Variant Description" description="Variant-specific description (overrides product description)">
            <uui-textarea
              ...
              @input=${(t) => this._formData = { ...this._formData, description: t.target.value }}
        ...
        <uui-box headline="Search Engine Optimization">
          <umb-property-layout label="Page Title" description="Title displayed in browser tab and search results">
            <uui-input
              ...
              @input=${(t) => this._formData = { ...this._formData, pageTitle: t.target.value }}>
            </uui-input>
          </umb-property-layout>
          ...
          <umb-property-layout label="Meta Description" description="Description shown in search engine results">
            <uui-textarea
              ...
              @input=${(t) => this._formData = { ...this._formData, metaDescription: t.target.value }}>
            </uui-textarea>
          </umb-property-layout>
          ...
          <umb-property-layout label="No Index" description="Hide from search engines">
            <uui-toggle
              ...
              @change=${(t) => this._formData = { ...this._formData, noIndex: t.target.checked }}>
            </uui-toggle>
          </umb-property-layout>
        </uui-box>
      </div>
          ...
          ${this._formData.removeFromFeed ? n : i`
                ...
                <umb-property-layout label="Exclude from Custom Labels" description="Exclude from custom label categorization">
                  <uui-toggle
                    ...
                    @change=${(t) => this._formData = { ...this._formData, excludeFromCustomLabels: t.target.checked }}>
                  </uui-toggle>
                </umb-property-layout>
              `}
        </uui-box>
  ...
  _renderStockTab() {
    const t = this._formData.warehouseStock ?? [], e = t.reduce((a, l) => a + l.stock, 0);
    return i`
      <div class="tab-content">
        <uui-box class="info-banner">
          <div class="info-content">
    ...
    return i`
      <umb-body-layout header-fit-height main-no-padding>
        ...
        <umb-body-layout header-fit-height header-no-padding>
          ...
          ${t === "basic" ? this._renderBasicTab() : n}
          ${t === "dimensions" ? this._renderDimensionsTab() : n}
          ${t === "seo" ? this._renderSeoTab() : n}
          ${t === "feed" ? this._renderFeedTab() : n}
          ${t === "stock" ? this._renderStockTab() : n}
        </umb-body-layout>
...
//# sourceMappingURL=variant-detail.element-BVyVrlFm.js.map
