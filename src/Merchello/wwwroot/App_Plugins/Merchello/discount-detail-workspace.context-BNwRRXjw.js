...
import { d as l, e as c, a as h, D as d, c as m } from "./discount.types-YWYxoniA.js";
import { M as p } from "./merchello-api-DPQ4r4XT.js";
import { g } from "./store-settings-BhzqJKNt.js";
import { D as f } from "./navigation-m-G5wLvz.js";
class v extends r {
  constructor(t) {
    super(t, i.toString()), this.workspaceAlias = "Merchello.Discount.Detail.Workspace", this.#e = !1, this.#o = 1e3, this.#s = new u(void 0), this.discount = this.#s.asObservable(), this.#i = new a(!1), this.isLoading = this.#i.asObservable(), this.#r = new a(!1), this.isSaving = this.#r.asObservable(), this.routes = new n(t), this.provideContext(i, this), this._loadSettings(), this.routes.setRoutes([
      {
        path: "create",
        component: () => import("./discount-detail.element-qWYA3qMM.js"),
        setup: () => {
  ...
  async load(t) {
    ...
    const { data: e, error: s } = await p.getDiscount(t);
    if (s) {
  ...
  async _loadSettings() {
    const t = await g();
    this.#o = t.defaultDiscountPriority;
  }
...
export {
  v as MerchelloDiscountDetailWorkspaceContext,
  v as api
};
//# sourceMappingURL=discount-detail-workspace.context-BNwRRXjw.js.map
