...
Every availability check returns a [`ProductLocationAvailability`](https://github.com/YodasMyDad/Merchello/blob/main/src/Merchello.Core/Storefront/Models/ProductLocationAvailability.cs) record:
...
The starter site demonstrates the pattern for showing stock status on a product page ([Default.cshtml:37-49](https://github.com/YodasMyDad/Merchello/blob/main/src/Merchello.Site/Views/Products/Default.cshtml#L37)):
