...
The starter site's [CategoryController.cs](https://github.com/YodasMyDad/Merchello/blob/main/src/Merchello.Site/Category/Controllers/CategoryController.cs) accepts filter selections from query parameters, queries products, and loads the relevant filter groups:
